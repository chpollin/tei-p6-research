...
The other builders own `docs/project.html`, `docs/corpus.html`,
`docs/knowledge.html`, and `docs/model.html`. Regenerate affected pages using
the commands in `SETUP.md`.
