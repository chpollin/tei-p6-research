...
| Area | State | Evidence |
|---|---|---|
| Repository version 0.1.0 | am 2026-09-07 nach GitHub übertragen | [[knowledge/releases]] definiert Inhalt, Versionsgrenzen und bekannte Einschränkungen. Der annotierte Tag [`v0.1.0`](https://github.com/chpollin/tei-p6-research/tree/v0.1.0) verweist auf Commit `f72594fd3bc3e3e987716926a8148e0e2c068bec` und sichert den zusammengehörigen Stand aus Modellarbeit, Ontologie, HSA-Fall und vorbereiteter P5-Strukturstudie. Branch und Tag wurden atomar übertragen; die entfernten Referenzen wurden anschließend geprüft. Die vollständige Testsuite bestand in dieser Session mit 1.620 Tests; nach den letzten HSA-Beschriftungen bestanden zusätzlich 102 HSA- und Seitenprüfungen. Der nächste fachliche Arbeitspunkt steht in [[knowledge/handoff]] unter den Revisionsabhängigkeiten von Modell 0.2. |
...
| Integrated release gate | lokaler Gesamtabschluss und sauberer Checkout am 2026-09-07 geprüft | Der zusammengeführte Versionsstand bestand die Gesamtsuite mit 1.620 Tests, einem plattformabhängigen Skip und zehn bekannten RDFLib-Warnungen. In einem frischen Checkout des Commits `f72594f` bestanden anschließend die Quellen-, Modell- und Berichtsreproduktion sowie 78 gezielte Tests ohne ignorierte Rohdaten oder Git-Mirror. Die zugehörigen GitHub-Läufe für [Branch-Prüfung](https://github.com/chpollin/tei-p6-research/actions/runs/34135506015), [Tag-Prüfung](https://github.com/chpollin/tei-p6-research/actions/runs/34135506375) und [Pages-Veröffentlichung](https://github.com/chpollin/tei-p6-research/actions/runs/34135506121) dokumentieren den serverseitigen Prüf- und Veröffentlichungsstand dieses Commits. Fachliche Prüfung und menschliche Abnahme bleiben gesonderte Grenzen. |
