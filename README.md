...
The staged collector build, subagent ownership model, API strategy, and
integration gates are defined in
[docs/multi-agent-acquisition-runbook.md](docs/multi-agent-acquisition-runbook.md).
