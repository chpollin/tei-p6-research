...
source: '[[00_sources/tei-p5-guidelines-hd-header-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 The TEI Header
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Guidelines/en/HD-Header.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 161563. Git blob: `0a6f850e4112e4279825ca8ff3f71102a942de28`.
...
<specList><specDesc key="teiHeader"/></specList>
</p>
...
it also has some mandatory components, as further discussed in <ptr target="#HD2"/> below. The smallest possible valid TEI header thus
looks like this:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD11-egXML-yk" xml:lang="und" source="#UND"><teiHeader>
    <fileDesc>
      <titleStmt>
...
English text has been given a French header:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD11-egXML-tp" xml:lang="und" valid="feasible" source="#UND">
<TEI>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD11-egXML-os" valid="feasible" source="#UND">
<teiCorpus>
   <teiHeader>
...
<list type="gloss">
  ...
  Associations, see <ptr target="http://www.ifla.org/VII/s13/pubs/isbd.htm"/>. On the
  relation between the TEI proposals and other standards for
  bibliographic description, see further section <ptr target="#HD8"/>.</note> In the case of the <gi>xenoData</gi>
  ...
  cross-reference to it, as further described in section <ptr target="#CCAS"/>.</item>
...
see further section <ptr target="#COBI"/>). See further section <ptr target="#HD8"/>.</p>
...
might look like this:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD2-egXML-kl" xml:lang="und" source="#UND"><teiHeader>
    <fileDesc>
...
<p>Examples:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD21-egXML-nj"><titleStmt>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD21-egXML-ca"><titleStmt>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD21-egXML-ez"><titleStmt>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD22-egXML-lk"><editionStmt>
  <edition n="P2">Second draft, substantially
       extended, revised, and corrected.</edition>
</editionStmt></egXML>
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD22-egXML-ft"><editionStmt>
...
recommended where applicable, here as elsewhere (see <ptr target="http://physics.nist.gov/cuu/Units/binary.html"/>). </p>
<p>Examples:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD23-egXML-kj"><extent>between 1 and
2 Mb</extent>
...
machine-tractable or normalized versions of the size or sizes given,
as in the following example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD23-egXML-lq"><extent>
...
These elements form the <ident type="class">model.publicationStmtPart.agency</ident> class; if the agency making the resource available is unknown, but other structured information about it is available, an explicit statement such as <soCalled>publisher unknown</soCalled> should be used.
</p>
...
<p>Whichever of these elements is chosen, it may be followed by one or more of the following elements, which together form the <ident type="class">model.publicationStmtPart.detail</ident> class
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD24-egXML-td"><publicationStmt>
...
<p>The  <ident type="class">model.publicationStmtPart.detail</ident> elements all supply additional information relating to the
...
In the following example, Benson is identified as responsible for distribution of some resource at the date and place cited:
 <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD24-egXML-ww"><publicationStmt>
...
<p>The following example shows a resource published by one agency (Sigma Press) at one address and date, which is also distributed by another (Oxford Text Archive), with a specified identifier and a different date: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD24-egXML-fr"><publicationStmt>
...
<p>The <gi>availability</gi> element may be used, as above, to provide a simple prose statement of any restrictions concerning the distribution of the resource. Alternatively, a more formal statement of the licensing conditions applicable may be provided using the <gi>licence</gi> element:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD24-egXML-jz"><publicationStmt>
...
serial.</item></list>
A <gi>seriesStmt</gi> element may contain a prose description or one
...
the number further, taking the value <val>ISSN</val> for an ISSN for
  example. Multiple <gi>seriesStmt</gi> elements may be supplied if the TEI document is associated with more than one series.
</p>
<p>Examples:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD26-egXML-oe"><seriesStmt>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD27-egXML-tz"><notesStmt>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD27-egXML-zi">
      <titleStmt>
        <title>…</title>
        <respStmt>
...
has no source:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD3-egXML-wk"><sourceDesc>
   <p>Born digital.</p>
</sourceDesc></egXML></p>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD3-egXML-gl"><sourceDesc>
   <bibl>The first folio of Shakespeare, prepared by
   Charlton Hinman (The Norton Facsimile, 1968)</bibl>
</sourceDesc></egXML>
or with more elaboration:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD3-egXML-vf" xml:lang="fr"><sourceDesc>
...
<include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/biblFull.xml"/><specGrpRef target="#D2231"/>
  ...
  <div type="div3" xml:id="HD31"><head>TEI documents derived from other TEI documents</head>
<p>When a TEI document (call it B) is derived not from a
printed source but from another TEI file (call it
A), then the five sections of A's file header will need to be incorporated into the new
...
<specList>
  ...
  <specDesc key="unitDecl"/>
  <specDesc key="schemaSpec"/>
  <specDesc key="schemaRef"/>
...
<include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/schemaRef.xml"/>
...
<p>For example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD51-egXML-tn"><encodingDesc>
   <projectDesc>
...
but is not restricted to these.
        ...
        <!-- doubt it.  so no.  -msm                             -->
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD52-egXML-rp"><samplingDecl>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD52-egXML-ve"><samplingDecl>
...
them?</p></item>
  ...
  <item>
    <specList>
      <specDesc key="punctuation" atts="marks placement"/>
    </specList>
    <p>Are punctuation marks present in the original source retained? Are they identified with the element <gi>pc</gi>, or implied by markup? If retained, how are they placed with respect to related elements? For example, do commas and periods appear inside or outside elements marking phrases and sentences?</p></item>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD53-egXML-gp"><editorialDecl>
...
</specList></p><p>The <gi>tagsDecl</gi> element is descriptive, rather than prescriptive: if used, it simply documents
practice in the TEI document containing it. The elements constituting a TEI customization file (discussed in chapter <ptr target="#TD"/>) by contrast
...
the actual state of a document and what is documented by its <gi>tagsDecl</gi>, then the latter should be corrected. If there is an
...
document that requires correction.</p>
...
used to  describe the rendering of an element. See further <ptr target="#STGAre"/>.
</p>
  <p>The content of a <gi>rendition</gi> element may
...
<gi>rendition</gi> elements using the <att>scheme</att> attribute.
  ...
  <p>The recommended way to indicate a default rendition on one or more elements is to use the <att>selector</att> attribute together with the <att>scheme</att> attribute on <gi>rendition</gi>. For example, suppose that all paragraphs in the <gi>front</gi> of a text appear in a large font, with significant top and bottom margins, while paragraphs in the main <gi>body</gi> are in regular font size and have no top and bottom margins. The use of <att>selector</att> together with <att>scheme</att> provides an efficient way to specify the distinct styling for distinct contexts of the paragraph by means of CSS selectors:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD57-1-egXML-qp">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD57-1-egXML-du">
...
following figure: <figure xml:id="HD57-1-figure-cu" corresp="#HD-eg-swinb"><graphic url="Images/HDswinburne.jpg" height="400px"/></figure> Elements for the encoding of
...
obviously closely linked.
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD57-1-egXML-yq" xml:lang="und"><styleDefDecl scheme="css" schemeVersion="2.1"/>
<!-- ... -->
<tagsDecl>
...
follows:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD57-1-egXML-mj" source="#HD-eg-swinb"><titlePage>
...
renditions such as the following:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD57-1-egXML-ci" xml:lang="und">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD57-1-egXML-am">
...
<p>For example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD57-2-egXML-eh"><tagUsage gi="hi" occurs="28">
...
in a given context, as discussed in section <ptr target="#CCAS"/>. </p>
</div>
...
<item>as nested set of citation structure declarations</item>
...
<p>For example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD54P-egXML-rw"><refsDecl>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD54M-egXML-wy" source="#UND"><refsDecl>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD54M-egXML-ii" source="#UND"><milestone n="II" ed="first" unit="page"/>
...
<specGrp xml:id="D2254" n="The reference scheme declaration">
  ...
  <include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/citeStructure.xml"/>
  <include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/citeData.xml"/>
  <include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/att.citeStructurePart.xml"/>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD55-egXML-xu">
...
the category, or any number of elements from the <ident type="class">model.catDescPart</ident> class. When the corpus module
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD55-egXML-wm"><taxonomy xml:id="b">
...
<gi>textClass</gi> element, as described in section <ptr target="#HD43"/>.  
Where finer-grained analysis is desired, the <att>ana</att> attribute on an
element in the text could point to a category, as in the following abbreviated example:
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD55-egXML-tz" xml:lang="en" source="#UND">
      <taxonomy>
        <category xml:id="poe">
...
<p>Where the taxonomy permits of classification along more
...
defined above.
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD55-egXML-zl" xml:lang="und" source="#UND"><catRef target="#b.a1 #b.a3 #b.a5"/></egXML></p>
...
more than one language, as in the following example:
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD55-egXML-ss" xml:lang="mul">
<category xml:id="lit">
...
<div type="div3" xml:id="HDGDECL"><head>The Geographic Coordinates Declaration</head>
  ...
  <div type="div3" xml:id="HDUDECL"><head>The Unit Declaration</head>
    <p>When documents feature units of measurement that are not listed in the <ref target="https://www.bipm.org/en/publications/si-brochure/">International System of Units</ref>, the <gi>unitDecl</gi> element may be used in the encoding description to provide definitions and information about their origins and equivalents.
      <specList>
        <specDesc key="unitDecl"/>
      </specList>
    </p>
    <p>The <gi>unitDecl</gi> contains one or more <gi>unitDef</gi> child elements that serve to describe units of measure which may be marked in <gi>unit</gi> elements within the <gi>text</gi>.  
      <specList>
...
Within the <gi>unitDef</gi>, a <gi>conversion</gi> element may be used to store information relating to conversion between units. 
    ...
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HDUDECL-egXML-zm" xml:lang="en" source="#ZUPKO">
      <encodingDesc>
        <unitDecl>
        <unitDef xml:id="keel" type="weight">
          <label>keel</label>
          <placeName ref="#england"/>
          <conversion fromUnit="#chalder" toUnit="#keel" formula="$fromUnit * 20" from="1421" to="1676"/>
          <conversion fromUnit="#chalder" toUnit="#keel" formula="$fromUnit * 16" from="1676" to="1824"/>
        ...
        <unitDef xml:id="chalder" type="weight">
          <label>chalder</label>
          <placeName ref="#england"/>
          <conversion fromUnit="#bushel" toUnit="#chalder" formula="$fromUnit * 32" from="1421" to="1676"/>
          <conversion fromUnit="#bushel" toUnit="#chalder" formula="$fromUnit * 36" from="1676" to="1824"/>
    ...
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HDUDECL-egXML-zb" source="#NONE">
     <encodingDesc>
       <unitDecl>
         <unitDef xml:id="Celsius" type="temperature">
           <label>Celsius or Centigrade scale</label>
           <conversion fromUnit="#Fahrenheit" toUnit="#Celsius" formula="($fromUnit - 32) * (5 div 9)"/>
    ...
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HDUDECL-egXML-cb" source="#HDUDECL-TG">
  ...
  <div type="div3" xml:id="HDSCHSPEC"><head>The Schema Specification</head>
    ...
    convenient to make a copy of the <gi>schemaSpec</gi> from your project's ODD document inside the <gi>teiHeader</gi> itself, in addition to
      ...
      <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HDSCHSPEC-egXML-fs" xml:lang="en" source="#UND"><encodingDesc>
          <!-- Other encoding description elements... -->
          <schemaSpec ident="myTEICustomization" docLang="en" prefix="tei_" xml:lang="en" source="#NONE">
            <moduleRef key="core"/>
            <moduleRef key="tei"/>
    ...
    <p>Alternatively, it is possible to point to an external ODD customization file or schema through use of the <gi>schemaRef</gi> element. More than one <gi>schemaRef</gi> element may be provided for different sources, stages in a workflow, or formats.
      
      <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HDSCHSPEC-egXML-aj" source="#UND">
      ...
      The <att>url</att> attribute may be any form of URI pointer including a private URI syntax documented by a <gi>prefixDef</gi>.  
    </p>
  </div>
...
<p>The <gi>profileDesc</gi> element contains 
...
For descriptions of these elements, see section <ptr target="#CCAH"/>.</p>
<p>When the <ident type="module">transcr</ident> module for the
transcription of primary sources described in chapter <ptr target="#PH"/> is included in a schema, the following elements become
available within the <gi>profileDesc</gi> element:
<specList>
<specDesc key="handNotes"/>
<specDesc key="listTranspose"/>
</specList>
For a description of the <gi>handNotes</gi> element, see section <ptr target="#PHDH"/>. Its purpose is to group together a number of
...
<p>The <gi>listTranspose</gi> element is discussed in detail in section <ptr target="#transpo"/>.</p>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD4C-egXML-kv"><creation>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD41-egXML-ez" xml:lang="mul"><langUsage>
...
the following examples:
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD43-egXML-su">
...
the usual way:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD43-egXML-ht"><keywords scheme="#welch">
...
canonical source for the scheme, as in the following example: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD43-egXML-qk" xml:lang="und"><classCode scheme="http://www.udcc.org/udcsummary/php/index.php">005.756</classCode>
</egXML>
</p>
<p>The <gi>catRef</gi> element categorizes an individual text by
pointing to one or more <gi>category</gi> elements using the
<att>target</att> attribute, which it inherits from the <ident type="class">att.pointing</ident> class.  The
...
in the following example:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD43-egXML-mu" xml:lang="und" source="#UND"><catRef target="#b.a4 #b.d2"/></egXML></p><p>The <att>scheme</att> attribute
...
conveyed by the  resource pointed to. For example,
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD43-egXML-hk" xml:lang="und" source="#UND"><catRef target="#b.a4 #b.d2" scheme="http://www.example.com/browncorpus"/>
...
<p>The main purpose of the <gi>abstract</gi> element is to supply a brief resume or abstract for an article which was originally published without such a component. An abstract or summary forming part of the document at its creation should usually appear in the front matter (<gi>front</gi>) of the document.
 <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD4ABS-egXML-cr" xml:lang="en">
...
<p>This paper is a draft studying 
 ...
 <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD4ABS-egXML-mh">
...
<p>The same element may be used to provide other summary information supplied by the encoder, perhaps grouped together into a list of discrete items:
 <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD4ABS-egXML-wc" xml:lang="en">
<profileDesc><abstract>
<list>
<item>An annual HBC supply ship is 
  ...
  <item><name key="pelly_jh">Pelly</name> writes 
    ...
    establishment on the southern <name type="place" key="vancouver_island">Vancouver Island</name>. 
...
<div type="div3" xml:id="HD44"><head>Calendar Description</head>
  ...
  used in a fictional environment.
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD44-egXML-yt">
      <calendarDesc>
  ...
  supplying a date expressed using that calendar system:
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD44-egXML-un">
...
<div type="div3" xml:id="HD44CD"><head>Correspondence Description</head>
      ...
      the <gi>sourceDesc</gi> element. <specList>
          <specDesc key="correspDesc"/>
        </specList>
      </p>
      ...
      <p>Acts of correspondence typically do not occur in isolation from each other. The
        ...
        it is a reply, or the item which replies to it: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD44CD-egXML-gk">
          <correspContext>
...
<!-- add an example using note or p ? -->
      ...
      <p>Many types of correspondence actions may be distinguished. The <att>type</att>
      ...
      <p>The following simple example uses <gi>correspAction</gi> to describe the sending of a
        ...
        Caen. The date of reception is unknown: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD44CD-egXML-vb">
...
Note the use of the <att>when</att> attribute described in <ptr target="#CONADA"/> to provide a normalized
      ...
      be omitted, since no underlying source is being transcribed.</p>
      ...
      <p>Several senders, recipients, etc. can be specified for a single
        ...
        the piece of correspondence. <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD44CD-egXML-an">
          <correspAction type="received">
      ...
      <p>The <att>subtype</att> attribute may be used to further distinguish types of action.
        ...
        <soCalled>carbon copy</soCalled> (<term>cc</term>). <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD44CD-egXML-jy">
          <correspAction type="sent">
      ...
      <p>The same person may be associated with several actions. For example, it will often
        ...
        elsewhere in the document. <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD44CD-egXML-nx" source="#UND">
          <correspAction type="sent">
            <name sameAs="#author"/>
          </correspAction>
        </egXML>
      ...
      <p>It is assumed that each correspondence action applies to a single act of
        ...
        separately: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD44CD-egXML-dm">
...
that refer to the contents of the TEI file itself, the
<gi>xenoData</gi> element may be placed inside the <gi>standOff</gi> 
element instead.
<specList>
  <specDesc key="xenoData"/>
</specList></p>
...
<code><![CDATA[&lt;]]></code> and <code><![CDATA[&amp;]]></code> respectively. See
...
<specGrp n="non-TEI Metadata" xml:id="D227">
  ...
  <p>In the following example, the prefix
    ...
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD9-egXML-zm" valid="feasible"><xenoData xmlns:cc="http://web.resource.org/cc/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:RDF>
    <cc:Work rdf:about="">
...
most recent first.</p>
<p>For example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD6-egXML-de">
  <!-- ... -->
  <revisionDesc>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD6-egXML-in">
      <titleStmt>
...
<div type="div2" xml:id="HD7"><head>Minimal and Recommended Headers</head>
...
example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD7-egXML-kt"><teiHeader>
  <fileDesc>
    <titleStmt>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD7-egXML-wx"><teiHeader>
   <fileDesc>
      <titleStmt>
...
<div>
  <head>The TEI Header Module</head>
  <p>The module described in this chapter makes available the
  following components:
  <moduleSpec xml:id="DHD" ident="header">
    <idno type="FPI">Common Metadata</idno>
    <desc xml:lang="en" versionDate="2006-09-13">The TEI header</desc>
    <desc xml:lang="fr" versionDate="2018-07-12">En-tête TEI</desc>
    <desc xml:lang="zh-TW" versionDate="2018-07-12">TEI標頭</desc>
    <desc xml:lang="it" versionDate="2018-07-12">L'intestazione TEI (TEI header)</desc>
    <desc xml:lang="pt" versionDate="2018-07-12">O cabeçalho TEI</desc>
    <desc xml:lang="ja" versionDate="2018-07-12">ヘダーモジュール</desc>
  </moduleSpec>
...
```xml
<head>Organization of the TEI Header</head>
```
...
```xml
<head>The TEI Header and Its Components</head>
```
...
XML location: `/div[1]/div[1]/div[1]/p[5]`.
...
XML location: `/div[1]/div[1]/div[1]/p[6]`.
...
XML location: `/div[1]/div[1]/div[1]/specGrp[1]`.
...
```xml
<head>Model Classes in the TEI Header</head>
```
...
XML location: `/div[1]/div[2]/specGrp[1]`.
...
XML location: `/div[1]/div[2]/div[1]/p[7]`.
...
XML location: `/div[1]/div[2]/div[1]/p[8]`.
...
XML location: `/div[1]/div[2]/div[1]/p[9]`.
...
```xml
<specGrp xml:id="D2221" n="The title statement"><include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/titleStmt.xml"/><include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/sponsor.xml"/><include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/funder.xml"/><include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/principal.xml"/>
</specGrp>
```
...
```xml
<p>No simple rule can specify how <soCalled>substantive</soCalled>
changes have to be before they are regarded as producing a new
edition, rather than a simple update.  The general principle proposed
here is that the production of a new edition entails a significant
change in the intellectual content of the file, rather than its
...
XML location: `/div[1]/div[2]/div[2]/specGrp[1]`.
...
```xml
<head>Type and Extent of File</head>
```
...
XML location: `/div[1]/div[2]/div[3]/specGrp[1]`.
...
```xml
<head>Publication, Distribution, Licensing, etc.</head>
```
...
XML location: `/div[1]/div[2]/div[4]/p[3]`.
...
XML location: `/div[1]/div[2]/div[4]/p[4]`.
...
XML location: `/div[1]/div[2]/div[4]/p[5]`.
...
XML location: `/div[1]/div[2]/div[4]/p[6]`.
...
XML location: `/div[1]/div[2]/div[4]/p[7]`.
...
XML location: `/div[1]/div[2]/div[4]/p[8]`.
...
XML location: `/div[1]/div[2]/div[4]/p[9]`.
...
XML location: `/div[1]/div[2]/div[4]/p[10]`.
...
XML location: `/div[1]/div[2]/div[4]/specGrp[1]`.
...
```xml
<head>The Series Statement</head>
```
...
XML location: `/div[1]/div[2]/div[6]/head[1]`.

```xml
<head>The Notes Statement</head>
```
...
XML location: `/div[1]/div[2]/div[6]/p[1]`.
...
XML location: `/div[1]/div[2]/div[6]/p[2]`.
...
XML location: `/div[1]/div[2]/div[6]/p[3]`.
...
XML location: `/div[1]/div[2]/div[6]/p[4]`.
...
XML location: `/div[1]/div[2]/div[7]/head[1]`.
...
XML location: `/div[1]/div[2]/div[7]/p[1]`.
...
XML location: `/div[1]/div[2]/div[7]/p[2]`.
...
XML location: `/div[1]/div[2]/div[7]/p[3]`.
...
XML location: `/div[1]/div[2]/div[7]/p[4]`.
...
XML location: `/div[1]/div[2]/div[7]/p[5]`.
...
XML location: `/div[1]/div[2]/div[7]/p[6]`.
...
XML location: `/div[1]/div[2]/div[7]/p[7]`.
...
XML location: `/div[1]/div[2]/div[7]/p[8]`.
...
XML location: `/div[1]/div[2]/div[7]/p[9]`.
...
XML location: `/div[1]/div[2]/div[7]/specGrp[1]`.

```xml
<specGrp xml:id="D223" n="The source description">
<!--&model.sourceDescPart;-->
<include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/sourceDesc.xml"/>
<include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/biblFull.xml"/><specGrpRef target="#D2231"/>
</specGrp>
...
XML location: `/div[1]/div[2]/div[8]/head[1]`.

```xml
<head>TEI documents derived from other TEI documents</head>
```
...
XML location: `/div[1]/div[2]/div[8]/p[1]`.
...
XML location: `/div[1]/div[3]/div[1]/p[2]`.
...
XML location: `/div[1]/div[3]/div[1]/specGrp[1]`.
...
```xml
<head>The Sampling Declaration</head>
```
...
XML location: `/div[1]/div[3]/div[2]/p[2]`.
...
XML location: `/div[1]/div[3]/div[2]/p[3]`.
...
XML location: `/div[1]/div[3]/div[2]/specGrp[1]`.
...
discussed in chapter <ptr target="#MD"/>.</p>
```
...
XML location: `/div[1]/div[3]/div[3]/p[2]`.

```xml
<p>Some of these policy elements carry attributes to support automated
processing of certain well-defined editorial decisions; all of them
contain a prose description of the editorial principles adopted with
respect to the particular feature concerned.  Examples of the kinds of
questions which these descriptions are intended to answer are given in
...
XML location: `/div[1]/div[3]/div[3]/p[3]`.

```xml
<p>Any information about the editorial principles applied not falling
under one of the above headings should be recorded in a distinct list
of items.  Experience shows that a full record should be kept of
decisions relating to editorial principles and encoding practice,
both for future users of the text and for the project which produced
...
XML location: `/div[1]/div[3]/div[3]/specGrp[1]`.
...
XML location: `/div[1]/div[3]/div[3]/p[4]`.
...
```xml
<head>The Tagging Declaration</head>
```
...
XML location: `/div[1]/div[3]/div[4]/p[3]`.

```xml
<p>The <gi>tagsDecl</gi> element is descriptive, rather than prescriptive: if used, it simply documents
practice in the TEI document containing it. The elements constituting a TEI customization file (discussed in chapter <ptr target="#TD"/>) by contrast
document expected practice in a number of documents, and may thus be used prescriptively. If there is an inconsistency between 
the actual state of a document and what is documented by its <gi>tagsDecl</gi>, then the latter should be corrected. If there is an
inconsistency between a document and what is required by the customization file, or a schema derived from it, then it will usually be the
...
XML location: `/div[1]/div[3]/div[4]/p[4]`.
...
XML location: `/div[1]/div[3]/div[4]/div[1]/p[3]`.
...
XML location: `/div[1]/div[3]/div[4]/div[1]/p[4]`.
...
XML location: `/div[1]/div[3]/div[4]/div[1]/p[5]`.
...
XML location: `/div[1]/div[3]/div[4]/div[1]/p[6]`.
...
XML location: `/div[1]/div[3]/div[4]/div[1]/p[7]`.
...
XML location: `/div[1]/div[3]/div[4]/div[1]/p[8]`.
...
XML location: `/div[1]/div[3]/div[4]/div[1]/p[9]`.
...
XML location: `/div[1]/div[3]/div[5]/head[1]`.

```xml
<head>The Default Style Definition Language Declaration</head>
```
...
XML location: `/div[1]/div[3]/div[5]/p[1]`.
...
XML location: `/div[1]/div[3]/div[5]/p[2]`.
...
XML location: `/div[1]/div[3]/div[5]/p[3]`.
...
XML location: `/div[1]/div[3]/div[6]/head[1]`.

```xml
<head>The Reference System Declaration</head>
```
...
XML location: `/div[1]/div[3]/div[6]/p[1]`.
...
XML location: `/div[1]/div[3]/div[6]/p[2]`.
...
XML location: `/div[1]/div[3]/div[6]/p[3]`.
...
XML location: `/div[1]/div[3]/div[6]/div[1]/head[1]`.

```xml
<head>Prose Method</head>
```
...
XML location: `/div[1]/div[3]/div[6]/div[1]/p[1]`.
...
XML location: `/div[1]/div[3]/div[6]/div[1]/p[2]`.
...
XML location: `/div[1]/div[3]/div[6]/div[2]/head[1]`.
...
XML location: `/div[1]/div[3]/div[6]/div[2]/p[1]`.
...
XML location: `/div[1]/div[3]/div[6]/div[3]/head[1]`.

```xml
<head>Milestone Method</head>
```
...
XML location: `/div[1]/div[3]/div[6]/div[3]/p[1]`.
...
XML location: `/div[1]/div[3]/div[6]/div[3]/p[2]`.
...
XML location: `/div[1]/div[3]/div[6]/div[3]/p[3]`.
...
XML location: `/div[1]/div[3]/div[6]/div[3]/p[4]`.
...
XML location: `/div[1]/div[3]/div[6]/div[3]/p[5]`.
...
XML location: `/div[1]/div[3]/div[6]/div[3]/p[6]`.
...
XML location: `/div[1]/div[3]/div[6]/div[3]/specGrp[1]`.
...
XML location: `/div[1]/div[3]/div[6]/div[3]/p[7]`.
...
XML location: `/div[1]/div[3]/div[7]/head[1]`.

```xml
<head>The Classification Declaration</head>
```
...
XML location: `/div[1]/div[3]/div[7]/p[1]`.
...
XML location: `/div[1]/div[3]/div[7]/p[2]`.
...
XML location: `/div[1]/div[3]/div[7]/p[3]`.
...
XML location: `/div[1]/div[3]/div[7]/p[4]`.
...
XML location: `/div[1]/div[3]/div[7]/p[5]`.
...
XML location: `/div[1]/div[3]/div[7]/specGrp[1]`.
...
XML location: `/div[1]/div[3]/div[8]/head[1]`.

```xml
<head>The Geographic Coordinates Declaration</head>
```
...
XML location: `/div[1]/div[3]/div[8]/p[1]`.
...
XML location: `/div[1]/div[3]/div[8]/include[1]`.
...
XML location: `/div[1]/div[3]/div[9]/head[1]`.

```xml
<head>The Unit Declaration</head>
```
...
XML location: `/div[1]/div[3]/div[9]/p[1]`.
...
XML location: `/div[1]/div[3]/div[9]/p[2]`.
...
XML location: `/div[1]/div[3]/div[9]/egXML[1]`.
...
XML location: `/div[1]/div[3]/div[9]/egXML[2]`.
...
XML location: `/div[1]/div[3]/div[9]/egXML[3]`.
...
XML location: `/div[1]/div[3]/div[9]/specGrp[1]`.
...
XML location: `/div[1]/div[3]/div[10]/head[1]`.

```xml
<head>The Schema Specification</head>
```
...
XML location: `/div[1]/div[3]/div[10]/p[1]`.
...
XML location: `/div[1]/div[3]/div[10]/p[2]`.
...
XML location: `/div[1]/div[3]/div[10]/p[3]`.
...
XML location: `/div[1]/div[3]/div[11]/head[1]`.
...
XML location: `/div[1]/div[3]/div[11]/p[1]`.
...
XML location: `/div[1]/div[3]/div[11]/p[2]`.

```xml
<p>The class <ident type="class">model.applicationLike</ident>
provides an element, <gi>application</gi>, which may be used to record
such information within the <gi>appInfo</gi> element.<specList>
<specDesc key="appInfo"/>
<specDesc key="application" atts="ident version"/>
...
XML location: `/div[1]/div[3]/div[11]/p[3]`.

```xml
<p>Each <gi>application</gi> element identifies the current state of
one software application with regard to the current file.  This
element is a member of the <ident type="class">att.datable</ident>
class, which provides a variety of attributes for associating this
state with a date and time, or a temporal range. The <att>ident</att>
...
XML location: `/div[1]/div[3]/div[11]/p[4]`.
...
XML location: `/div[1]/div[3]/div[11]/specGrp[1]`.

```xml
<specGrp xml:id="DHDAPP"><include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/appInfo.xml"/><include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/application.xml"/><!--&model.applicationLike;-->
</specGrp>
```
...
XML location: `/div[1]/div[3]/div[12]/head[1]`.

```xml
<head>Module-Specific Declarations</head>
```
...
XML location: `/div[1]/div[3]/div[12]/p[1]`.
...
XML location: `/div[1]/div[3]/div[12]/p[2]`.

```xml
<p>The <gi>fsdDecl</gi> element is available only when the <ident type="module">iso-fs</ident> module is included in a schema. Its
purpose is to document the <term>feature system declaration</term> (as
defined in chapter <ptr target="#FD"/>) underlying any analytic
<term>feature structures</term> (as defined in chapter <ptr target="#FS"/>) present in the text documented by this header. </p>
```
...
XML location: `/div[1]/div[3]/div[12]/p[3]`.

```xml
<p>The <gi>metDecl</gi> element is available only when the <ident type="module">verse</ident> module is included in a schema. Its
purpose is to document any metrical notation scheme used in the text,
as further discussed in section <ptr target="#VEME"/>. It consists
either of a prose description or a series of <gi>metSym</gi>
elements.</p>
...
XML location: `/div[1]/div[3]/div[12]/p[4]`.

```xml
<p>The <gi>variantEncoding</gi> element is available only when the
<ident type="module">textcrit</ident> module is included in a
schema. Its purpose is to document the method used to encode textual
variants in the text, as discussed in section <ptr target="#TCAPLK"/>.</p>
```
...
XML location: `/div[1]/div[4]/specGrp[1]`.
...
XML location: `/div[1]/div[4]/div[1]/specGrp[1]`.
...
XML location: `/div[1]/div[4]/div[3]/head[1]`.

```xml
<head>The Text Classification</head>
```
...
XML location: `/div[1]/div[4]/div[3]/p[1]`.
...
XML location: `/div[1]/div[4]/div[3]/p[2]`.
...
XML location: `/div[1]/div[4]/div[3]/p[3]`.
...
XML location: `/div[1]/div[4]/div[3]/p[4]`.
...
XML location: `/div[1]/div[4]/div[3]/p[5]`.
...
XML location: `/div[1]/div[4]/div[3]/p[6]`.
...
XML location: `/div[1]/div[4]/div[3]/p[7]`.
...
XML location: `/div[1]/div[4]/div[3]/p[8]`.
...
XML location: `/div[1]/div[4]/div[3]/p[9]`.
...
XML location: `/div[1]/div[4]/div[3]/p[10]`.
...
XML location: `/div[1]/div[4]/div[3]/p[11]`.
...
the <att>target</att> attribute on the <gi>catRef</gi> element, as
in the following example:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD43-egXML-mu" xml:lang="und" source="#UND"><catRef target="#b.a4 #b.d2"/></egXML></p>
```
...
XML location: `/div[1]/div[4]/div[3]/p[12]`.

```xml
<p>The <att>scheme</att> attribute
may be supplied to specify the taxonomy to which the categories
identified by the target attribute belong, if this is not adequately
conveyed by the  resource pointed to. For example,
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HD43-egXML-hk" xml:lang="und" source="#UND"><catRef target="#b.a4 #b.d2" scheme="http://www.example.com/browncorpus"/>
...
XML location: `/div[1]/div[4]/div[3]/p[13]`.
...
XML location: `/div[1]/div[4]/div[3]/p[14]`.
...
XML location: `/div[1]/div[4]/div[3]/specGrp[1]`.
...
XML location: `/div[1]/div[4]/div[4]/head[1]`.
...
XML location: `/div[1]/div[4]/div[4]/p[1]`.
...
XML location: `/div[1]/div[4]/div[4]/p[2]`.
...
XML location: `/div[1]/div[4]/div[4]/p[3]`.
...
XML location: `/div[1]/div[4]/div[5]/head[1]`.

```xml
<head>Calendar Description</head>
```
...
XML location: `/div[1]/div[4]/div[5]/p[1]`.
...
XML location: `/div[1]/div[4]/div[5]/p[2]`.
...
XML location: `/div[1]/div[4]/div[5]/p[3]`.
...
XML location: `/div[1]/div[4]/div[5]/p[4]`.
...
XML location: `/div[1]/div[4]/div[5]/specGrp[1]`.
...
XML location: `/div[1]/div[4]/div[6]/head[1]`.
...
XML location: `/div[1]/div[4]/div[6]/p[1]`.
...
XML location: `/div[1]/div[4]/div[6]/p[2]`.
...
XML location: `/div[1]/div[4]/div[6]/p[3]`.
...
XML location: `/div[1]/div[4]/div[6]/p[4]`.
...
XML location: `/div[1]/div[4]/div[6]/p[5]`.
...
XML location: `/div[1]/div[4]/div[6]/p[6]`.
...
XML location: `/div[1]/div[4]/div[6]/p[7]`.
...
XML location: `/div[1]/div[4]/div[6]/p[8]`.
...
XML location: `/div[1]/div[4]/div[6]/p[9]`.
...
XML location: `/div[1]/div[4]/div[6]/p[10]`.
...
XML location: `/div[1]/div[4]/div[6]/specGrp[1]`.
...
XML location: `/div[1]/div[5]/specGrp[1]`.
...
XML location: `/div[1]/div[6]/specGrp[1]`.
...
```xml
<head>Minimal and Recommended Headers</head>
```
...
```xml
<p>The only mandatory component of the TEI header is the
<gi>fileDesc</gi> element.  Within this, <gi>titleStmt</gi>,
<gi>publicationStmt</gi>, and <gi>sourceDesc</gi> are all required
constituents.  Within the title statement, a title is required, and an
author should be specified, even if it is <mentioned>unknown</mentioned>, as
...
```xml
<head>Note for Library Cataloguers</head>
```
...
```xml
<p>A strong motivation in preparing the material in this chapter was to
provide in the TEI header a viable chief source of information
for cataloguing computer files.  The TEI header is not
a library catalogue record, and so will not make all of the distinctions
essential in standard library work.  It also includes much information
