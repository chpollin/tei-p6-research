...
source: '[[00_sources/tei-p5-guidelines-gd-graphsnetworkstrees-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 Graphs, Networks, and Trees
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Guidelines/en/GD-GraphsNetworksTrees.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 54901. Git blob: `eddf6facdeb9de4d5adc6cd7aeeee8b4cc375c33`.
...
<div>
  ...
  <moduleSpec xml:id="DGD" ident="nets">
    ...
    <desc xml:lang="fr" versionDate="2018-07-09">Graphes, réseaux et arbres</desc>
    <desc xml:lang="zh-TW" versionDate="2018-07-09">圖形、網絡與樹狀結構</desc>
    <desc xml:lang="it" versionDate="2018-07-09">Grafici, reti e alberi</desc>
    <desc xml:lang="pt" versionDate="2018-07-09">Grafos, redes, e árvores</desc>
    <desc xml:lang="ja" versionDate="2018-07-09">グラフモジュール</desc>
  </moduleSpec>
...
```xml
<head>Graphs, Networks, and Trees</head>
```
...
```xml
<head>Historical Interpretation</head>
```
...
```xml
<head>Another Tree Notation</head>
```
...
```xml
<head>Representing Textual Transmission</head>
```
