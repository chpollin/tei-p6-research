...
source: '[[00_sources/tei-p5-guidelines-ab-about-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 About These Guidelines
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Guidelines/en/AB-About.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 46735. Git blob: `dd7983d510d0e55e4e9e4d983d8ea52418da43ae`.
...
<p>The remaining two sections of the front matter to these Guidelines
...
<p>The body of this edition of these Guidelines proper contains 23
...
and <ident type="class">att.global</ident> for an attribute class.
  ...
  <div xml:id="AB-modal">
    ...
    <p>In general the TEI guidelines try to be careful when using modal verbs and phrases such as 'must', 'must not, 
      'should', 'should not' and 'may'. In terms of the meanings, these generally follow <ptr target="https://tools.ietf.org/html/bcp14"/> in the different meanings of these words.
      In particular:
      <list type="gloss">
        <label>MUST</label>
        <item>This word, or the terms "REQUIRED" or "SHALL", means that this is an absolute requirement of the TEI Guidelines 
          for production of a TEI conformant file.</item>
        <label>MUST NOT</label>
        <item>This phrase, or the phrase "SHALL NOT", means that this is an absolute prohibition of the 
          TEI Guidelines for production of a TEI conformant file.</item>
        <label>SHOULD</label>
        <item>This word, or the adjective "RECOMMENDED", means that there may exist valid reasons in 
        ...
        <item>This phrase, or the phrase "NOT RECOMMENDED" means that there may exist valid reasons in 
        ...
        <label>MAY</label>
        <item>This word, or the adjective "OPTIONAL", means that a recommendation is truly optional.  One user may 
...
an attribute class, a model class, a datatype, or a macro: <table xml:id="ABSTRUNC-table-vo">
<row role="label">
<cell>Component</cell>
<cell>Name</cell>
<cell>Example</cell>
...
<row><cell>Datatypes</cell><cell>teidata.*</cell><cell>teidata.pointer</cell></row>
</table>
</p>
...
<soCalled>copy text</soCalled>, etc.  However, these Guidelines are
...
<p>The rules defining conformance to these Guidelines are
...
as <term>tag abuse</term> and strongly discouraged.</item>
...
extensions should not be associated with the TEI namespace.  </item>
...
XML location: `/div[1]/div[1]/div[2]/div[1]/p[4]`.
...
XML location: `/div[1]/div[1]/div[2]/div[1]/p[5]`.
...
XML location: `/div[1]/div[1]/div[5]/div[1]/head[1]`.

```xml
<head>Use in Text Capture and Text Creation</head>
```
...
XML location: `/div[1]/div[1]/div[5]/div[1]/p[1]`.
...
XML location: `/div[1]/div[1]/div[5]/div[1]/p[2]`.
...
XML location: `/div[1]/div[1]/div[5]/div[1]/p[3]`.
...
XML location: `/div[1]/div[1]/div[5]/div[1]/p[4]`.
...
XML location: `/div[1]/div[1]/div[5]/div[1]/p[5]`.
...
XML location: `/div[1]/div[1]/div[5]/div[2]/head[1]`.

```xml
<head>Use for Interchange</head>
```
...
XML location: `/div[1]/div[1]/div[5]/div[2]/p[1]`.
...
XML location: `/div[1]/div[1]/div[5]/div[2]/p[2]`.
...
XML location: `/div[1]/div[1]/div[5]/div[2]/p[3]`.
...
XML location: `/div[1]/div[1]/div[5]/div[2]/p[4]`.
...
XML location: `/div[1]/div[1]/div[5]/div[2]/p[5]`.
...
XML location: `/div[1]/div[1]/div[5]/div[2]/p[6]`.
...
XML location: `/div[1]/div[1]/div[5]/div[3]/head[1]`.

```xml
<head>Use for Local Processing</head>
```
...
XML location: `/div[1]/div[1]/div[5]/div[3]/p[1]`.
...
XML location: `/div[1]/div[1]/div[5]/div[3]/p[2]`.
...
XML location: `/div[1]/div[1]/div[5]/div[3]/p[3]`.

```xml
<p>Because the TEI format is expressed using XML, 
almost any modern text processing system is able to process it, and
new TEI-aware software systems are able to build on a solid base
of existing software libraries. </p>
```
...
```xml
<head>Future Developments and Version Numbers</head>
```
