...
source: '[[00_sources/tei-p5-guidelines-ph-primarysources-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 Representation of Primary Sources
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Guidelines/en/PH-PrimarySources.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 237776. Git blob: `e785b299a1216f919ad6ae00fe3b77a039ddd854`.
...
<div xmlns="http://www.tei-c.org/ns/1.0" xmlns:xi="http://www.w3.org/2001/XInclude" type="div1"
   xml:id="PH" n="18">
   <head>Representation of Primary Sources</head>

   <p>This chapter describes elements that may be used to represent primary source materials, such
      as manuscripts, printed books, ephemera, or other textual documents. Some of these specialized
      elements, particularly at phrase-level, add to the other elements available within
         <gi>text</gi> to deal with textual phenomena more specific to primary source transcription.
      ...
      textual structure (that is, the elements described in chapter <ptr target="#DS"/>). These
      elements, <gi>facsimile</gi>, <gi>sourceDoc</gi>, and their children, may be used in parallel
      and in combination with an encoding of logical text structures with <gi>text</gi>, or as
      standalone representations. The element <gi>sourceDoc</gi> in particular provides a way of
      combining facsimile and transcriptions by embedding transcribed text. This approach focuses on
      physical and textual features that can be primarily described spatially, such as the sequence
      of pages in a manuscript, or the layout of a printed page. This is not meant to be the only
      way of transcribing primary sources in TEI, or even a preferred way; which approach is more
      appropriate will depend on the specific needs of your project.</p>

   <p>Although this chapter discusses manuscript materials more frequently than other forms of
      written text, most of the recommendations presented are equally applicable to facsimiles of a
      wide variety of media, including printed matter, monumental inscriptions, and art. Each medium
      has its own vocabulary of agents. In the following examples, terms such as
         <soCalled>scribe</soCalled>, <soCalled>author</soCalled>, <soCalled>editor</soCalled>,
         <soCalled>annotator</soCalled> or <soCalled>corrector</soCalled> may be re-interpreted in
      terms more appropriate to the medium being transcribed. In printed material, for example, the
         <soCalled>compositor</soCalled> plays a role analogous to the <soCalled>scribe</soCalled>,
      while in an authorial manuscript, the <soCalled>author</soCalled> and the
         <soCalled>scribe</soCalled> are the same person.</p>

   <p>This module may be used in conjunction with other modules. These recommendations are not
      intended to meet every transcriptional circumstance likely to be faced by any scholar. They
      are intended rather as a base to enable encoding of the most common phenomena found in the
      course of scholarly transcription of primary source materials. These guidelines do not address
      the encoding of physical description of textual witnesses: the materials of the carrier, the
      medium of the inscribing implement, the organisation of the carrier materials themselves (such
      as quiring, collation), authorial instructions or scribal markup, etc., except insofar as
      these are involved in the broader question of manuscript description, as addressed by the
         <ident type="module">msdescription</ident> module described in chapter <ptr target="#MS"/>. </p>

   <p>This chapter begins by describing elements for handling digitally-encoded images of primary
      source materials for the purpose of creating digital facsimiles using the <gi>facsimile</gi>
      element (<ptr target="#PHFAX"/>).</p>
   <p>The next section (<ptr target="#PH-transcr"/>) describes two ways of combining a facsimile
      images with a transcription; either by referencing a parallel transcription in <gi>text</gi>,
      or by providing an <soCalled>embedded</soCalled> transcription that prioritizes the encoding
      of a resource’s spatial features via the <gi>sourceDoc</gi> element and a number of
      transcriptional elements. </p>
   <p>Section <ptr target="#PHST"/> documents elements that support scholars in recording
      information about specific features of the text written on its physical carrier, such as <ptr
         target="#PHCH"/> and <ptr target="#PHPH"/></p>
   <p>Section <ptr target="#PHLAY"/> describes how complex page layouts may be represented.</p>
   <p>Section <ptr target="#PHSK"/> introduces the element <gi>fw</gi> (<term>forme work</term>) for
      encoding material repeated from page to page that falls outside the stream of the text.</p>
   <p>Section <ptr target="#PH-changes"/> describes how to document changes made during the
      production or revision of a primary source.</p>
   <p>The chapter concludes with a technical overview of the structure and organization of the
      module described here. Some elements from other chapters are recontexualized for situations
      involving the transcription of primary source materials, whether within <gi>text</gi> or
         <gi>sourceDoc</gi>. Therefore, this overview should be read in conjunction with chapters
         <ptr target="#CO"/> and <ptr target="#WD"/>.</p>

   <div xml:id="PHFAX">

      <head>Digital Facsimiles</head>

      <p>A common approach in the TEI to representing pre-existing sources involves transcribing or
         otherwise converting sources into character form before marking them up. However, it is
         also a common practice to make a different form of <soCalled>digital text</soCalled> that
         is instead composed of digital images of the original source, typically one per page, or
         other written surface. We call such a resource a <term>digital facsimile</term>. A digital
         facsimile may, in the simplest case, just consist of a collection of images, with some
         metadata to identify them and the source materials portrayed. It may sometimes contain a
         variety of images of the same source pages, perhaps of different resolutions, or of
         different kinds. Such a collection may form part of any kind of document, for example a
         commentary of a codicological or paleographic nature, where there is a need to align
         explanatory text with image data. It may also be complemented by a transcribed or encoded
         version of the original source, which may be linked to the page images or
            <soCalled>embedded</soCalled> as discussed in <ptr target="#PH-transcr"/>. In this
         section we present elements designed to support these various possibilities and discuss the
      ...
      <p>In the simple case where a digital text is composed of page images, the <att>facs</att>
         ...
         appropriate point in the text: <egXML xmlns="http://www.tei-c.org/ns/Examples"
            xml:id="PHFAX-egXML-it" valid="feasible" source="#UND">
            <TEI>
               <teiHeader>
                  <!--...--></teiHeader>
               <text>
         ...
         (page beginning) element, up to the next <gi>pb</gi> element. Any convenient milestone
         element (see further <ptr target="#CORS5"/>) could be used in the same way; for example if
         the images represent individual columns, the <gi>cb</gi> element might be used. Though
         simple, this method has some drawbacks. It does not scale well to more complex cases where,
         for example, the images do not correspond exactly with transcribed pages, or where the
      ...
      <p>The recommended approach to encoding facsimiles is instead to use the <att>facs</att>
         ...
         them. Typical applications include the provision of full text search in <soCalled>digital
      ...
      <p>Either of the <gi>facsimile</gi> or <gi>sourceDoc</gi> elements may be used to represent a
         digital facsimile. Either may appear within a TEI document along with, or instead of, the
            <gi>text</gi> element introduced in section <ptr target="#DS"/>. The <gi>sourceDoc</gi>
         element is used when a digital facsimile contains a transcription that prioritizes the
         encoding of the spatial features and layout of a text document over the text’s logical
         textual structure; the <gi>text</gi> element should be used when it contains a textual
         transcription focused on its logical features. When the digital facsimile contains only
         images, however, only <gi>facsimile</gi> elements should be used. In this section, we first
         discuss the simpler case, returning to the use of the <gi>sourceDoc</gi> element in section
            <ptr target="#PH-transcr"/> below. When this module is selected therefore, a legal TEI
         document may thus comprise any of the following: <list rend="bulleted">
      ...
      <p>In the simplest case, a facsimile just contains a series of <gi>graphic</gi> elements, each
         of which identifies an image file: <egXML xmlns="http://www.tei-c.org/ns/Examples"
            xml:id="PHFAX-egXML-yf" xml:lang="und" source="#UND">
            <facsimile>
      ...
      <p>In this simple case, the four page images are understood to represent the complete
         ...
         the two image files, since these correspond with the same area of the work: <egXML
            xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHFAX-egXML-fj" xml:lang="und"
            source="#UND">
            <facsimile>
               <graphic url="page1.png"/>
               <surface>
      ...
      <p>The <gi>surfaceGrp</gi> element may be used to indicate that two (or more) surfaces are
         ...
         leaf, as in this example: <egXML xmlns="http://www.tei-c.org/ns/Examples"
            xml:id="PHFAX-egXML-oq" xml:lang="und" source="#UND">
            <facsimile>
               <surfaceGrp n="leaf1">
                  <surface>
                     <graphic url="page1.png"/>
...
used to define a polygon of any shape using this coordinate system:-->
      ...
      <p>A <gi>surface</gi> element can contain one or more <gi>zone</gi> elements, each of which
         ...
         point on the perimeter of the zone.<note place="foot">The <att>points</att> attribute
            ...
            by the <gi>polyline</gi> or <gi>polygon</gi> elements in the SVG standard. See <ptr
               target="https://www.w3.org/TR/SVG/shapes.html#PointsBNF"/>
         </note></p>
      ...
      <p>We therefore define a <gi>surface</gi> element corresponding with the area of the image
         which represents the whole of the two page spread and embed the graphic within it: <egXML
            xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHFAX-egXML-hx" xml:lang="und"
            source="#UND"><facsimile>
      ...
      <p>Since the image in this example is of a two page opening, we will probably wish to define
         at least two nested zones, one for each page: <egXML
            xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHFAX-egXML-jq" source="#UND"><facsimile>
      ...
      <p>In the following extended example, we discuss a hypothetical digital edition of an early
         16th century French work, Charles de Bovelles' <title>Géometrie Pratique</title>.<note
            place="bottom">The image is taken from the collection at <ptr
               target="https://web.archive.org/web/20191023112411/http://ancilla.unice.fr/illustr.html"
            />, and was digitized from a copy in the Bibliothèque Municipale de Lyon, by whose kind
            permission it is included here.</note> In this edition, each page has been digitized as
         a separate file: for example, recto page 49 is stored in a file called <ident type="file"
            >Bovelles-49r.png</ident>. In the <gi>facsimile</gi> element used to contain the whole
         set of pages, we define a <gi>surface</gi> element for this page, which we situate within a
         coordinate scale running from 0 to 200 in the x (horizontal) axis, and 0 to 300 in the y
         (vertical) axis. The <gi>surface</gi> element contains a <gi>graphic</gi> element which
         represents the whole of this surface: <egXML xmlns="http://www.tei-c.org/ns/Examples"
            xml:id="PHFAX-egXML-iv" xml:lang="und" source="#UND"><facsimile>
         ...
         above. <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHFAX-egXML-fr"
            source="#UND"><facsimile>
               <surface ulx="0" uly="0" lrx="200" lry="300">
                  <graphic url="Bovelles-49r.png"/>
      ...
      <p>A non rectangular-zone, for example that containing the word <mentioned>cloche.</mentioned>
         at bottom left of the page, could also be defined, using the <att>points</att> attribute:
            <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHFAX-egXML-dk" source="#UND"><facsimile>
               <surface ulx="0" uly="0" lrx="200" lry="300">
                  <graphic url="Bovelles-49r.png"/>
                  <zone
      ...
      <p>In the examples above a single <gi>graphic</gi> element has been associated directly with
         the surface of the page rather than nesting it within a zone. However, it is also possible
         to include multiple <gi>zone</gi> elements which contain a <gi>graphic</gi> element, if for
         ...
         third zone above, we might encode that zone as follows: <egXML
            xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHFAX-egXML-hz" xml:lang="und"
            source="#UND">
            <zone ulx="105" uly="76" lrx="175" lry="160">
      ...
      <p>Within a <gi>surface</gi> or <gi>zone</gi>, individual lines can be identified using the
            <gi>path</gi> element, which also carries the <att>points</att> attribute: <figure
            xml:id="facs-fig3">
            <graphic url="Images/facs-fig3.jpg"/>
            <head>Smaller detail of p 49r from Bovelles highlighting two specific lines</head>
         </figure>
         <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHFAX-egXML-rl">
            <surface ulx="0" uly="0" lrx="443" lry="272">
               <graphic url="facs-fig3.jpg"/>
               <path points="74,73 171,244" xml:id="balan"/>
               <path points="71,203 173,116" xml:id="dindan"/>
            </surface></egXML> This is useful for linking an annotation or explanation to a specific
         line on an object surface. Any number of coordinates can be included to specify lines which
         are not straight; this example shows how the first of the famous <soCalled>story
            lines</soCalled> appearing at the beginning of chapter 40 of <title level="m">Tristram
            Shandy</title> might be encoded: <figure xml:id="facs-fig4">
            <graphic url="Images/sterne.png"/>
            <head>Page 152 of <title level="m">Tristram Shandy</title></head>
         </figure>
         <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHFAX-egXML-lp">
            <surface ulx="0" uly="0" lrx="411" lry="652">
               <graphic url="sterne.png"/>
               <path
                  points="65,511 88,510 92,517                    100,521 107,520 112,516 116,512                    117,511 152,512 156,508 162,505                    169,505 174,506 178,509 179,512                    236,514 136,479 208,493 270,512                    328,513 336,525 339,528 339,536                    331,539 328,535 329,530 334,526                    342,521 345,519 350,512 397,514                    402,498 414,515 425,515 435,531                    440,513 475,513 475,518 477,520                    479,521 481,522 483,521 484,518                    486,516 486,514 491,512 494,514                    496,520 496,529 493,535 494,539                    497,543 501,543 504,543 507,540                    508,537 507,526 505,518 502,510                    501,508 501,503 503,501 506,500                    510,500 512,503 513,507 511,513                    543,516 552,513 552,501 550,496                    549,490 552,486 562,487 564,468                    559,465 557,462 556,457 558,453                    562,450 570,451 573,446 579,433"
               />
            </surface></egXML>
      </p>
   ...
   <div xml:id="PH-transcr">
      ...
      <p>If the transcription is regarded as a text in its own right, organized and structured
         ...
         component parts, it can be presented as an embedded transcription, as further described in
         section <ptr target="#PHZLAB"/> below.</p>
      <div xml:id="PH-bov">
         ...
         <p>Suppose now that we wish to align a transcription of the page discussed in the preceding
            ...
            identifier: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-bov-egXML-tn"
               source="#UND"><facsimile>
                  <surface ulx="0" uly="0" lrx="200" lry="300">
            ...
            by means of the <att>facs</att> attribute: <egXML
               xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-bov-egXML-hh" xml:lang="fr">
               <pb facs="#B49r"/>
         ...
         <p>It is also possible to point in the other direction, from a <gi>surface</gi> or
            ...
            linking this page with its transcription would be simply <egXML
               xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-bov-egXML-zh" xml:lang="und"><facsimile>
                  <surface start="#PB49R">
                     <graphic url="Bovelles-49r.png"/>
                  </surface>
               </facsimile>
         ...
         <specGrp xml:id="DPFACS">
            <xi:include href="../../Specs/facsimile.xml"/>
            <xi:include href="../../Specs/sourceDoc.xml"/>
            <xi:include href="../../Specs/att.global.facs.xml"/>
            <xi:include href="../../Specs/att.global.change.xml"/>
            <xi:include href="../../Specs/surface.xml"/>
            <xi:include href="../../Specs/surfaceGrp.xml"/>
            <xi:include href="../../Specs/att.coordinated.xml"/>
            <xi:include href="../../Specs/zone.xml"/>
            <xi:include href="../../Specs/path.xml"/>
            <xi:include href="../../Specs/model.resource.xml"/>
            <xi:include href="../../Specs/model.describedResource.xml"/>
         </specGrp>
      ...
      <div xml:id="PHZLAB">
         ...
         <p>Returning to the preceding example, we might transcribe the content of the zone to which
            ...
            follows: </p>
         <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHZLAB-egXML-kf">
            <sourceDoc>
               <surface ulx="0" uly="0" lrx="200" lry="300">
         ...
         <p>Using these elements, the Whitman draft above might be encoded as follows: <egXML
               xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHZLAB-egXML-pk" source="#WHITMS2">
               <surface>
                  <zone>
                     <line>Poem</line>
         ...
         <div xml:id="PH-surfzone">
            ...
            <p>As a child of <gi>sourceDoc</gi>, the <gi>surface</gi> element both identifies a
               specific area containing writing and provides a two dimensional set of coordinates
               which can be used to position and define dimensions for sub-parts of it. In the
               context of three-dimensional objects, the <gi>surface</gi> element also provides a
               three-dimensional set of points which can be used to define the dimensions of the
               object. Furthermore, surfaces may nest within other surfaces, as in the case of
                  <q>patches</q> or other written materials attached to the main writing surface. In
               the general case, the position and dimensions of such nested surfaces will be defined
               using the same coordinate system as that supplied by the parent <gi>surface</gi>
               element. It is also possible, however, that a different coordinate system is required
               for such a nested surface, perhaps because it requires a more complex granularity. We
               consider both possibilities.</p>

            <p>In the earlier examples showing nested examples we did not provide any coordinate
               information, for simplicity of presentation. Suppose however, that we wish to
               indicate the position and sizes of the newspaper scraps in <ptr target="#sleeprs"/>
               above, relative to the whole page. As previously noted, the four attributes
                  <att>ulx</att>, <att>uly</att>, <att>lrx</att> and <att>lry</att> when given on
               the <gi>surface</gi> element define the coordinate scheme, rather than specifying the
               location of that surface. We must therefore introduce an additional <gi>zone</gi>
               element, as in the following revised encoding for this example <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-surfzone-egXML-rj"
                  source="#WHITMS2">
                  ...
                  </surface></egXML> In this version of the encoding, the inner surface,
               corresponding with the first piece of newsprint, inherits locational information from
               the <gi>zone</gi> element that contains it. This zone, and the preceding one, which
               contains a sequence of <gi>line</gi> elements, are both positioned in terms of the
               coordinates specified on the outermost <gi>surface</gi> element, which defines a
               scale running from 0 to 50 in either direction. On that scale, the <gi>line</gi>
               elements occupy a rectangle with coordinates (1,1,10,10), while the nested surface
               occupies a rectangle with coordinates (4,4,20,20).</p>
            <p>Now suppose that we wish to define a finer scale grid for the newspaper patch,
               perhaps because we wish to localize zones within it with greater accuracy. To do this
               we will need to specify the position of the nested surface as in the previous
               example, but also to define the new coordinate system. We accomplish this as follows:
                  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-surfzone-egXML-mr">
                  <surface ulx="0" uly="0" lrx="50" lry="50">
                     <zone ulx="1" uly="1" lrx="10" lry="10">
                        <line>Poem</line>
                        <!-- ... -->
                     ...
                     <zone ulx="4" uly="4" lrx="20" lry="20">
                        <surface ulx="0" uly="0" lrx="100" lry="100">
                           <zone ulx="10" uly="10" lrx="90" lry="95"> Spring has just set in here,
                              and the weather [...] a steamer </zone>
                        </surface>
                     </zone>
                  </surface></egXML> As before, the second zone defines the position and size of the
               newspaper patch itself in terms of a coordinate system running from 0 to 50 on both X
               and Y axes. The nested <gi>surface</gi> element however defines a new scale for all
               of its components, running from 0 to 100 on both X and Y axes. The position of the
               nested zone containing the text <mentioned>Spring ... steamer</mentioned> is now
            ...
            <p>All of the examples so far given have involved rectangular zones, for clarity of
               ...
               examples discussed in section <ptr target="#PH-meta"/> above, we might wish to record
               the exact shape of the zone containing the metamark <mentioned>Entered</mentioned>.
               Since this is not a rectangular zone, we use the <att>points</att> attribute to
               indicate the points defining a polygon which contains it. The values used are
               expressed in terms of a coordinate space running from 0 to 229 in the X dimension,
               and 0 to 160 in the Y dimension. </p>

            <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-surfzone-egXML-bu"
               source="#UND">
               <surface ulx="0" uly="0" lrx="229" lry="160">
                  <graphic url="whitman-02.jpg"/>
                  <zone xml:id="entered" points="142,122 155,113 178,122   208,144 198,154 178,139"
                  />
               </surface>
            </egXML>

            <p>In exactly the same way, we may wish to identify the curved zone in the following
               image containing the word <mentioned>Northamptonshire</mentioned>: <figure
                  xml:id="PH-surfzone-figure-mc">
                  ...
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-surfzone-egXML-vy"
                  source="#UND">
            ...
            <p>It should be noted that a <gi>zone</gi> does not need to be entirely contained within
               the two-dimensional space defined by its parent surface. For example, we might wish
               to encode the example in <ptr target="#durlach"/> above not as a surface representing
               the whole of the two page spread, but as a surface representing only the written part
               of this opening. The written part appears 50 units from the left of the image and 20
               units from the top, while the bottom right corner of the written part appears 400
               units from the left of the image, and 280 units from the top. We therefore define the
               written surface within this image as follows: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-surfzone-egXML-of"
                  xml:lang="und" source="#UND"><facsimile>
                     <surface ulx="50" uly="20" lrx="400" lry="280">
                        <!-- ... -->
                     </surface>
                  </facsimile></egXML> To describe the whole image, we will now need to define a
               zone of interest which represents an area larger than this surface. Using the same
               coordinate system as that defined for the surface, its coordinates are
                  <val>0,0,500,321</val>. This zone of interest can be defined by a <gi>zone</gi>
               element, within which we can place the uncropped <gi>graphic</gi>: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-surfzone-egXML-du"
                  xml:lang="und" source="#UND"><facsimile>
                     <surface ulx="50" uly="20" lrx="400" lry="280">
                        <zone ulx="0" uly="0" lrx="500" lry="321">
                           <graphic
            ...
            <p>Finally, if you are using the <gi>surface</gi> and <gi>zone</gi> elements to encode a
               three-dimensional object, it is essential to include the Z-axis as well as the X- and
               Y- axes. You can represent the spatial information of a three-dimensional object
               using the <att>points</att> attribute to construct a polygonal shape. When you are
               using the <gi>surface</gi> and <gi>zone</gi> elements in a three-dimensional context,
               the <gi>surface</gi> element represents the surface of the entire three-dimensional object. The
                  <gi>graphic</gi> element can then be used to reference an image or three-dimensional model
               of the object. All the zones of interest on the object can be defined using the
                  <gi>zone</gi> element. For example, if a monument features both a relief and an
               inscription, the <gi>zone</gi> element can be used to delineate each feature
               respectively. You can use the <att>points</att> attribute on a <gi>zone</gi> element
               to represent the three-dimensional spatial information for these zones of interest.
                  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-surfzone-egXML-jo"
                  xml:lang="und" source="#UND">
                  <sourceDoc>
                     <surface xml:id="inscription" type="3Dobject">
                        <figure>
                           <graphic type="model" subtype="glb" url="inscription1.glb"/>
                           <graphic type="texture" url="texture.png"/>
                        </figure>
                        <zone xml:id="inscription1">
                           <zone xml:id="inscription1_relief"/>
                           <zone xml:id="inscription1_text" points="0,1,0 1,0,0 -1,0,0 0,-1,0">
                              <lb n="1"/>
                              <choice><expan><abbr>D</abbr><ex>is</ex></expan></choice>
                              <choice><expan><abbr>M</abbr><ex>anibus</ex></expan></choice>
                              <zone xml:id="inscription1_l2"
                                 points="0,0,0 0.5,0,0 -0.5,0,0 0,-0.5,0">
                                 <lb n="2"/><gap reason="lost" extent="unknown" unit="character"/>
                                 <zone>M</zone><zone>I</zone>
                              </zone>
                              <zone xml:id="inscription1_l3"
                                 points="0,-0.5,0 -0.5,0,0 0.5,0,0 0,0.5,0">
                                 <lb n="3" break="no"/><gap reason="lost" extent="unknown"
                                    unit="char"/>
                                 <zone>R</zone>
                              </zone>
                              <lb n="4" break="no"/>
                              <gap reason="lost" extent="unknown" unit="char"/> XXXXVII
                                       <choice><expan><abbr>stip</abbr><ex>endiorum</ex></expan></choice>
                              <lb n="5"/> XXVIII
                                 <choice><expan><abbr>Iul</abbr><ex>ius</ex></expan></choice>
                              Martialis <lb n="6"/>
                              <choice><expan><abbr>dupl</abbr><ex>icarius</ex></expan></choice> alae
                                       Britan<choice><expan><ex>n</ex><abbr>ic</abbr><ex>a</ex><abbr>e</abbr></expan></choice>
                              <lb n="7"/> heres Ermius <lb n="8"
                                       /><choice><expan><abbr>lib</abbr><ex>ertus</ex></expan></choice>
                              eius </zone>
                        </zone>
                     </surface>
                  </sourceDoc>
   ...
   <div xml:id="PHST">
      ...
      <p>When transcribing a primary source, whether using <gi>text</gi> or <gi>sourceDoc</gi>,
         scholars may wish to record information concerning individual readings of letters, words,
         or larger units. They may also wish to include other editorial material, such as comments
         on the status or possible origin of particular readings, corrections, or text supplied to
         fill lacunae. </p>
      ...
      <p>In either case, it is customary in transcriptions to register certain features of the
         ...
         chapter provides ways of encoding such information: <list rend="bulleted">
            <item>methods of recording editorial or other alterations to the text, such as expansion
               ...
               />)</item>
            <item>methods of describing important extra-linguistic phenomena in the source:
               pagination, lineation, unusual spaces, changes of manuscript hand, etc. (section <ptr
                  target="#PHPH"/>)</item>
...
recommendations form a good basis for such future work.-->
      ...
      <div type="div2" xml:id="PHCH">
         ...
         <div type="div3" xml:id="PHCO">
            ...
            <p>All of these elements bear additional attributes for specifying who is responsible
         ...
         <div type="div3" xml:id="PHAB">
            ...
            <p>These two methods of coding abbreviation may also be combined. An encoder may record,
               ...
               represented by a sequence of abbreviated characters: <figure xml:id="PHAB-figure-zk">
               ...
               indicate the two brevigraphs as follows: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAB-egXML-nu"
                  source="#PH-BIBL-1">eu<g ref="#b-er">er</g>y <g ref="#b-per">per</g>sone that
                  loketh after heuen hath a place in this ladder <!-- elsewhere -->
                  <charDecl>
                     <char xml:id="b-er">
            ...
            <p>The transcriber may also wish to indicate that, because of the presence of these
               particular characters, the two words are actually abbreviations, by using the
                  <gi>abbr</gi> element: <egXML xmlns="http://www.tei-c.org/ns/Examples"
                  xml:id="PHAB-egXML-av"><abbr>eu<g ref="#b-er">er</g>y</abbr>
               ...
               transcriber may choose silently to expand these abbreviations, using the
                  ...
                  xml:id="PHAB-egXML-wb"><expan>euery</expan>
               ...
               can be used to show that one encoding is an alternative for the other: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAB-egXML-rb"><choice><abbr>eu<g
                           ref="#b-er">er</g>y</abbr><expan>euery</expan></choice></egXML>
            </p>
            <p>When abbreviated forms such as these are expanded, two processes are carried out:
               ...
               by other characters in the expanded form of the abbreviation: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAB-egXML-dx"><abbr>eu<am><g
                           ref="#b-er"/></am>y</abbr>
               ...
               present in the abbreviated form. <egXML xmlns="http://www.tei-c.org/ns/Examples"
                  xml:id="PHAB-egXML-ss"><expan>eu<ex>er</ex>y</expan>
               ...
               considered necessary, the <gi>am</gi> and <gi>ex</gi> elements may be used within a
                  ...
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAB-egXML-pi">eu<choice><am><g
                           ref="#b-er"/></am><ex>er</ex></choice>y <choice><am><g ref="#b-per"
            ...
            <p>Further information may be attached to instances of these elements by the
               ...
               the final d of <mentioned>good</mentioned> to <mentioned>goode</mentioned>: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAB-egXML-on" source="#PH-eg-01"
                  >For alle the while that I had good<ex xml:id="exp01">e</ex> I was
                  welbeloued</egXML>
               <!--  abbr="&#x027d;" --> Then the note: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAB-egXML-lg"><note
                     target="#exp01">The stroke added to the final d could signify the plural ending
                     (-es, -is, -ys&gt;) but the singular <hi rend="it">goode</hi> was used with the
                     meaning <q>property</q>, <q>wealth</q>, at this time (v. examples quoted in
                     OED, sb. Good, C. 7, b, c, d and 8 spec.)</note></egXML> The editor might
               declare a degree of certainty for this expansion, based on the OED examples, and
               state the responsibility for the expansion: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAB-egXML-qs">For alle the while
                  that I had good<ex resp="#mp" cert="high">e</ex> I was welbeloued</egXML> The
               value supplied for the <att>resp</att> attribute should point to the name of the
               editor responsible for this and possibly other interventions; an appropriate element
               therefore might be a <gi>respStmt</gi> element in the header like the following:
                  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAB-egXML-sn">
                  <respStmt xml:id="mp">
            ...
            <p>The <gi>choice</gi> element may be used to indicate that the proposed expansion is
               ...
               represented by the hooked D, as follows: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAB-egXML-wu">For alle the while
                  that I had <choice><sic>goo<abbr>ɗ</abbr></sic>
         ...
         <div type="div3" xml:id="PHCC">
            ...
            <p>The <gi>sic</gi>, <gi>corr</gi>, and <gi>choice</gi> elements, defined in the <ident
               ...
               non-standard orthography could be recorded thus: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCC-egXML-ud">But <sic>One</sic>
                  must have lived ...</egXML> or corrected: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCC-egXML-cy">But
                     <corr>one</corr> must have lived ...</egXML> or the two possibilities might be
               represented as a choice: <egXML xmlns="http://www.tei-c.org/ns/Examples"
                  xml:id="PHCC-egXML-la">But <choice><sic>One</sic><corr>one</corr></choice> must
                  have lived ...</egXML></p>
            <p>Similarly, in this example from Albertus Magnus, both a manuscript error
               ...
               registered within a <gi>choice</gi> element: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCC-egXML-xr" xml:lang="la"
                  source="#PH-eg-02">Nos autem iam ostendimus quod nutrimentum et
            ...
            <p>The <gi>sic</gi> element is used to mark passages considered by the transcriber to be
               ...
               transcriber supplies the word <mentioned>we</mentioned> omitted by the author: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCC-egXML-mk" source="#PH-eg-03"
                  >You see that I avoid the word create for we create nothing
                     <supplied>we</supplied> develope.</egXML>
            </p>
            ...
            <p>For example, consider the following encoding of an emendation in the Hengwrt
               manuscript proposed by E. Talbot Donaldson: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCC-egXML-lp">Telle me also, to
                  what conclusioun Were membres maad, of generacioun And of so parfit wis a <choice
                     xml:id="corr117"><sic>wight</sic><corr>wright</corr></choice> ywroght? <!-- ... -->
            ...
            <p>As remarked above, where the same annotation applies to several corrections, this may
               ...
               manuscript of the same phenomenon: <egXML xmlns="http://www.tei-c.org/ns/Examples"
                  xml:id="PHCC-egXML-kd" xml:lang="la" source="#PH-eg-04">quamuis <choice
               ...
               described as follows: <egXML xmlns="http://www.tei-c.org/ns/Examples"
                  xml:id="PHCC-egXML-tv"><note target="#sic-1 #sic-2">Substitution of a more
                     familiar word which resembles graphically what the scribe should be copying but
                     which does not make sense in the context.</note></egXML>
            </p>
            <p>The <att>target</att> attribute on the <gi>note</gi> element indicates the
               ...
               chosen freely and is not treated as a pointer. <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCC-egXML-lg" xml:lang="la"
                  >quamuis <choice><sic>mens</sic><corr type="graphSubs">iners</corr></choice> que
                  nutu dei gesta sunt ... unde esset uiriliter <choice><corr type="graphSubs"
                        >uegetata</corr><sic>negata</sic></choice></egXML> Note that this encoding
               might be extended to include a range of possible corrections: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCC-egXML-bk" xml:lang="la"
                  >quamuis <choice><sic>mens</sic><corr type="graphSubs">iners</corr><corr
                        type="reversal">inres</corr></choice> que nutu dei gesta sunt ...</egXML> In
               addition, the conscientious encoder will provide documentation explaining the
               circumstances in which particular codes are judged appropriate. A suitable location
               for this might be within the <gi>correction</gi> element of the <gi>encodingDesc</gi>
               of the header, which might include a <gi>list</gi> such as the following: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCC-egXML-ru">
                  <correction>
            ...
            <p>When making a correction in a source which forms part of a textual tradition attested
               ...
               represented as follows: <egXML xmlns="http://www.tei-c.org/ns/Examples"
                  xml:id="PHCC-egXML-mp"> And of so parfit wis a <choice><sic>wight</sic><corr
                        resp="#mp" source="#Gg">wyf</corr></choice> ywroght?</egXML> The value of
               the <att>source</att> attribute here is, like the value of the <att>resp</att>
               attribute, a pointer, in this case indicating the manuscript used as a witness.
               Elsewhere in the transcribed text, a list of witnesses used in this text will be
               given, one of which has an identifier <code>Gg</code>. Each witness will be
               represented either by a <gi>witness</gi> element (see <ptr target="#TCAPLL"/>) or
               more fully by an <gi>msDesc</gi> element (see <ptr target="#MS"/>): <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCC-egXML-wl">
                  <msDesc xml:id="Gg">
                     <msIdentifier>
            ...
            <p>The <gi>app</gi> element described in chapter <ptr target="#TC"/> provides a more
               powerful way of representing all three possible readings in parallel: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCC-egXML-px">And of so parfit
                  wis a <app>
            ...
            <p>This encoding simply records the three readings found in the various traditions, and
               ...
               intervention elements such as <gi>corr</gi> can however be nested within a
                  ...
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCC-egXML-lm">And of so parfit
                  wis a <app>
                     <rdg wit="#Hg">wight</rdg>
         ...
         <div type="div3" xml:id="PHAD">
            ...
            <p>As described in section <ptr target="#COED"/>, the <gi>add</gi> element is used to
               ...
               document (see further <ptr target="#PHDH"/>): <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAD-egXML-cg" source="#PH-eg-05"
                  >Some things are best at first sight. Others — and here is one of them — <add
                     hand="#mb">do ever</add> improve by recognition [...] <handNote xml:id="mb">Max
                     Beerbohm holograph</handNote>
               </egXML>
            </p>
            ...
            <p>The <gi>del</gi> element is used to record manuscript deletions in a similar way. In
               ...
               that the deletion was by strike-through: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAD-egXML-wl" source="#PH-eg-06"
                  >For I hate this <del rend="strikethrough" hand="#dhl">my</del> body, which is so
                  dear to me ... <handNote xml:id="dhl">D H Lawrence holograph</handNote>
               </egXML></p>
            ...
            <p>The <att>place</att> attribute is also available to indicate the location of an
               ...
               Graves: <figure xml:id="PHAD-figure-pk">
               ...
               defined the identifier <code>RG</code> somewhere: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAD-egXML-ap" source="#UND">
                  <listPerson>
                     <person xml:id="RG">
                  ...
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAD-egXML-li" source="#PH-eg-07"
                  > The O.E.D. is not a dictionary so much as a corpus of precedents <del hand="#RG"
                     >in the</del>: current, obsolete, <add hand="#RG" place="above">cant,</add>
                  cataphretic and nonce-words are all included. </egXML> A little earlier in the
               same extract, Graves writes <q>for an abridgement</q> above the line, and then
               deletes it. This may be encoded similarly: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAD-egXML-dk" source="#PH-eg-07"
                  > As for 'significant artist.' You quote the O.E.D <del><add hand="#RG"
                        place="above">for an abridgement</add></del> in explanation... </egXML>
               Similarly, in the margin, the word <q>Norton</q> has been added and then deleted:
                  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAD-egXML-pl"
                  source="#PH-eg-07"> You quote the <del><add hand="#RG" place="margin"
                     >Norton</add></del> O.E.D...</egXML> The word <q>O.E.D.</q> in this first
               sentence has also clearly been the result of some redrafting: it may be that Graves
               started to write <q>Oxford</q>, and then changed it; it may be that he inserted other
               punctuation marks between the letters before replacing them with the centre dots used
               elsewhere to represent this acronym. We do not deal with these possibilities here,
               and mention them only to indicate that any encoding of manuscript material of this
               complexity will need to make decisions about what is and is not worth mentioning. </p>
...
<subst><del>foe</del><add place="margin">friend</add></subst> to men, 
            ...
            <p>An encoder may also wish to indicate that an addition replaces a specific deletion,
               ...
               the start of <q>the</q>. <egXML xmlns="http://www.tei-c.org/ns/Examples"
                  xml:id="PHAD-egXML-dp" source="#PH-eg-07"> ... are all included. <del hand="#RG"
                     >It is</del>
            ...
            <p>In this example of the use of <gi>addSpan</gi>, the insertion by Helgi Ólafsson of a
               ...
               ascribes responsibility for the addition to the manuscript to Helgi, and the
                  ...
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAD-egXML-qe" source="#PH-eg-08"
            ...
            <p>The <gi>delSpan</gi> element is used in the same way. An authorial manuscript will
               often contain <!-- For example,
in the Eliot typescript mentioned above, there are --> several occasions where
               sequences of whole lines are marked for deletion, either by boxes or by being struck
               out. If the encoder is marking up individual verse lines with the <gi>l</gi> element,
               such deletions are problematic: deletion of two consecutive lines should be regarded
               as a single deletion, but the <gi>del</gi> element must be properly nested within a
               single <gi>l</gi> element. The <gi>delSpan</gi> element solves this problem: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAD-egXML-la">
            ...
            <p>It is also often the case that deletions and additions may themselves contain other
               ...
               strike-through. Within the first of the two lines, the word
                  ...
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHAD-egXML-kw" source="#PH-eg-09"><l>
         ...
         <div type="div3" xml:id="PHSU">
            ...
            <p>As we have shown, the simplest method of recording a substitution is simply to record
               ...
               section might be encoded as follows: <egXML xmlns="http://www.tei-c.org/ns/Examples"
                  xml:id="PHSU-egXML-fa"><l>
            ...
            <p>For example, returning to the example from William James, in a passage first written
               ...
               deletions: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHSU-egXML-oz">One
                  must have lived longer with <subst><del seq="1">this</del>
            ...
            <p>A special case of a substitution may consist of a superfluous word or phrase that is
               silently replaced by some addition. E.g. a scribe abandons a word (without indicating
               it should be deleted), and then writes a replacement word immediately after. Here the
               encoder may interpret this as an <soCalled>unmarked</soCalled> deletion which can
               then be combined with a corresponding addition to a substitution.</p>
            ...
            <p> The case of a single substitution or scribal correction that involves non-contiguous
               ...
               separated in this way are part of a single scribal intervention: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHSU-egXML-zw"> While <del
                     xml:id="change1">pondering</del> thus <add xml:id="change2">she mus'd</add>,
                  her pinions fann'd<substJoin target="#change1 #change2"/>
               </egXML> Note that, unlike <gi>subst</gi>, the placement of the <gi>substJoin</gi> is
               arbitrary. It may occur before or after the relevant <gi>add</gi> and <gi>del</gi>
               elements. </p>
            ...
            <p>As a more complex example, consider the following passage:<!-- in one of the manuscripts
               ...
               <figure xml:id="PHSU-figure-ju">
                  ...
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHSU-egXML-ca" source="#PH-eg-16">
            ...
            <p>The <gi>app</gi> element presented in chapter <ptr target="#TC"/> provides similar
               ...
               James example above might thus be represented as follows: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHSU-egXML-on">One must have
                  lived longer with <app>
         ...
         <div type="div3" xml:id="PHCD">
            ...
            <p>Presume that Lawrence decided to restore <mentioned>my</mentioned> to the phrase of
               ...
               writing <q>stet</q> in the margin. This may be encoded: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCD-egXML-hg">For I hate this
         ...
         <div type="div3" xml:id="PHOM">
            ...
            <p>Where text is not transcribed, whether because of damage to the original, or because
               ...
               another source, the <gi>surplus</gi> element may be used in preference. Where the
               editor believes text to be interpolated but genuine, the <gi>secl</gi> element may be
               used instead. Where text not present in the source is supplied (whether conjecturally
               or from other witnesses) to fill an apparent gap in the text, the <gi>supplied</gi>
               element may be used. <specList>
                  <specDesc key="gap" atts="reason agent"/>
            ...
            <p>By its nature, the <gi>gap</gi> element has no content. It marks a point in the text
               ...
               passage amounting about 10 cm in length by inking over it completely: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHOM-egXML-sc" source="#PH-eg-05"
                  >Others <gap reason="cancelled" quantity="10" unit="cm"/>—and here is one of
                  them...</egXML></p>
            <p>In an autograph letter of Sydney Smith now in the Pierpont Morgan library three words
               in the signature are quite illegible: <egXML xmlns="http://www.tei-c.org/ns/Examples"
                  xml:id="PHOM-egXML-me" source="#PH-eg-10">I am dr Sr yr <gap reason="illegible"
                     quantity="3" unit="word"/>Sydney Smith</egXML> The degree of precision
               attempted when measuring the size of a gap will vary with the purpose of the encoding
               and the nature of the material: no particular recommendation is made here.</p>
            ...
            <p>Amongst the many examples cited in Hans Krummrey &amp; Silvio Panciera's classic text
               ...
               may choose any of the following three possibilities: </p>
            <list>
               <item>mark this as an erroneous form <egXML xmlns="http://www.tei-c.org/ns/Examples"
                     xml:id="PHOM-egXML-xs" source="#PHegsurp">
                     <sic>dedikararunt</sic>
                  </egXML></item>
               <item>additionally supply a corrected form <egXML
                     xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHOM-egXML-ya"
                     source="#PHegsurp">
                     <choice><sic>dedikararunt</sic>
                        <corr>dedikarunt</corr>
                     </choice>
                  </egXML></item>
               <item>indicate that the erroneous form contains surplus characters which the editor
                  wishes to suppress <egXML xmlns="http://www.tei-c.org/ns/Examples"
                     xml:id="PHOM-egXML-lh" source="#PHegsurp"> dedika<surplus>ra</surplus>runt
                  </egXML></item>
            </list>
            ...
            <p>The <gi>surplus</gi> element may also be used to mark up interpolations, as in the
               following example taken from a 13th century Italian source: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHOM-egXML-qo"
                  source="#PHegsurp2">
            ...
            <p>In the case of an interpolation which the editor regards as genuine (i.e. written by
               the author in question), but out of its original place, the <gi>secl</gi> element
               should be used instead of <gi>surplus</gi>. For example:
               <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHOM-egXML-qj" source="#PHOM-eg-secl" xml:space="preserve">
<sp>
  <ab>
    ...
    ...
           ...
           </egXML> The final line is bracketed in the Loeb edition, with a note:
                  <q>versum secl. Bothe</q>, meaning Bothe regarded this line as Plautine, but
               probably interpolated. It is easy to see how the line might have crept in as a gloss
               on the metaphor in the previous line. </p>
            ...
            <p>If some part of the source text is completely illegible or missing, an encoder may
               ...
               transcription: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHOM-egXML-ng"
                  >I am dr Sr yr <supplied reason="illegible" resp="#msm" source="#Ry2">very humble
      ...
      <div type="div2" xml:id="PHPH">
         ...
         <div type="div3" xml:id="PHDH">
            ...
            <p>A <gi>handShift</gi> element can be used to indicate a change of hand even within an
               element with a <att>hand</att> attribute. The text following the <gi>handShift</gi>
               must be considered to be in the new hand. </p>
            <p>Both <gi>handShift</gi> and <gi>handNote</gi> are members of the <ident type="class"
                  ...
                  <specDesc key="att.handFeatures"
                     atts="scribe script scribeRef            scriptRef medium scope"/>
               </specList>
            </p>
            ...
            <p>In the following example there is a change of ink within a single hand. This is
               simply indicated by a new value for the <att>medium</att> attribute on the
                  ...
                  xml:id="PHDH-egXML-vu" source="#PH-eg-11"><l>When wolde the cat dwelle in his
                     ynne</l>
            ...
            <p>In the following example, the encoder has identified two distinct hands within the
               ...
               following declarations included in the document's TEI header: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHDH-egXML-iz">
                  <handNotes>
            ...
            <p>Then the change of hand is indicated in the text: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHDH-egXML-gu" source="#PH-eg-12"
                     ><handShift new="#h1" resp="#das"/>... and that good Order Decency and regular
                  worship may be once more introduced and Established in this Parish according to
                  the Rules and Ceremonies of the Church of England and as under a good
                  Consciencious and sober Curate there would and ought to be <handShift new="#h2"
                     resp="#das"/> and for that purpose the parishioners pray</egXML></p>
         ...
         <div type="div3" xml:id="PHHR">
            ...
            <!-- TODO: This discussion needs @source! -->
            <p>The <att>hand</att> and <att>resp</att> attributes have similar, but not identical,
               ...
               consequent editorial correction of <mentioned>One</mentioned> to
                  ...
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHHR-egXML-xs"><add place="above"
                     resp="#FB" hand="#WJ">But</add>
            ...
            <p>The <att>resp</att> attribute, by contrast, indicates the person responsible for
               ...
               itself. It should be noted that the <att>source</att> attribute may be used in a
               simiilar fashion to indicate, for example, when an encoding decision is based on the
               work of a previous editor or on an article. In that case, the <att>source</att> would
               point to a <gi>bibl</gi> in the bibliography.</p>
...
attribute (<gi>sic</gi>, <gi>abbr</gi>, <gi>del</gi>, etc.).  In all--> In cases where
               both the <att>resp</att> and <att>cert</att> attributes are defined for a particular
               element, the two attributes refer to the same aspect of the markup. The one indicates
               who is intellectually responsible for some item of information, the other indicates
               the degree of confidence in the information. Thus, for a correction, the
...
-->
            <p>It should be noted that the certainty and responsibility mechanisms described in
               ...
               Donaldson's conjectured emendation of <mentioned>wight</mentioned> to
                  ...
                  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHHR-egXML-yh">
               ...
               using the certainty and responsibility mechanisms, as follows: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHHR-egXML-pz">
         ...
         <div type="div3" xml:id="PHDA">
            ...
            <p>In the first line of this leaf, the transcriber may believe that the last three
               letters of <mentioned>daga</mentioned> can be read clearly despite the damage: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHDA-egXML-ga" source="#PH-eg-13"
                  xml:lang="non">um aldr d<damage>aga</damage> yndisniota</egXML>
            </p>
            <p>If, as is often the case, the damage crosses structural divisions, so that the
               ...
               way as the <gi>delSpan</gi> and <gi>addSpan</gi> elements discussed in section <ptr
                  ...
                  xml:id="PHDA-egXML-ou" source="#PH-eg-13"><p>
                     <!-- ... -->
                     <pb n="5r"/>
            ...
            <p>If, as is also likely, the damage affects several disjoint parts of the text, each
               ...
               has affected an area covering parts of several lines: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHDA-egXML-jl"><l> The Moving
                     Finger wri<damage agent="water" group="1">es; and</damage> having writ,</l>
            ...
            <p>If the damage has been so severe as to render parts of the text only imperfectly
               ...
               reading might indicate this as follows: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHDA-egXML-yb" xml:lang="mul">um
                  aldr d<unclear reason="damage">aga</unclear> yndisniota</egXML></p>
            <p>If it is desired to supply more information about the kind of damage, it is also
               possible to nest an <gi>unclear</gi> element within the <gi>damage</gi> element:
                  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHDA-egXML-fa"
                  xml:lang="mul">um aldr d<damage agent="rubbing"><unclear>aga</unclear></damage>
                  yndisniota</egXML></p>
            <p>Alternatively, the transcriber may not feel able to read the last three letters of
               ...
               use of the <att>resp</att> attribute to assign the conjecture to Finnur Jónsson:
                  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHDA-egXML-yj"
                  xml:lang="mul" source="#PH-eg-13">um aldr d<supplied reason="rubbing"
                     resp="#finjon">aga</supplied> yndisniota</egXML> The <gi>supplied</gi> element
               may if desired be enclosed within a <gi>damage</gi> element: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHDA-egXML-uq" xml:lang="mul"
                  source="#PH-eg-13">um aldr d<damage agent="rubbing"><supplied source="#msm"
                        >aga</supplied></damage> yndisniota</egXML> The transcriber may also provide
               alternative conjectures by enclosing multiple <gi>supplied</gi> elements within a
                  <gi>choice</gi> element.</p>
            <p>Contrast the use of <gi>gap</gi> in the next line, where the transcriber believes
               that four letters cannot be read at all because of the damage: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHDA-egXML-uf" xml:lang="mul"
                  source="#PH-eg-13">þar komr inn dimmi dreki fliugandi naþr frann neþan <gap
                     reason="illegible" agent="rubbing" quantity="4" unit="letter"/></egXML> As with
                  <gi>supplied</gi>, this <gi>gap</gi> might be enclosed by a <gi>damage</gi>
               element.</p>
            <p>Where elements are nested in this way, information about agency, etc. is by default
               ...
               cannot be read at all: <egXML xmlns="http://www.tei-c.org/ns/Examples"
                  xml:id="PHDA-egXML-sn"><damage agent="smoke">
            ...
            <p>The above examples record imperfect legibility due to damage. When imperfect
               ...
               the context. <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHDA-egXML-xq"
                  source="#PH-eg-14">and from time to time invited in like manner his
                     att<unclear>ention</unclear></egXML> The <att>cert</att> attribute on the
                  <gi>unclear</gi> element may be used to indicate the level of editorial confidence
               in the reading contained within it.</p>
         </div>
               ...
               in use. This may be formulated as follows: <list rend="bulleted">
                  <item>where the text has been rendered completely illegible by deletion or damage
                     and no text is supplied by the editor in place of what is lost: place an empty
                        <gi>gap</gi> element at the point of deletion or damage. Note that the
                        <gi>gap</gi> could be wrapped in a <gi>del</gi> or <gi>damage</gi> element.
                     Use the <att>reason</att> attribute to state the cause (damage, deletion, etc.)
                     of the loss of text.</item>
                  <item>where the text has been rendered completely illegible by deletion or damage
            ...
            <list rend="bulleted">
               <item>if one <gi>add</gi> element (with identifier <ident>ADD1</ident>) contains
                  another (with identifier <ident>ADD2</ident>), then the addition
                     ...
                     xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCOMB-egXML-es">This is the
                     text <add xml:id="ADD1">with some added <add xml:id="ADD2">(interlinear!)</add>
                        material</add> as written.</egXML></item>
               <item>if one <gi>del</gi> element contains another, and the <att>seq</att> attribute
                  ...
                  before the enclosing one. In the following example, the word
                     <mentioned>redundant</mentioned> was deleted before a second deletion removed
                  the entire passage: <egXML xmlns="http://www.tei-c.org/ns/Examples"
                     xml:id="PHCOMB-egXML-fk"><del>This sentence contains some <del>redundant</del>
                        unnecessary verbiage.</del></egXML></item>
               <item>if a <gi>del</gi> element contains an <gi>add</gi> element, the normal
                  ...
                  deleted in its entirety: <egXML xmlns="http://www.tei-c.org/ns/Examples"
                     xml:id="PHCOMB-egXML-ky"><del>This sentence was deleted <add>originally</add>
                        from the text.</del></egXML></item>
               <item>if an <gi>add</gi> element contains a <gi>del</gi> element, the normal
                  ...
                  been added: <egXML xmlns="http://www.tei-c.org/ns/Examples"
                     xml:id="PHCOMB-egXML-bd"><add>This sentence was added <del>eventually</del> to
                        the text.</add></egXML></item>
               <item>When some text has been blackened out so thoroughly that can no longer be read,
                  the encoding should be: <egXML xmlns="http://www.tei-c.org/ns/Examples"
                     xml:id="PHCOMB-egXML-wo">runs out the door in <gap extent="1 word"/>
                     shirt</egXML></item>
               <item>For consistency, one might prefer to encode the deletion as such, using
                     <gi>del</gi>, and containing a <gi>gap</gi>, as in the following example:
                     <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCOMB-egXML-ss">runs
                     out the door in <del><gap extent="1 word"/></del> shirt</egXML></item>
               <item>This is something that would be necessary if one wanted to encode a
                     <gi>subst</gi> including an illegible deletion: <egXML
                     xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCOMB-egXML-jk"
                              >sum<subst><del><gap extent="2 characters"/></del><add place="inline"
                           >mo</add></subst>ns</egXML></item>
               <item>If some parts of the deleted text are readable, and other parts unreadable, it
                  should be encoded as in the following example: <egXML
                     xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHCOMB-egXML-zx">Billy in The
                           <del><gap extent="1 character"/>ng<gap extent="2 characters"/></del>
                     Silver Dollar.. </egXML></item>
            </list>
         </div>
      </div>
      ...
      <div xml:id="alterations">
         ...
         <p>Modifications of various kinds (correction, addition, deletion, etc.) are frequently
            ...
            <!-- at the
   dossier level --> should be regarded in the same way as intra-document alterations.
            When two witnesses are collated, we may observe that a word present in one is missing
            from the other: this does not necessarily imply that the word was added to the first
            witness, nor that it was deleted from the other. </p>
         ...
         <div xml:id="PH-mod">
            ...
            <p>Most, if not all, transcriptional elements imply a certain level of semantic
               ...
               the document. </p>
            <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-mod-egXML-gu">
         ...
         <div xml:id="PH-meta">
            ...
            <p>In the second paragraph, the word <mentioned xml:lang="la">lege</mentioned> ("read")
               ...
               encode this as follows as an embedded transcription (keeping in mind that the
               elements described here can also be used within <gi>text</gi>):
                  <!-- ka04_1v-dtl.xml --><egXML xmlns="http://www.tei-c.org/ns/Examples"
                  xml:id="PH-meta-egXML-iv">
            ...
            <p>The <gi>metamark</gi> element may also be used to encode the symbols etc. often found
               in marked-up proofs such as the following, taken from the Walt Whitman archive:
                  <figure xml:id="PH-meta-figure-ak">
            ...
            <p>In this example, the whole of what was originally the 14th section of the poem has
               been marked for deletion, both by horizontal and vertical lines, and by the
               proofreading mark resembling the <q>deleatur</q> or <q>dele</q> deletion symbol to
               left and right of the section. The deletion itself might be encoded by using the
               normal <gi>del</gi> or <gi>delSpan</gi> element, and the metamarks by the
                  <gi>metamark</gi> element. This is quite a different case from that of the next
               example, in which the writer does not intend to suppress the content, but only to
               mark that it has been copied to another manuscript or reused. </p>
            <p>
               <figure xml:id="PH-meta-figure-iv">
            ...
            <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-meta-egXML-hy">
               <surface>
            ...
            <p>In this embedded transcription example, we class as metamarks both the long vertical
               line and the annotation <q>Entered - yes</q>. <!--The first indicates
...
has identifier <val>z2</val>. --> Both metamarks are assumed to indicate that the
               whole of the written zone with identifier <code>X2</code> is marked as having been
               used. <gi>metamark</gi> can be similarly used within <gi>text</gi> to encode the same
               phenomenon as part of a transcription that privileges logical over physical and
               layout structures. </p>
         ...
         <div xml:id="PH-fix">
            ...
            <p>In this simple example, taken from the papers of Henrik Ibsen, the writer wrote the
               ...
               letter <mentioned>l</mentioned> larger and clearer: <figure xml:id="PH-fix-figure-ux">
                  ...
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-fix-egXML-uz"> Sku<retrace
                     cause="unclear">l</retrace>dren </egXML>
            </p>
            ...
            <p>A single rewrite may not be sufficient, and it may be that the document becomes
               ...
               can distinguish at least three attempts to write the letters
                  ...
                  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-fix-egXML-rs"
                  source="#PH-ib05"> ved Bæg<retrace cause="unclear" change="#stage2">
                     <retrace cause="unclear" change="#stage1">er</retrace>
                  </retrace> ... </egXML> The <att>change</att> attribute used here is discussed
               further below (<ptr target="#PH-changes"/>). </p>
...
-->
            ...
            <p>Consider the following imaginary example: <figure xml:id="undo-figure-of">
            ...
            <p>This sequence of events might be encoded as follows: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="undo-egXML-mn"> This is <del
                     change="#s2" rend="overstrike">
                     <undo spanTo="#Xa" rend="dotted" change="#s3"/>just some <anchor xml:id="Xa"/>
                     sample <undo spanTo="#Xb" rend="dotted" change="#s3"/>text, <anchor xml:id="Xb"
                     /> we need</del>
                  <add change="#s2">not</add> a real example. </egXML> using two <gi>undo</gi>
               elements, each with a <att>spanTo</att> attribute, to delimit the two parts of the
               deletion which were reverted at change s3. Note that in this case, since
                  <att>target</att> is not supplied, it is the effect of the parent element (the
                  <gi>del</gi>) which is assumed to be undone. </p>

            <p>Alternatively, we might more economically use the generic <gi>seg</gi> element to
               delimit the two sequences whose deletion is being reverted, and then use the
                  <att>target</att> attribute on a single <gi>undo</gi> element: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="undo-egXML-az"> This is <del
                     change="#s2" rend="overstrike">
                     <seg xml:id="X-a">just some</seg> sample <seg xml:id="X-b">text</seg>, we
                     need</del>
                  <add change="#s2">not</add> a real example. <undo target="#X-a #X-b" rend="dotted"
                     change="#s3"/>
               </egXML>
...
individual tokens. Or one from a real doc -->
         ...
         <div xml:id="transpo">
            ...
            <p>Consider for example, the following extract from an Ibsen manuscript <figure
               ...
               text, the order of the two words should be reversed. We may encode this as follows:
                  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="transpo-egXML-gp"
                  source="#PH-ib04">
                  <seg xml:id="ib01">bör</seg><metamark rend="underline" function="transposition"
                     target="#ib01" place="above">2.</metamark> og <seg xml:id="ib02"
                     >hör</seg><metamark rend="underline" function="transposition" target="#ib02"
            ...
            <p>Note the use of the generic <gi>seg</gi> element to identify the sections of text
               being transposed. The following example uses an embedded transcription approach,
               which typically identifies lines of writing with the <gi>line</gi> element. This
               makes it trivial to refer to the transposed line, but when encoding transposition
               within <gi>text</gi> the encoder will need to find a way to identify the line with
               another element, such as <gi>seg</gi>.<figure xml:id="transpo-figure-lj">
               ...
               <!-- ibsen04.xml --><egXML xmlns="http://www.tei-c.org/ns/Examples"
                  xml:id="transpo-egXML-ch" source="#PH-ib01">
	    ...
	    -->
            ...
            <p>One or more <gi>listTranspose</gi> elements may be supplied either embedded within
               the text, in the <gi>profileDesc</gi> of the header, or in a <gi>standOff</gi>
               depending on local preference. Each <gi>listTranspose</gi> can contain one or more
                  <gi>transpose</gi> elements, each of which defines a single transposition.</p>
         </div>

         <div xml:id="alter">
            <head>Alternative Readings</head>
            <p><figure xml:id="alter-figure-ic">
            ...
            <p>The element <gi>alt</gi> provided by the <ident type="module">linking</ident> module
               gives a simple way of encoding the state of this manuscript, as follows: <egXML
                  xmlns="http://www.tei-c.org/ns/Examples" xml:id="alter-egXML-dt"
                  source="#PH-eg-09">Alone <seg xml:id="alt1">before</seg>
                  <add place="above" xml:id="alt2">beside</add> his native river ­— <alt
                     target="#alt1 #alt2" mode="excl" weights="0 1"/>
               </egXML>
            </p>
...
<line>While <subst><del>pondering</del> thus <add>she
   mus'd</add></subst>, her pinions fann'd</line>
         ...
         <div xml:id="instantcorr">
            ...
            <p> An example of false start or instant correction can be seen in the following line:
                  <figure xml:id="instantcorr-figure-ei" corresp="#WHITMS1">
               ...
               revision campaign as follows: <egXML xmlns="http://www.tei-c.org/ns/Examples"
                  xml:id="instantcorr-egXML-xu" source="#WHITMS1">
   ...
   <div xml:id="PHLAY">
      ...
      <p>The following methods are available to capture general aspects of the layout of material on
         ...
         surfaces, as in the following example: <egXML xmlns="http://www.tei-c.org/ns/Examples"
            xml:id="PHLAY-egXML-vd" xml:lang="und" source="#UND"><sourceDoc>
      ...
      <p>In some cases, it may be preferable to define <gi>surface</gi>s corresponding with each two
         ...
         example is shown here: <figure xml:id="PHLAY-figure-pu">
...
-->
      <p>This approach assumes that the transcription will primarily be organized in the same way as
         ...
         where a non-embedded transcription has been provided, using the <gi>text</gi> element, it
         is still possible to record gathering beginnings, page beginnings, column beginnings, line
         beginnings etc. in the source, using the elements described in section <ptr target="#CORS"
         />. Detailed metadata about the physical make-up of a source will usually be summarized by
         the <gi>physDesc</gi> component of an <gi>msDesc</gi> element discussed in <ptr
            target="#msph"/>. </p>
      ...
      <div type="div3" xml:id="PHSP">
         ...
         <p>In line 694 of Chaucer's <title>Wife of Bath's Prologue</title> in the Holkham
            manuscript the scribe has left a space for a word where other manuscripts read
               <mentioned>preestes</mentioned>: <egXML xmlns="http://www.tei-c.org/ns/Examples"
               xml:id="PHSP-egXML-kv">By god if wommen had writen storyes As <space quantity="7"
                  unit="chars"/> han within her oratoryes</egXML> The <gi>supplied</gi> element
            discussed in the previous section may be used to supply the text presumed missing:
               <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHSP-egXML-js">By god if
               wommen had writen storyes As <supplied reason="space" resp="#ETD" source="#Hg"
                  >preestes</supplied> han within her oratoryes</egXML> Here, the fact of the space
            within the manuscript is indicated by the value of the <att>reason</att> attribute. The
            source of the supplied text is shown by the value of the <att>source</att> attribute as
            the Hengwrt manuscript; the transcriber responsible for supplying the text is ES. </p>
      </div>
      <div type="div3" xml:id="PHLN">
         ...
         <p>One of the more common forms of modification encountered in written documents of any
            ...
            strike-through of <mentioned>my</mentioned> in the autograph of <title>Eloi, Eloi, lama
               ...
               xml:id="PHLN-egXML-yt">For I hate this <del rend="strikethrough" hand="#dhl">my</del>
               body, which is so dear to me</egXML></p>
         <p>There will be instances, however, where a scholar wishes only to register the occurrence
            ...
            Moulton-Barrett the underlining of the phrase <mentioned>had obtained all the letters to
               ...
               xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHLN-egXML-bp" source="#PH-eg-15">I
               have once — by declaring I would prosecute by law — hindered a man's proceedings who
                  <hi rend="underline">had obtained all the letters to Mr Boyd</hi></egXML></p>
         <p>The above examples presume the common case where a single word or phrase is marked by a
            ...
            and this uncertainty could be remarked as follows: <egXML
               xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHLN-egXML-ps">I have once — by
               declaring I would prosecute by law — hindered a man's proceedings who <hi
                  xml:id="cstart1" rend="underline">had obtained all the letters to Mr Boyd</hi>
               <!-- ... -->
   ...
   <div type="div2" xml:id="PHRB">
      <head>Transcription and Ruby</head>

      <p>These Guidelines also provide special elements to support the encoding of ruby annotations,
         which are common in East Asian textual traditions. These elements provide a method of
         capturing a specific type of annotation, in addition to the generic methods like the
            <gi>note</gi> or <gi>interp</gi> elements. Both the specific and general methods should
         integrate well with the transcriptional elements described above, allowing authorial and
         scribal features to be captured in conjunction with ruby base text and annotations. See
            <ptr target="#COHTGRB"/> for more information about these elements.</p>
   </div>
   ...
   <div type="div2" xml:id="PHSK">
      ...
      <p>For example: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PHSK-egXML-kl"><fw
               type="head" place="top-centre">Poëms.</fw>
   ...
   <div xml:id="PH-changes">
      <head>Identifying Changes and Revisions</head>
      <p>A major purpose of genetic editing is the identification of <soCalled>revision
         ...
         regard a particular set of alterations (deletions, additions, substitutions,
         transpositions, etc.) or any other act of writing as a single object for which we use the
         general term <term>change</term>, to indicate both that one or more of such phenomena
         preceded or followed another and also to indicate that they are related in some way, for
         example that one is a consequence of the other. They might also wish to group together
         certain revisions, regardless of when they might have occurred, based on a variety of other
         shared characteristics (e.g., corrections of factual errors or revisions that incorporate
         suggestions made by a given reader). To document this we need: <list>
            <item>a system to assign phenomena to a particular <soCalled>change</soCalled> as
               defined above</item>
            <item>a way to characterize each such change, in itself and in relation to
               others.</item>
         </list></p>
      ...
      <p>The element <gi>creation</gi> (within the TEI header profile description) contains all
         ...
         each set of alterations identified: <specList>
            <specDesc key="listChange" atts="ordered"/>
            <specDesc key="change"/>
         </specList>
      </p>

      <p>In the following example an editor has identified four distinct sets of alterations:</p>
      <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-changes-egXML-zh">
         <profileDesc>
            <creation>
      ...
      <p>The <gi>listChange</gi> element carries an attribute <att>ordered</att>, which can take the
         ...
         elements. <!-- Note that asserting a specific order early on, though probably
      ...
      <p>--> If necessary, <gi>listChange</gi> elements can be nested hierarchically. This
         may be helpful in two cases. Firstly one can build up hypotheses about related revisions
         step-by-step, starting with <gi>change</gi> elements of smaller coverage, whose members are
         certainly related, and then in a subsequent pass grouping these in turn, thereby extending
         their reach.</p>

      <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-changes-egXML-je">
         <profileDesc>
            <creation>
               <listChange>
      ...
      <p>A nested <gi>listChange</gi> element is also useful to indicate a <emph>partial</emph>
         ordering of <gi>change</gi> elements.</p>
      <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-changes-egXML-os">
         <listChange ordered="true">
     ...
     that they both followed ST1 and preceded STX  -->
      ...
      <p>In addition to the possibility of being ordered by their sequence within a
            <gi>listChange</gi> element, <gi>change</gi> elements may carry a number of attributes
         from the <ident type="class">att.datable</ident> class (<att>period</att>, <att>when</att>,
            <att>notBefore</att>, <att>notAfter</att>, <att>from</att>, and <att>to</att>) which
         allow each element to be dated as exactly or inexactly as necessary, in the same way as is
         currently possible for the TEI <gi>date</gi> element.</p>
      <!-- Maybe note that absolute dates and relative order can conflict -->
      <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="PH-changes-egXML-ks">
         <profileDesc>
            <creation>
      ...
      <p>Each <gi>change</gi> element, apart from declaring a distinct moment or phase in the
         creation of the document, may also contain references to other annotations contained within
         the <gi>teiHeader</gi> or in the document (as shown in the previous example). Such
         references, along with the textual content, are purely
         documentary<!-- and do not affect the
         textual stage associated with any element thus referred to-->. The association
         between a textual component and a <gi>change</gi> element is always made explicitly, either
         by using the <att>target</att> attribute on the <gi>change</gi> element to point to one or
         more textual elements, or by pointing from the element or elements concerned to the
            <gi>change</gi> element by means of their <att>change</att> attribute. If a
            <gi>change</gi> element is associated with some element, it is also associated with all
         of that element's children, unless otherwise indicated, for example by a new value for the
      ...
      <p>In this example, however, the text originally read <q>This is a house</q>, and subsequently
         ...
         second <gi>change</gi> element. The word <q>house</q>, because its deletion forms part of
         this second set of alterations, must have been present originally, whereas the word
            <q>mouse</q> must have been added during the second set of alterations. </p>
      ...
      <p>Elements such as <gi>add</gi> and <gi>del</gi> and the like carry an implied semantics
         ...
         />). Explicit indication of the set of alterations to which some modification belongs is
         mostly useful in situations where all the alterations identified in a document are to be
         grouped, for example chronologically. </p>
      <!--For example, in the
...
following ...-->
     ...
     <p>Note first that a change, once assigned to an element, is inherited by all descendants of
      ...
      <p>The interpretation of <gi>change</gi> elements with respect to a particular text passage is
         based on a number of implicit assumptions and constraints which have the effect of
         minimizing the amount of tagging necessary. The system is also flexible enough to support
         an explicit distinction between acts of writing and textual alterations, since either of
         these can be associated with changes described in the encoding. The following example shows
         an encoding in which the same passage is transcribed twice, once from a documentary
         perspective, and once from a textual one: <egXML xmlns="http://www.tei-c.org/ns/Examples"
            xml:id="PH-changes-egXML-dj">
            <profileDesc>
               <creation>
                  <listChange ordered="true">
                     ...
                     <change target="#redo_1 #redo_2 #redo_3 #subst_1 #subst_2 #delSpan_1 #add_1"
      ...
      <p>The documentary transcription stresses the writing process, while the textual transcription
         ...
         perspective, by assigning particular modifications to a specific <gi>change</gi> element,
         we describe the writing process, in that they specify which segment has been written when
   ...
   <div type="div2" xml:id="PHTRXX">
      ...
      <p>We repeat the advice given at the beginning of this chapter, that these recommendations are
         ...
         organisation of the carrier materials themselves (as quiring, collation, etc.), and
         authorial instructions or scribal markup, except insofar as these are involved in the
         broader question of manuscript description, as addressed by the <ident type="module"
   ...
   <div>
      ...
      <p>The module described in this chapter makes available the following components: <moduleSpec
            ...
            <idno type="FPI">Transcription of Primary Sources</idno>
            <desc xml:lang="en" versionDate="2006-09-13">Transcription of primary sources</desc>
            <desc xml:lang="zh-TW" versionDate="2018-07-12">原文轉錄</desc>
            <desc xml:lang="fr" versionDate="2018-07-12">Représentation de sources primaires</desc>
            <desc xml:lang="it" versionDate="2018-07-12">Trascrizione di fonti primarie</desc>
            <desc xml:lang="pt" versionDate="2018-07-12">Transcrição de fontes primárias</desc>
            <desc xml:lang="ja" versionDate="2018-07-12">転記モジュール</desc>
         </moduleSpec>
         <!--publicID:  -//TEI P5//ELEMENTS Additional Element Set for Transcription of Primary Sources//EN-->
         The selection and combination of modules to form a TEI schema is described in <ptr
            target="#STIN"/>.</p>
      <specGrp xml:id="DTCHD">
         <xi:include href="../../Specs/addSpan.xml"/>
         <xi:include href="../../Specs/damage.xml"/>
         <xi:include href="../../Specs/damageSpan.xml"/>
         <xi:include href="../../Specs/delSpan.xml"/>
         <xi:include href="../../Specs/ex.xml"/>
         <xi:include href="../../Specs/fw.xml"/>
         <xi:include href="../../Specs/handNotes.xml"/>
         <xi:include href="../../Specs/handShift.xml"/>
         <xi:include href="../../Specs/am.xml"/>
         <xi:include href="../../Specs/restore.xml"/>
         <xi:include href="../../Specs/space.xml"/>
         <xi:include href="../../Specs/subst.xml"/>
         <xi:include href="../../Specs/substJoin.xml"/>
         <xi:include href="../../Specs/supplied.xml"/>
         <xi:include href="../../Specs/surplus.xml"/>
         <xi:include href="../../Specs/secl.xml"/>
         <xi:include href="../../Specs/line.xml"/>
         <xi:include href="../../Specs/listChange.xml"/>
         <xi:include href="../../Specs/listTranspose.xml"/>
         <xi:include href="../../Specs/metamark.xml"/>
         <xi:include href="../../Specs/mod.xml"/>
         <!--<xi:include href="../../Specs/patch.xml"/>-->
         <xi:include href="../../Specs/redo.xml"/>
         <xi:include href="../../Specs/retrace.xml"/>
         <xi:include href="../../Specs/transpose.xml"/>
         <xi:include href="../../Specs/undo.xml"/>
      </specGrp>
   </div>
</div>
...
XML location: `/div[1]/div[2]/div[1]/head[1]`.
...
XML location: `/div[1]/div[2]/div[1]/p[1]`.
...
XML location: `/div[1]/div[2]/div[1]/p[2]`.
...
XML location: `/div[1]/div[2]/div[1]/specGrp[1]`.
...
XML location: `/div[1]/div[2]/div[2]/head[1]`.
...
XML location: `/div[1]/div[2]/div[2]/p[1]`.
...
XML location: `/div[1]/div[2]/div[2]/p[2]`.
...
XML location: `/div[1]/div[2]/div[2]/p[3]`.
...
XML location: `/div[1]/div[2]/div[2]/p[4]`.
...
XML location: `/div[1]/div[2]/div[2]/egXML[1]`.
...
XML location: `/div[1]/div[2]/div[2]/p[5]`.
...
XML location: `/div[1]/div[2]/div[2]/p[6]`.
...
XML location: `/div[1]/div[2]/div[2]/p[7]`.
...
XML location: `/div[1]/div[2]/div[2]/p[8]`.
...
XML location: `/div[1]/div[2]/div[2]/p[9]`.
...
XML location: `/div[1]/div[2]/div[2]/div[1]/head[1]`.
...
XML location: `/div[1]/div[2]/div[2]/div[1]/p[1]`.
...
XML location: `/div[1]/div[2]/div[2]/div[1]/p[2]`.
...
XML location: `/div[1]/div[2]/div[2]/div[1]/p[3]`.
...
XML location: `/div[1]/div[2]/div[2]/div[1]/p[4]`.
...
XML location: `/div[1]/div[2]/div[2]/div[1]/egXML[1]`.
...
XML location: `/div[1]/div[2]/div[2]/div[1]/p[5]`.
...
XML location: `/div[1]/div[2]/div[2]/div[1]/p[6]`.
...
XML location: `/div[1]/div[2]/div[2]/div[1]/p[7]`.
...
XML location: `/div[1]/div[3]/div[1]/p[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[1]/head[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[1]/p[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[1]/p[2]`.
...
XML location: `/div[1]/div[3]/div[1]/div[1]/p[3]`.
...
XML location: `/div[1]/div[3]/div[1]/div[2]/head[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[2]/p[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[2]/p[2]`.
...
XML location: `/div[1]/div[3]/div[1]/div[2]/p[3]`.
...
XML location: `/div[1]/div[3]/div[1]/div[2]/p[4]`.
...
XML location: `/div[1]/div[3]/div[1]/div[2]/p[5]`.
...
XML location: `/div[1]/div[3]/div[1]/div[2]/p[6]`.
...
XML location: `/div[1]/div[3]/div[1]/div[2]/p[7]`.
...
XML location: `/div[1]/div[3]/div[1]/div[2]/p[8]`.
...
XML location: `/div[1]/div[3]/div[1]/div[2]/p[9]`.
...
XML location: `/div[1]/div[3]/div[1]/div[2]/p[10]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/head[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[2]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[3]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[4]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[5]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[6]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[7]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[8]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[9]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[10]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[11]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[12]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[13]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[14]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[15]`.
...
XML location: `/div[1]/div[3]/div[1]/div[3]/p[16]`.
...
XML location: `/div[1]/div[3]/div[1]/div[4]/head[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[4]/p[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[4]/p[2]`.
...
XML location: `/div[1]/div[3]/div[1]/div[4]/p[3]`.
...
XML location: `/div[1]/div[3]/div[1]/div[4]/p[4]`.
...
XML location: `/div[1]/div[3]/div[1]/div[4]/p[5]`.
...
XML location: `/div[1]/div[3]/div[1]/div[4]/p[6]`.
...
XML location: `/div[1]/div[3]/div[1]/div[4]/p[7]`.
...
XML location: `/div[1]/div[3]/div[1]/div[4]/p[8]`.
...
XML location: `/div[1]/div[3]/div[1]/div[4]/p[9]`.
...
XML location: `/div[1]/div[3]/div[1]/div[4]/p[10]`.
...
XML location: `/div[1]/div[3]/div[1]/div[4]/p[11]`.
...
XML location: `/div[1]/div[3]/div[1]/div[4]/p[12]`.
...
XML location: `/div[1]/div[3]/div[1]/div[5]/head[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[5]/p[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[5]/p[2]`.
...
XML location: `/div[1]/div[3]/div[1]/div[5]/p[3]`.
...
XML location: `/div[1]/div[3]/div[1]/div[5]/p[4]`.
...
XML location: `/div[1]/div[3]/div[1]/div[5]/p[5]`.
...
XML location: `/div[1]/div[3]/div[1]/div[5]/p[6]`.
...
XML location: `/div[1]/div[3]/div[1]/div[5]/p[7]`.
...
XML location: `/div[1]/div[3]/div[1]/div[6]/head[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[6]/p[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[6]/p[2]`.
...
XML location: `/div[1]/div[3]/div[1]/div[6]/p[3]`.
...
XML location: `/div[1]/div[3]/div[1]/div[6]/p[4]`.
...
XML location: `/div[1]/div[3]/div[1]/div[7]/head[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[7]/p[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[7]/p[2]`.
...
XML location: `/div[1]/div[3]/div[1]/div[7]/p[3]`.
...
XML location: `/div[1]/div[3]/div[1]/div[7]/p[4]`.
...
XML location: `/div[1]/div[3]/div[1]/div[7]/p[5]`.
...
XML location: `/div[1]/div[3]/div[1]/div[7]/list[1]`.
...
XML location: `/div[1]/div[3]/div[1]/div[7]/p[6]`.
...
XML location: `/div[1]/div[3]/div[1]/div[7]/p[7]`.
...
XML location: `/div[1]/div[3]/div[1]/div[7]/p[8]`.
...
XML location: `/div[1]/div[3]/div[2]/p[1]`.
...
XML location: `/div[1]/div[3]/div[2]/div[1]/head[1]`.
...
XML location: `/div[1]/div[3]/div[2]/div[1]/p[1]`.
...
XML location: `/div[1]/div[3]/div[2]/div[1]/p[2]`.
...
XML location: `/div[1]/div[3]/div[2]/div[1]/p[3]`.
...
XML location: `/div[1]/div[3]/div[2]/div[1]/p[4]`.
...
XML location: `/div[1]/div[3]/div[2]/div[1]/p[5]`.
...
XML location: `/div[1]/div[3]/div[2]/div[1]/p[6]`.
...
XML location: `/div[1]/div[3]/div[2]/div[1]/p[7]`.
...
XML location: `/div[1]/div[3]/div[2]/div[1]/p[8]`.
...
XML location: `/div[1]/div[3]/div[2]/div[1]/p[9]`.
...
XML location: `/div[1]/div[3]/div[2]/div[1]/p[10]`.
...
XML location: `/div[1]/div[3]/div[2]/div[1]/p[11]`.
...
XML location: `/div[1]/div[3]/div[2]/div[1]/p[12]`.
...
XML location: `/div[1]/div[3]/div[2]/div[1]/p[13]`.
...
XML location: `/div[1]/div[3]/div[2]/div[2]/head[1]`.
...
XML location: `/div[1]/div[3]/div[2]/div[2]/p[1]`.
...
XML location: `/div[1]/div[3]/div[2]/div[2]/p[2]`.
...
XML location: `/div[1]/div[3]/div[2]/div[2]/p[3]`.
...
XML location: `/div[1]/div[3]/div[2]/div[2]/p[4]`.
...
XML location: `/div[1]/div[3]/div[2]/div[2]/p[5]`.
...
XML location: `/div[1]/div[3]/div[2]/div[2]/p[6]`.
...
XML location: `/div[1]/div[3]/div[3]/head[1]`.
...
XML location: `/div[1]/div[3]/div[3]/p[1]`.
...
XML location: `/div[1]/div[3]/div[3]/div[1]/head[1]`.
...
XML location: `/div[1]/div[3]/div[3]/div[1]/p[1]`.
...
XML location: `/div[1]/div[3]/div[3]/div[1]/p[2]`.
...
XML location: `/div[1]/div[3]/div[3]/div[1]/p[3]`.
...
XML location: `/div[1]/div[3]/div[3]/div[1]/p[4]`.
...
XML location: `/div[1]/div[3]/div[3]/div[1]/p[5]`.
...
XML location: `/div[1]/div[3]/div[3]/div[1]/p[6]`.
...
XML location: `/div[1]/div[3]/div[3]/div[1]/p[7]`.
...
XML location: `/div[1]/div[3]/div[3]/div[1]/p[8]`.
...
XML location: `/div[1]/div[3]/div[3]/div[1]/p[9]`.
...
XML location: `/div[1]/div[3]/div[3]/div[1]/p[10]`.
...
XML location: `/div[1]/div[3]/div[3]/div[1]/p[11]`.
...
XML location: `/div[1]/div[3]/div[3]/div[1]/p[12]`.
...
XML location: `/div[1]/div[3]/div[3]/div[2]/head[1]`.
...
XML location: `/div[1]/div[3]/div[3]/div[2]/p[1]`.
...
XML location: `/div[1]/div[3]/div[3]/div[2]/p[2]`.
...
XML location: `/div[1]/div[3]/div[3]/div[2]/list[1]`.
...
XML location: `/div[1]/div[3]/div[4]/head[1]`.
...
XML location: `/div[1]/div[3]/div[4]/p[1]`.
...
XML location: `/div[1]/div[3]/div[4]/p[2]`.
...
XML location: `/div[1]/div[3]/div[4]/div[1]/head[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[1]/p[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[1]/egXML[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[1]/p[2]`.
...
XML location: `/div[1]/div[3]/div[4]/div[2]/head[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[2]/p[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[2]/p[2]`.
...
XML location: `/div[1]/div[3]/div[4]/div[2]/p[3]`.
...
XML location: `/div[1]/div[3]/div[4]/div[2]/p[4]`.
...
XML location: `/div[1]/div[3]/div[4]/div[2]/p[5]`.
...
XML location: `/div[1]/div[3]/div[4]/div[2]/p[6]`.
...
XML location: `/div[1]/div[3]/div[4]/div[2]/p[7]`.
...
XML location: `/div[1]/div[3]/div[4]/div[2]/p[8]`.
...
XML location: `/div[1]/div[3]/div[4]/div[2]/p[9]`.
...
XML location: `/div[1]/div[3]/div[4]/div[2]/p[10]`.
...
XML location: `/div[1]/div[3]/div[4]/div[2]/egXML[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[2]/p[11]`.
...
XML location: `/div[1]/div[3]/div[4]/div[3]/head[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[3]/p[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[3]/p[2]`.
...
XML location: `/div[1]/div[3]/div[4]/div[3]/p[3]`.
...
XML location: `/div[1]/div[3]/div[4]/div[3]/p[4]`.
...
XML location: `/div[1]/div[3]/div[4]/div[4]/head[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[4]/p[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[4]/p[2]`.
...
XML location: `/div[1]/div[3]/div[4]/div[4]/p[3]`.
...
XML location: `/div[1]/div[3]/div[4]/div[4]/p[4]`.
...
XML location: `/div[1]/div[3]/div[4]/div[4]/p[5]`.
...
XML location: `/div[1]/div[3]/div[4]/div[4]/p[6]`.
...
XML location: `/div[1]/div[3]/div[4]/div[5]/head[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[5]/p[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[5]/p[2]`.
...
XML location: `/div[1]/div[3]/div[4]/div[5]/p[3]`.
...
XML location: `/div[1]/div[3]/div[4]/div[5]/p[4]`.
...
XML location: `/div[1]/div[3]/div[4]/div[6]/head[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[6]/p[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[6]/p[2]`.
...
XML location: `/div[1]/div[3]/div[4]/div[6]/p[3]`.
...
XML location: `/div[1]/div[3]/div[4]/div[7]/head[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[7]/p[1]`.
...
XML location: `/div[1]/div[3]/div[4]/div[7]/p[2]`.
...
XML location: `/div[1]/div[3]/div[4]/div[7]/p[3]`.
...
XML location: `/div[1]/div[4]/head[1]`.
...
XML location: `/div[1]/div[4]/div[1]/head[1]`.
...
XML location: `/div[1]/div[4]/div[1]/p[1]`.
...
XML location: `/div[1]/div[4]/div[1]/p[2]`.
...
XML location: `/div[1]/div[4]/div[2]/head[1]`.
...
XML location: `/div[1]/div[4]/div[2]/p[1]`.
...
XML location: `/div[1]/div[4]/div[2]/p[2]`.
...
XML location: `/div[1]/div[4]/div[2]/p[3]`.
...
XML location: `/div[1]/div[4]/div[2]/p[4]`.
...
XML location: `/div[1]/div[4]/div[2]/p[5]`.
...
XML location: `/div[1]/div[4]/div[2]/p[6]`.
...
XML location: `/div[1]/div[5]/head[1]`.
...
XML location: `/div[1]/div[6]/head[1]`.
...
XML location: `/div[1]/div[7]/head[1]`.
...
XML location: `/div[1]/div[7]/egXML[1]`.
...
XML location: `/div[1]/div[7]/egXML[2]`.
...
XML location: `/div[1]/div[7]/egXML[3]`.
...
XML location: `/div[1]/div[7]/egXML[4]`.
...
XML location: `/div[1]/div[8]/head[1]`.
...
XML location: `/div[1]/div[9]/head[1]`.
...
XML location: `/div[1]/div[9]/specGrp[1]`.
