...
source: '[[00_sources/tei-p5-guidelines-ch-languagescharactersets-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 Languages and Character Sets
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Guidelines/en/CH-LanguagesCharacterSets.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 44594. Git blob: `ba4acd8b2c4d9d1240116e488ed4e75d8eaedd26`.
...
attributes, if any, where a language might apply.<note place="bottom">This excludes all attributes where a non-textual
datatype has been specified, for example tokens, boolean values,
dates, and predefined value lists.</note></p>
```
...
```xml
<p>Before the significance of Unicode and the
   implications of the association between XML and Unicode can be
   adequately explained, it is necessary to clarify some key
   concepts and attempt to establish an adequately precise
   terminology for them.</p>
...
XML location: `/div[1]/div[2]/div[7]/div[1]/head[1]`.
...
XML location: `/div[1]/div[2]/div[7]/div[1]/p[1]`.
...
<p>The principles of Unicode are judiciously tempered with
   ...
   treat it as such. Where a digraph occurs in a source text, it
   should normally be encoded using the appropriate code point for
   the single abstract character which it represents. </p>
```
...
XML location: `/div[1]/div[2]/div[7]/div[2]/head[1]`.
...
XML location: `/div[1]/div[2]/div[7]/div[2]/p[1]`.
...
XML location: `/div[1]/div[2]/div[7]/div[2]/p[2]`.
...
XML location: `/div[1]/div[2]/div[7]/div[3]/head[1]`.
...
XML location: `/div[1]/div[2]/div[7]/div[3]/p[1]`.
...
XML location: `/div[1]/div[2]/div[7]/div[3]/p[2]`.
...
XML location: `/div[1]/div[2]/div[8]/div[1]/head[1]`.
...
XML location: `/div[1]/div[2]/div[8]/div[1]/p[1]`.
...
XML location: `/div[1]/div[2]/div[8]/div[1]/p[2]`.

```xml
<p>UTF-8 is a variable length encoding: the more
    significant bits there are in the underlying code point (or in
    everyday terminology the bigger the number used to represent
    the character), the more bytes UTF-8 uses to encode it. What
    makes UTF-8 particularly attractive for representing Latin
...
XML location: `/div[1]/div[2]/div[8]/div[1]/p[3]`.
...
XML location: `/div[1]/div[2]/div[8]/div[1]/p[4]`.
...
XML location: `/div[1]/div[2]/div[8]/div[1]/p[5]`.
...
<p>In projects that routinely handle documents in non-Latin
    ...
    consistency and integrity of encoding and its correct
    declaration, including the use of appropriate software for
    transcoding and verification. </p>
```
