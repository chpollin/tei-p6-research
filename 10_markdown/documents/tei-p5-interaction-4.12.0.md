...
source: '[[00_sources/tei-p5-interaction-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 interaction
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Specs/interaction.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 19738. Git blob: `67d0748668e2289c18dd9f746fd226274af221a6`.
...
<elementSpec xmlns="http://www.tei-c.org/ns/1.0" module="corpus" xml:id="gi-interaction" ident="interaction">
  <gloss versionDate="2007-06-12" xml:lang="en">interaction</gloss>
  ...
  active and passive participants in the text.</desc>
      ...
      <valList type="closed">
        <valItem ident="none">
          ...
          <desc versionDate="2008-04-05" xml:lang="ja">相互作用ではない。例えば、独白など。</desc>
...
monologue par exemple.</desc>
        ...
        <valItem ident="partial">
          ...
          <desc versionDate="2008-04-05" xml:lang="ja">ある程度の相互作用。例えば、反応する人がいる状況での独白など。</desc>
...
exemple un monologue avec une série de réponses.</desc>
        ...
        <valItem ident="complete">
          ...
          <desc versionDate="2008-04-05" xml:lang="ja">完全なる相互作用。例えば、直接対話など。</desc>
...
une conversation en tête-à-tête.</desc>
        ...
        <valItem ident="inapplicable">
          ...
          <desc versionDate="2008-04-05" xml:lang="ja">当該パラメータは、不適切、または使用が相応しくない。</desc>
   ...
   (or <term>addressors</term>) producing parts of the text.</desc>
      ...
      <valList type="semi">
        <valItem ident="singular">
          ...
          <desc versionDate="2008-04-05" xml:lang="ja">個人の参加者。</desc>
        ...
        <valItem ident="plural">
          ...
          <desc versionDate="2008-04-05" xml:lang="ja">複数の参加者。</desc>
        ...
        <valItem ident="corporate">
          ...
          <desc versionDate="2008-04-05" xml:lang="ja">団体としての参加者。</desc>
        ...
        <valItem ident="unknown">
          ...
          <desc versionDate="2008-04-05" xml:lang="ja">参加者は不明または特定不可能。</desc>
   ...
   or in whose presence it is created or performed.</desc>
      ...
      <valList type="semi">
        <valItem ident="self">
          ...
          <desc versionDate="2008-04-05" xml:lang="ja">テキストは作成者に向けられたもの。例えば、日記など。</desc>
...
un journal intime par exemple.</desc>
        ...
        <valItem ident="single">
          ...
          <desc versionDate="2008-04-05" xml:lang="ja">テキストは他の人物に向けられたもの。例えば、個人書簡など。</desc>
...
indéfini et illimité de personnes, comme un livre publié par exemple.</desc>
  ...
  <exemplum xml:lang="en">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-interaction-egXML-yj" source="#UND">
      <interaction type="complete" active="plural" passive="many"/>
    </egXML>
  </exemplum>
  <exemplum versionDate="2008-04-06" xml:lang="fr">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-interaction-egXML-jb" source="#UND">
      <interaction type="complete" active="plural" passive="many"/>
    </egXML>
  </exemplum>
  <exemplum versionDate="2008-04-06" xml:lang="fr">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-interaction-egXML-qv" source="#UND">
      <interaction type="none" active="singular" passive="group"/>
    </egXML>
  </exemplum>
  <exemplum xml:lang="en">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-interaction-egXML-gg" source="#UND">
      <interaction type="none" active="singular" passive="group"/>
    </egXML>
  </exemplum>
  <listRef>
