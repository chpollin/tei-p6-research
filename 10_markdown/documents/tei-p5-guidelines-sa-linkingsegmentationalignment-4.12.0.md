...
source: '[[00_sources/tei-p5-guidelines-sa-linkingsegmentationalignment-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 Linking, Segmentation, and Alignment
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Guidelines/en/SA-LinkingSegmentationAlignment.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 194323. Git blob: `3f54beadb9d84864514deabd3268c4bfbdd4ed11`.
...
<div xmlns="http://www.tei-c.org/ns/1.0" xmlns:xi="http://www.w3.org/2001/XInclude" type="div1" xml:id="SA" n="14">
...
provides for the following common requirements:
  <list rend="bulleted">
    ...
    <item>to store markup separately from the data it describes
    or is related to (section <ptr target="#SASO"/>);</item>
    <item>to associate segments of a text
    with interpretations or analyses of their significance (section
    <ptr target="#SAAN"/>);</item>
    <item>to group together elements used to provide stand-off
    annotation, including contextual information (section <ptr target="#SASOstdf"/>).</item>
  </list></p>
...
attribute <att>target</att>, provided by the <ident type="class">att.pointing</ident> class as a means of indicating the
...
from the <ident type="class">att.pointing</ident> and <ident type="class">att.typed</ident> classes:
<specList>
...
encoding:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTL-egXML-zk" xml:lang="und" source="#UND"><ptr xml:id="sa-p1" target="#sa-p2"/><ptr xml:id="sa-p2" target="#sa-p1"/></egXML>
...
equivalent to the more compact encoding:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTL-egXML-ov" xml:lang="und" source="#UND"><link target="#sa-p1 #sa-p2"/></egXML></p>
...
<q>Imitations</q>.</note>
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTEG-egXML-vw" xml:lang="mul" source="#SAPTEG-eg-3"><l>(Diff'rent our parties, but with equal grace</l>
<l>The Goddess smiles on Whig and Tory race,</l>
<l><note type="imitation" place="bottom">    
...
annotation:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTEG-egXML-ft" xml:lang="mul" source="#SAPTEG-eg-3"><l>(Diff'rent our parties, but with equal grace</l>
...
<note xml:id="note3.284" type="imitation" place="bottom">    
   <bibl>Virg. Æn. 10.</bibl>
   <quote>
<l>Tros Rutulusve fuat; nullo discrimine habebo.</l>
<l>—— Rex Jupiter omnibus idem.</l>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTEG-egXML-rs" source="#SAPTEG-eg-3"><l xml:id="L3.283">(Diff'rent our parties, but with equal grace</l>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTEG-egXML-vt" xml:lang="mul" source="#SAPTEG-eg-3"><note type="imitation" place="bottom" target="#L3.284">    
...
with:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTEG-egXML-sv" xml:lang="mul" source="#SAPTEG-eg-3">
<note xml:id="n3.284" type="imitation" place="bottom">    
   <ref rend="sc" target="#L3.284">Verse 283–84.
<quote>
   <l>——. With equal grace</l>
   <l>Our Goddess smiles on Whig and Tory race.</l>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTEG-egXML-wf" source="#SAPTEG-eg-3"><note type="imitation" place="bottom">    
...
follows:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTEG-egXML-gb" xml:lang="und" source="#UND"><link target="#n3.284 #r3.284 #L3.284"/></egXML></p>
    </div>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTLG-egXML-dv" xml:lang="mul"><l xml:id="L2.79">A place there is, betwixt earth, air and seas</l>
...
containing all links of this type.
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTLG-egXML-fs" xml:lang="und" source="#UND">
...
limit its search space:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTLG-egXML-xp" xml:lang="und" source="#UND">
  <!-- ... -->
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTLG-egXML-dw" source="#UND"><linkGrp type="imitation" domains="#dunciad #dunnotes" targFunc="source goal">
   <link target="#n2.79 #L2.79"/>
   <link target="#n2.88 #L2.88"/>
   <!-- ... -->
   <link target="#n3.284 #L3.284"/>
...
<xi:include href="../../Specs/link.xml"/>
<xi:include href="../../Specs/linkGrp.xml"/>
</specGrp>
    </div>
...
using for example the <gi>lg</gi> element defined in section <ptr target="#COVE"/> or the <soCalled>virtual</soCalled> <gi>join</gi>
...
<soCalled>intermediate pointer</soCalled> as follows:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTIP-egXML-bi" xml:lang="und" source="#UND">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPTIP-egXML-de" source="#UND"><link evaluate="all" target="#n3.284 #r3.284 #L3.283-284"/></egXML>
<!-- Pope, Dunciad (1729) III.284 --></p>
...
<p>Like the ubiquitous if misnamed XHTML pointing attribute <att scheme="XHTML">href</att>, the TEI pointing attributes can point to a
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAUR-egXML-xr">The current base URI in force is as defined in the
...
different protocol:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAUR-egXML-rl">This Debian package is distributed under the terms
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAUR-egXML-px"><figure rend="float fullpage">
...
Since no <att>xml:base</att> is specified here, the location of the resource
  <ident type="file">Images/compic.png</ident> is determined relative to the
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAUR-egXML-dm"><div type="chap" xml:base="http://classics.mit.edu/">
...
as in the following example.  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SABN-egXML-gn" source="#SA-eg-01"><div type="section" xml:id="sect106"><!-- ... --></div>
...
chapter and elsewhere in these Guidelines. </p>
    ...
    <div type="div3" xml:id="SAPU">
      ...
      <p>If you want to link a <gi>name</gi> in the <ident type="file">novel.xml</ident> file to a <gi>person</gi> in the <ident type="file">personography.xml</ident> file, the link will look like this:
        ...
        <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPU-egXML-oi">
      ...
      <p>One way to deal with this is to use what is often referred to as a "magic token". You could make such links using the <att>key</att> attribute:
        <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPU-egXML-xj">
      ...
      <p>A more robust alternative is to use a <term>private URI scheme</term>. This is a method of constructing a simple, key-like token which functions as a <ident type="datatype">teidata.pointer</ident>, and can therefore be used as the value of any attribute which has that datatype, such as <att>ref</att> and <att>target</att>. Such a scheme consists of a prefix (technically a private URI scheme name, as defined in <ref target="https://datatracker.ietf.org/doc/html/rfc7595">RFC 7595</ref>) with a colon, and then a value. You might, for example, use the prefix <val>psn</val> (for "person"), and structure your name tags like this:
        ...
        <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPU-egXML-vd">
          <listPrefixDef>
      ...
      <p>For any given prefix, it may be useful to supply more than one expansion. For instance, in addition to pointing at the <gi>person</gi> element in the personography file, it might also be useful to point to an external source which is available on the network, representing the same information in a different way. So there might be a second <gi>prefixDef</gi> like this:
        ...
        <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAPU-egXML-mu">
...
<item>Addresses a node or node sequence using the XPath syntax. (<ptr target="#SATSXP"/>)</item>
<label><name type="xpscheme">left()</name> and <name type="xpscheme">right()</name></label>
<item>addresses the point before (left) or after (right) a node or node 
sequence (<ptr target="#SATSL"/> and <ptr target="#SATSR"/>)</item>
...
<p>The <name type="xpscheme">xpath()</name> scheme locates zero or more nodes within an XML
  ...
  attribute nodes should be avoided in schemes other than <name type="xpscheme">xpath()</name>. </p>
...
<lb n="1" xml:id="line1"/><supplied reason="lost">si</supplied> non <choice><reg>habui</reg><orig>abui</orig></choice> quidquam vaco 
...
<p>A TEI Pointer that referenced the <gi>reg</gi> element in the 
<code>choice</code> in line 1 of the example might look like:
<lb/><code><![CDATA[#xpath(//lb[@n='1']/following-sibling::choice[1]/reg)]]></code>. 
  ...
  document they refer to is short and does not contain many elements.</p>
...
for the pointer.</p>
<p>Example: the pointer <code><![CDATA[#left(//supplied[1])]]></code>
...
<p>Example: <code><![CDATA[#left(//gap[1])]]></code> indicates the point immediately before
...
<p>Example: the pointer <code><![CDATA[#right(//lb[@n='3'])]]></code> 
...
<p>Example: <code><![CDATA[#string-index(//lb[@n='2'],1)]]></code> indicates the point
...
as a single character. Compare, for example, é (U+0060 
...
<head>range()</head>
  <p><code><![CDATA[Sequence range( POINTER, POINTER[, POINTER, POINTER ...])]]></code></p>
...
<p>Example: <code><![CDATA[#range(left(//lb[@n='3']),left(//lb[@n='4']))]]></code> indicates 
the whole of <ref target="#SATSXP-ex">line 3</ref> from the 
<code><![CDATA[<lb n="3"/>]]></code> to the point right before the 
following <code><![CDATA[<lb n="4"/>]]></code>.</p>
<p>Example: <code><![CDATA[#range(right(//lb[@n='3']),string-index(//lb[@n='3'],15))]]></code>
...
<p>Example: <code><![CDATA[#range(string-index(//lb[@n='3'],7),string-index(//lb[@n='3'],10),string-index(//lb[@n='3'],15),string-index(//lb[@n='3'],21))]]></code> indicates
the non-contiguous sequence <q>in mentem</q>.</p>
</div>

<div type="div4" xml:id="SATSSR">
<head>string-range()</head>
  <p><code><![CDATA[Sequence string-range(IDREF | XPATH, OFFSET, LENGTH[, OFFSET, LENGTH ...])]]></code></p>
...
it is captured.</p>
<p>Example: <code><![CDATA[#string-range(//lb[@n='5'],0,27)]]></code> indicates 
...
<code>ab</code> tag.</p>
<p>Example: <code><![CDATA[#string-range(//lb[@n='3'],7,8)]]></code>
indicates the sequence <q>in mente</q>.</p>
<p>Example: <code><![CDATA[#string-range(//lb[@n='3'],7,3,15,6)]]></code> indicates
the non-contiguous sequence <q>in mentem</q>.</p>
</div>
  
<div type="div4" xml:id="SATSMA">
<head>match()</head>
  <p><code><![CDATA[Sequence match(IDREF | XPATH, 'REGEX' [, INDEX])]]></code></p>
...
the match.</p>
<p>Example: <code><![CDATA[#match(//lb[@n='5'],'opto.*valeas')]]></code> indicates the sequence
<code><![CDATA[opto u<unclear>t</unclear> bene valeas]]></code> in 
<ref target="#SATSXP-ex">line 5</ref>.</p>
<p>Example: <code><![CDATA[#match(//lb[@n='3'],'semper')]]></code> would indicate the 
...
(like <val>Matt 5:7</val>) into a URI such as <code><![CDATA[#xpath(//div[@n='Matt']/div[5]/div[7])]]></code>. The
<gi>refsDecl</gi> element is described in section <ptr target="#HD54"/>; the following example is discussed in more
  detail below in section <ptr target="#SACRWE"/>. An alternative and less verbose method is described in section <ptr target="#SACRCS"/>.
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACR-egXML-na"><refsDecl xml:id="biblical">
...
<div type="div4" xml:id="SACRWE">
  ...
  <code><![CDATA[#xpath(//div[@n='$1']/div[$2]/div[$3])]]></code>, producing
  <code><![CDATA[#xpath(//div[@n='Matt']/div[5]/div[7])]]></code>.
  </p>
  <p>If, however, the input string had been <q>Matt 5</q>, the
  first regular expression would not have matched. The
  application would have then tried the second, <code><![CDATA[(.+)
  ...
  <code><![CDATA[#xpath(//div[@n='$1']/div[$2])]]></code> to produce a
  ...
  <p>If the input string had been <q>Matt</q>, neither the first
    ...
    <code><![CDATA[#xpath(//div[@n='Matt'])]]></code>.</p>
  <p>a <gi>cRefPattern</gi> should not reference more matched substrings. For example:
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACRWE-egXML-gp" xml:lang="und" source="#UND"><cRefPattern matchPattern="(.+) (.+):(.+)" replacementPattern="//div[@n='$1']/div[$2]/div[$3]/p[$4]"/></egXML>
...
<div type="div4" xml:id="SACRex">
  ...
  directly, as in the following example.
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACRex-egXML-cd" xml:lang="und">
    <refsDecl xml:id="USC">
...
<p>Canonical reference pointers are intended for use by TEI
    ...
    documents), possibly as part of their conversion to TEI.</p>
      ...
      <div type="div4" xml:id="SACRCS">
        <head>Citation Structures</head>
        <p>Citation structures provide a more thorough and concise mechanism for describing canonical references
           and the ways those references map on to parts of a TEI document. A <gi>citeStructure</gi> element
           describes a single step in a reference, such as <q>Matt</q>, and may nest to handle multi-part references.
        </p>
        <p>The equivalent structure to the set of <gi>cRefPattern</gi>s in <ptr target="#SACRWE"/> would be:
        <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACRCS-egXML-kb">
        ...
        <p>An application wishing to resolve a canonical reference such as <val>Matt 5:7</val> might follow this procedure:
          <list rend="numbered">
            <item>Ascertain the correct <gi>refsDecl</gi>
              following the rules summarized in section <ptr target="#CCAS3"/>.</item>
            <item>Begin with the outer <tag>citeStructure</tag>. If it has a <att>delim</att> attribute 
              and the reference begins with the value of <att>delim</att> then take the portion of 
              the reference after the value of <att>delim</att> as input for the next child <tag>citeStructure</tag>.</item>
            <item>For each nested <tag>citeStructure</tag>, if the input reference string contains the value 
              of the <att>delim</att>, then split the string on the value of the <att>delim</att> attribute. 
              If the input string does not contain <att>delim</att>, then stop. Take the portion of the input 
              string after the value of <att>delim</att> and use it as the input string for the child <tag>citeStructure</tag>. 
              After processing the outer <tag>citeStructure</tag>, the output will be <code>('Matt 5:7')</code>, after 
              the second, <code>('Matt', '5:7')</code>. The end result will be a 
              sequence like <code>('Matt','5','7')</code>.</item>
            <item>For each item in the resulting sequence, resolve the matching node by evaluating 
              the XPath in <att>match</att> with the predicate found in <att>use</att>, using the 
              context of the previously matched node, if any. Start with the outer <gi>citeStructure</gi> 
              and move to the next child <tag>citeStructure</tag> for each step in the sequence. For 
              example, for the first <tag>citeStructure</tag>, we could construct an XPath 
              <code><![CDATA[//div[@n='Matt']]]></code>. The full XPath after the reference <val>Matt 5:7</val> is resolved will be 
              <code><![CDATA[//div[@n='Matt']/div[@n='5']/div[@n='7']]]></code>.</item>
          </list>
          One advantage <gi>citeStructure</gi> has is that it can be used to <emph>generate</emph> canonical 
          ...
          generation of tables of contents.</p>
        <p>Citation structures may in addition specify how informational properties are to be extracted from the
          document sections they identify, using the <gi>citeData</gi> element. For example, if a TEI document 
          is divided into chapters with a <gi>div</gi> per chapter and those chapters have titles, contained in
          <gi>head</gi> elements, then we might declare a citation structure for the document thus:
          <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACRCS-egXML-fl">
            <citeStructure unit="chapter" match="/TEI/text/body/div" use="position()" delim="ch. ">
              <citeData property="http://purl.org/dc/terms/title" use="head"/>
            </citeStructure>
          </egXML>
        </p>
        <p>This specifies that chapter references are given in the form <q>ch. n</q>, where <q>n</q>
          is the position of the <gi>div</gi> in the <gi>body</gi> of the document, and that we may obtain
          the title of the chapter (identified by the Dublin Core property <code>title</code>) from the chapter
          heading. This would, for example, enable the automated generation of a chapter listing for the document.</p>
      </div>
    </div>
  </div>
...
<specDesc key="att.fragmentable" atts="part"/>
    ...
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASE-egXML-ls" source="#PNIN1">English language. Except for not very<anchor xml:id="eng1"/>
...
element is provided in these Guidelines.  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASE-egXML-gn" source="#SASE-eg-32"><q>Don't say <q><seg type="stutter">I-I-I</seg>'m afraid,</q> Melvin, just say <q>I'm
afraid.</q></q></egXML>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASE-egXML-yq" source="#SASE-eg-33">  <seg xml:id="bl0034" type="sentence">  
...
example):
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASE-egXML-rm">  <seg type="sentence" subtype="declarative">  
...
simply as
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASE-egXML-vy">  <phr type="noun">    
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASE-egXML-bh" source="#AI-eg-01"><seg xml:id="s1s3" type="narrative_unit">
...
not.
<!-- Made up example -->
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASE-egXML-yt">Give me <seg type="phrase">a dozen. Or two or three.</seg></egXML>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASE-egXML-yl"><s>Give me <seg type="phrase" part="I">a dozen.</seg></s>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASE-egXML-hw">…pressing <choice><seg type="platform" subtype="Mac">option</seg>
...
way.</p>
<p>The <gi>ab</gi> (anonymous block) element functions like the 
  <gi>seg</gi> element, but is used for portions
  of the text which occur at the <term>chunk</term> level 
  (See <ptr target="#STBTC"/>). It is therefore a member of the 
  <ident type="class">model.pLike</ident> class. Like <gi>seg</gi>, 
  but unlike <gi>p</gi>, <gi>ab</gi> may nest within other <gi>ab</gi> 
  elements. So it may be used to represent texts with irregular
  <term>chunk</term>-level structures.</p>
<p>Probably the most common use for <gi>ab</gi> is as a container for
text that does not naturally belong in a paragraph. The text of an
epitaph, for example, may not be paragraph-like, but still requires
a container:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASE-egXML-yu">
<ab style="text-align: center;">
  <lb/>SACRED 
  <lb/>to the memory of
  <lb/><abbr>M<hi rend="superscript">rs</hi><am>.</am></abbr> ALICE HUTTON
  <lb/>born at Che<g ref="#long-s">s</g>terfield in
  <lb/>Great Britain,
  <lb/><abbr>Jan<hi rend="superscript">y</hi><am>.</am></abbr> <abbr>25<hi rend="superscript">th</hi><am>.</am></abbr> 1722:
  <lb/>and died in Carolina
  <lb/><abbr>Sept<hi rend="superscript">r</hi><am>.</am></abbr> <abbr>26<hi rend="superscript">th</hi><am>.</am></abbr> 1777.
  <lb/>This <g ref="#long-s">s</g>tone
  <lb/>is placed by her only Child
  <lb/>ANN BOOTH POLLOK</ab>
</egXML>
Encoders may also prefer to treat other types of short documents, such as receipts, in this way.</p>
<p>The <gi>ab</gi> element may also be used, for
example, to tag the canonical verse divisions of Biblical texts:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASE-egXML-db" source="#SASE-eg-40"><div1 n="Gen" type="book">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASE-egXML-lx" xml:lang="de" source="#SASE-eg-41"><div1 n="Gen" type="book">
...
prose or as verse, they might be tagged as follows: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASE-egXML-yj" source="#CODR-eg-295"><div1 n="I" type="act">
  <div2 n="1" type="scene">
...
<xi:include href="../../Specs/ab.xml"/>
<xi:include href="../../Specs/anchor.xml"/>
<xi:include href="../../Specs/seg.xml"/>
</specGrp>
  </div>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASYNC-egXML-zp" source="#SA-eg-02">    <div xml:id="BNC-d1" type="convers">
<u xml:id="u2b" who="#b">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASYNC-egXML-jc" source="#UND"><back>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASYNC-egXML-mm"><u synch="#u02" xml:id="u01" who="#a">What?</u>
...
example,
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASYNC-egXML-vr"><u who="#a"> So you're <unclear synch="#u-b1"/> </u>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASYMP-egXML-ub" source="#UND"><timeline xml:id="tL1" origin="#w0" unit="ms">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASYMP-egXML-rq" source="#UND"><linkGrp type="temporal_specification" domains="#lg1 #tL1" targFunc="synch.points when">
   <link target="#L1 #w1"/>
   <link target="#L2 #w2"/>
   <link target="#L3 #w3"/>
   <link target="#l4 #w4"/>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASYMP-egXML-ce" source="#UND"><linkGrp type="temporal_specification" domains="#BNC-d1 #BNC-d1 #tL1" targFunc="speaker.a speaker.b when">
...
"smile") fragment:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASYMP-egXML-tk" xml:lang="und" valid="false" source="#UND">
<audio xmlns="http://www.w3.org/2001/SMIL20/Language" src="rtsp://soundstage.pi.cnr.it:554/home/az/bncSound/xmas4lots.mp3" xml:id="au1" begin="05.2s"/>
<audio xmlns="http://www.w3.org/2001/SMIL20/Language" src="rtsp://soundstage.pi.cnr.it:554/home/az/bncSound/xmas4lots.mp3" xml:id="au2" begin="05.7s"/>
<audio xmlns="http://www.w3.org/2001/SMIL20/Language" src="rtsp://soundstage.pi.cnr.it:554/home/az/bncSound/xmas4lots.mp3" xml:id="au3" begin="05.9s"/>
<audio xmlns="http://www.w3.org/2001/SMIL20/Language" src="rtsp://soundstage.pi.cnr.it:554/home/az/bncSound/xmas4lots.mp3" xml:id="au4" begin="06.3s"/>
<audio xmlns="http://www.w3.org/2001/SMIL20/Language" src="rtsp://soundstage.pi.cnr.it:554/home/az/bncSound/xmas4lots.mp3" xml:id="au5" begin="06.9s"/>
<audio xmlns="http://www.w3.org/2001/SMIL20/Language" src="rtsp://soundstage.pi.cnr.it:554/home/az/bncSound/xmas4lots.mp3" xml:id="au6" begin="07.4s"/>
</egXML>
...
<xi:include href="../../Specs/when.xml"/>
<xi:include href="../../Specs/timeline.xml"/>
</specGrp></div></div>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACS1-egXML-is" source="#SACS1-eg-48"><title xml:id="SHIRLEY">Shirley</title>, which made
...
and provides functionality more similar to that of the  <gi>link</gi> and <gi>linkGrp</gi> elements defined in
  ...
  example.
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACS1-egXML-vu" xml:lang="en"><title xml:id="shirley">Shirley</title>, which made
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACS1-egXML-xp" xml:lang="en">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACSAL-egXML-mj" xml:lang="mul" source="#SA-BIBL-1"><div xml:lang="en" type="subsection">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACSAL-egXML-dn" xml:lang="mul"><div xml:id="div-e" xml:lang="en" type="subsection">
  <p>
...
follows:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACSAL-egXML-ub" xml:lang="mul"><div xml:id="english" xml:lang="en" type="subsection">
  <ab xml:id="english1">  
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACSXA-egXML-pq" xml:lang="mul" source="#SA-BIBL-2"><div xml:id="e98" xml:lang="en" type="lesson">
   <head>The Study</head>
   <p>
...
requirements:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACSXA-egXML-kq" xml:lang="und" valid="false" source="#UND">
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <image xlink:href="p1764.png" width="597" height="897" id="p981"/>
...
mechanism described in section <ptr target="#COHTG"/>. The third kind of
alignment might be represented using pointers embedded within the
texts, for example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACSXA-egXML-nl" xml:lang="en">
<!--... -->
...
without redundancy.
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACSXA-egXML-vt" xml:lang="und" source="#UND"><linkGrp type="alignment">
...
more lightly tagged, as follows:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACSXA-egXML-rz" xml:lang="mul" source="#SA-BIBL-2">
...
XPath expression to identify the required <gi>ab</gi> elements:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACSXA-egXML-qc" xml:lang="und" source="#UND">
...
correspond, we might express the link between them as follows:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SACSXA-egXML-qd" xml:lang="und" source="#UND">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAIE-egXML-ib" source="#SA-eg-03"><p>In small clumsy letters he wrote:
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAIE-egXML-dr"><date sameAs="#d840404">April 4th,
1984</date>
...
recoded as follows:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAIE-egXML-oi" xml:lang="und" source="#UND"><date rend="italic" copyOf="#d840404"/></egXML></p>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAIE-egXML-yl" source="#COVE-eg-284"><sp><speaker>Mikado</speaker>
...
<p>It is recommended that the elements indicated by these attributes be of the same type as the element bearing them.</p>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAG-egXML-et" source="#SAAG-eg-72"><q><s xml:id="qs2">Monsieur Paul, after he has taken equal
...
encodings, is equivalent to specifying a <gi>link</gi> element:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAG-egXML-wt" xml:lang="und" source="#UND"><link type="join" target="#qs3 #qs4"/></egXML></p>
...
represent the virtual sentence formed by the aggregation of <val>s1</val> and <val>s2</val>:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAG-egXML-cw" xml:lang="und" source="#UND"><join target="#qs3 #qs4" result="s"/></egXML>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAG-egXML-gq"><list>
<head>Authors</head>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAG-egXML-fg">
...
follows:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAG-egXML-sh" xml:lang="und" source="#UND"><joinGrp domains="#mfkfhungry #mfkfhungry" result="s">
   <join target="#qs3 #qs4"/>
   <join target="#qs5 #qs6"/>
</joinGrp>
</egXML>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAG-egXML-ht" source="#SA-eg-04"><text xml:id="zuitxt">
   <body>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAG-egXML-qz"><joinGrp result="q">
...
represented by the <gi>join</gi> elements; this is necessary because 
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAG-egXML-dm" source="#SA-eg-04"><text>
 <body>
<!-- five div1 elements -->
<div1>
    <p>Zui-Gan called out to himself every day, <q>Master.</q></p>
...
<xi:include href="../../Specs/join.xml"/>
<xi:include href="../../Specs/joinGrp.xml"/>
</specGrp></div>
...
follows.
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-nx"><div type="interview">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-si"><div select="#we.fun2" type="interview">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-gp"><div type="interview">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-hs"><div type="interview">
  <u>We had
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-js"><div type="interview">
  <!-- ... -->
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-gx"><u>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-eg"><div select="#we.fun5 #lee.fun5" type="interview">
...
of those two tags:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-qp"><div type="interview">
...
attribute.
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-ga"><s>Let's go to
...
mark them as excluding each other as follows:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-eo" xml:lang="und" source="#UND"><body>
  <div1 xml:id="C1">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-hf"><div type="interview">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-xl" source="#UND"><alt target="#a #b" mode="excl"/></egXML> = 
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-hu" source="#UND"><link target="#a #b" type="exclusive_alternation"/></egXML></p>
<p>The preceding <gi>link</gi> element may therefore be recoded as the
  following <gi>alt</gi> element. <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-xw" xml:lang="und" source="#UND"><alt target="#we.had.fun #we.had.sun" mode="excl"/></egXML></p>
...
as follows: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-dq" xml:lang="und" source="#UND"><alt target="#we.fun #we.had.sun" mode="excl" weights="0.5 0.5"/></egXML></p>
...
of this section.
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-we"><u xml:id="we.fun">We had fun at the beach today.</u>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-qn"><u>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SAAT-egXML-mq"><div xml:id="bm" type="song">
...
<xi:include href="../../Specs/alt.xml"/>
<xi:include href="../../Specs/altGrp.xml"/>
</specGrp></div>
...
<div type="div3" xml:id="SASOin">
	...
	<emph>all</emph> kinds of markup externally as stand-off tags,
	for use whenever it is appropriate; and a place in the TEI
	structure (<gi>standOff</gi>) to contain certain common kinds
	of stand-off markup.</p>
	<!-- this list uses technical terms defined after it appears: it should be moved -->
	...
	<list type="gloss">
	  ...
	  <item>markup that is either outside of the source document
	  ...
	  at by data elsewhere that refers to it.</item>
	  <label>
	...
	<item>a process applied to markup from a pre-existing XML
  ...
  <head>Overview of XInclude </head>
   ...
   pointing schemes discussed in section <ptr target="#SAXP"/>.</p>
	...
	<p>XInclude is a W3C recommendation which specifies a syntax for the
	  ...
	  <p>The <gi>xi:include</gi> element uses the <att scheme="XI">href</att> attribute to specify the location of
	  the resource to be included; its value is an URI containing,
	  if necessary, an XPointer. Additionally, it uses the <att scheme="XI">parse</att> attribute (whose only valid values
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASOso-egXML-ya" xml:lang="en">
  <body>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASOso-egXML-zk" source="#VEST-eg-1"><text>
   <body>
<head>1755</head>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASOfr-egXML-pz">
...
will only select the text of the poem, with no markup inside.</p>
 ...
 xpointer='xpointer(string-range(//div[5]/text(),"If")/range-to(//div[5]/text(),".")'/>
  ...
  <div type="div2" xml:id="SASOstdf">
    <!-- head>Placement of Stand-off Markup and Contextual Information</head -->
    <head>The <gi>standOff</gi> Container</head>
    <p>The <gi>standOff</gi> element is intended to hold content that does not fit well in the
        <gi>text</gi> (e.g. because it is not transcribed from the source), nor in the
        <gi>teiHeader</gi> (e.g. because it is not metadata about the source or transcription).
      Examples include contextual information about named entities (typically encoded using
        <gi>listBibl</gi>, <gi>listOrg</gi>, <gi>listNym</gi>, <gi>listPerson</gi>, or
        <gi>listPlace</gi>), annotations indicating the morphosyntactic features of a text, and
      annotations commenting on or associating parts of a text with additional information. <specList>
        <specDesc key="standOff"/>
      </specList>
    </p>

    <p>As a member of <ident type="class">model.resource</ident>, <gi>standOff</gi> may occur as a
      child of <gi>TEI</gi> (or <gi>teiCorpus</gi>). If the metadata that describes the
      ...
      <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASOstdf-egXML-ij" valid="feasible">
        <TEI>
          <teiHeader>
            <!-- ... -->
          </teiHeader>
                ...
                <div type="textpart" n="1" xml:id="part1">
                  ...
                  <p n="1" xml:id="p1">
                    <seg n="1" xml:id="seg-1.1">Bello Alexandrino conflato <persName ref="#Caesar">Caesar</persName>
                      <app>
                        <lem><placeName ref="#Rhodus">Rhodo</placeName></lem>
                      ...
                      <placeName ref="#Cilicia">Cilicia</placeName>que omnem classem arcessit; <app>
                        <lem><placeName ref="#Creta">Creta</placeName></lem>
  ...
  <div type="div2" xml:id="SASOann">
    <head>Annotations</head>
    <p>The <gi>annotation</gi> element's structure is based on the <ref target="#WADM">Web
        Annotation Data Model</ref> (WADM). A Web Annotation may have one or more targets, which are
      ...
      dates, and license information. The <gi>annotation</gi> element implements a subset of WADM,
      using TEI elements and attributes to encode the same information, with a focus on annotating
      TEI documents. Targets are represented using the <att>target</att> attribute on
        <gi>annotation</gi>. URI bodies are represented using <gi>ref</gi> or <gi>ptr</gi> and
      embedded text bodies using <gi>note</gi>. Lifecycle and license information may be given using
        <gi>respStmt</gi>, <gi>revisionDesc</gi>, and <gi>licence</gi>. <specList>
        <specDesc key="listAnnotation"/>
        <specDesc key="annotation"/>
      </specList></p>

    <p>TEI annotations are, in general, intended to capture the output of processes that annotate
      TEI texts without altering the text and markup in the <gi>text</gi>. They allow this kind of
      output to be represented directly in TEI, and thus to be processed using the same toolchains
      as the texts they annotate. A named entity recognition workflow might use <gi>annotation</gi>,
      for example to associate names in the text with <gi>person</gi> elements instead of attempting
      to rewrite the TEI text using inline <gi>persName</gi>. Projects may wish to use this
      mechanism to layer information onto a TEI text in case where using inline elements might
      result in complicated markup.</p>

    <p>The example below illustrates how stand-off annotations can be used to connect words in a
      text with <gi>place</gi> elements in a list. The words <q>Gallia</q> and <q>Galliae</q> in the
      edition are connected by an annotation in the <gi>standOff</gi> section which points to them
      using <code>string-range()</code> pointers and references the definition of the place (also in
      the <gi>standOff</gi> section). If the set of annotations were created in a process separate
      from the creation of the transcription and then imported into the transcription document, then
      wrapping them in a <gi>TEI</gi> element with its own <gi>teiHeader</gi> providing metadata for
      the annotations might be advisable. <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="SASOann-egXML-if" valid="feasible">
        <TEI>
          <teiHeader>
            <fileDesc>
              <titleStmt>
          ...
          <text>
            <body>
              <div type="edition">
                <div type="textpart" subtype="chapter" n="1" xml:id="ch1">
                  <p n="1" xml:id="c1p1">
          ...
          <TEI>
            ...
            <standOff>
              <listAnnotation>
                <annotation xml:id="ann01" motivation="linking" target="#Gallia">
                  <respStmt xml:id="ed">
                    <resp>creator</resp>
                  ...
                  <revisionDesc>
                    ...
                    <change status="modified" when="2020-05-21T19:48:00Z" who="#ed"/>
                  </revisionDesc>
    ...
    <xi:include href="../../Specs/standOff.xml"/>
    <xi:include href="../../Specs/listAnnotation.xml"/>
    <xi:include href="../../Specs/annotation.xml"/>
  </div>
...
chapters<!-- , particularly in sections <ptr target="#AILA"/>, <ptr target="#FSFL"/> and <ptr target="#FSIL"/>-->.</p>
  <p>Another more specific form of annotation is available through the TEI <gi>ruby</gi> element and its
    children, described in detail in <ptr target="#COHTGRB"/>.</p>
...
<div type="div2" xml:id="SAref">
  ...
  <moduleSpec xml:id="DSA" ident="linking">
    <idno type="FPI">Linking, Segmentation, and Alignment</idno>
    <desc xml:lang="en" versionDate="2019-07-07">Linking, segmentation, and alignment</desc>
    <desc xml:lang="fr" versionDate="2018-07-12">Liens, segmentation et alignement</desc>
    <desc xml:lang="zh-TW" versionDate="2020-12-20">連結、分割與隊列</desc>
    <desc xml:lang="it" versionDate="2018-07-12">Collegamento, segmentazione e allineamento</desc>
    <desc xml:lang="pt" versionDate="2018-07-12">Ligação, segmentação e alinhamento</desc>
    <desc xml:lang="ja" versionDate="2018-07-12">リンクモジュール</desc>
  </moduleSpec>
  The selection and combination of modules to form a TEI schema is
  described in <ptr target="#STIN"/>.
  <specGrp>
    <xi:include href="../../Specs/att.global.linking.xml"/>
...
XML location: `/div[1]/div[1]/div[1]/head[1]`.
...
XML location: `/div[1]/div[1]/div[1]/p[1]`.
...
XML location: `/div[1]/div[1]/div[1]/p[2]`.
...
XML location: `/div[1]/div[1]/div[1]/p[3]`.
...
XML location: `/div[1]/div[1]/div[1]/p[4]`.
...
XML location: `/div[1]/div[1]/div[2]/head[1]`.
...
XML location: `/div[1]/div[1]/div[2]/p[1]`.
...
XML location: `/div[1]/div[1]/div[2]/p[2]`.
...
XML location: `/div[1]/div[1]/div[2]/p[3]`.
...
XML location: `/div[1]/div[1]/div[2]/p[4]`.
...
XML location: `/div[1]/div[1]/div[2]/p[5]`.
...
XML location: `/div[1]/div[1]/div[2]/p[6]`.
...
XML location: `/div[1]/div[1]/div[3]/head[1]`.
...
XML location: `/div[1]/div[1]/div[3]/p[1]`.
...
XML location: `/div[1]/div[1]/div[3]/p[2]`.
...
XML location: `/div[1]/div[1]/div[3]/p[3]`.
...
XML location: `/div[1]/div[1]/div[3]/p[4]`.
...
XML location: `/div[1]/div[1]/div[3]/p[5]`.
...
XML location: `/div[1]/div[1]/div[3]/p[6]`.
...
XML location: `/div[1]/div[1]/div[3]/specGrp[1]`.
...
XML location: `/div[1]/div[1]/div[4]/head[1]`.
...
XML location: `/div[1]/div[1]/div[4]/p[1]`.
...
XML location: `/div[1]/div[1]/div[4]/p[2]`.
...
XML location: `/div[1]/div[1]/div[4]/p[3]`.
...
XML location: `/div[1]/div[1]/div[4]/p[4]`.
...
XML location: `/div[1]/div[1]/div[4]/p[5]`.
...
XML location: `/div[1]/div[2]/div[1]/p[3]`.
...
XML location: `/div[1]/div[2]/div[1]/p[4]`.
...
XML location: `/div[1]/div[2]/div[1]/p[5]`.
...
XML location: `/div[1]/div[2]/div[1]/p[6]`.
...
XML location: `/div[1]/div[2]/div[3]/head[1]`.
...
XML location: `/div[1]/div[2]/div[3]/p[1]`.
...
XML location: `/div[1]/div[2]/div[3]/p[2]`.
...
XML location: `/div[1]/div[2]/div[3]/list[1]`.
...
XML location: `/div[1]/div[2]/div[3]/p[3]`.
...
XML location: `/div[1]/div[2]/div[3]/p[4]`.
...
XML location: `/div[1]/div[2]/div[3]/p[5]`.
...
XML location: `/div[1]/div[2]/div[3]/p[6]`.
...
XML location: `/div[1]/div[2]/div[3]/p[7]`.
...
XML location: `/div[1]/div[2]/div[3]/p[8]`.
...
XML location: `/div[1]/div[2]/div[3]/p[9]`.
...
XML location: `/div[1]/div[2]/div[3]/p[10]`.
...
XML location: `/div[1]/div[2]/div[3]/p[11]`.
...
XML location: `/div[1]/div[2]/div[4]/head[1]`.
...
XML location: `/div[1]/div[2]/div[4]/p[1]`.
...
XML location: `/div[1]/div[2]/div[4]/p[2]`.
...
XML location: `/div[1]/div[2]/div[4]/div[1]/head[1]`.

```xml
<head>Introduction to TEI Pointers</head>
```
...
XML location: `/div[1]/div[2]/div[4]/div[1]/p[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[1]/p[2]`.
...
XML location: `/div[1]/div[2]/div[4]/div[1]/p[3]`.
...
XML location: `/div[1]/div[2]/div[4]/div[1]/p[4]`.
...
XML location: `/div[1]/div[2]/div[4]/div[1]/p[5]`.
...
XML location: `/div[1]/div[2]/div[4]/div[1]/p[6]`.
...
XML location: `/div[1]/div[2]/div[4]/div[2]/head[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[2]/p[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[2]/p[2]`.
...
XML location: `/div[1]/div[2]/div[4]/div[2]/p[3]`.
...
XML location: `/div[1]/div[2]/div[4]/div[2]/p[4]`.
...
XML location: `/div[1]/div[2]/div[4]/div[2]/p[5]`.
...
XML location: `/div[1]/div[2]/div[4]/div[2]/p[6]`.
...
XML location: `/div[1]/div[2]/div[4]/div[3]/head[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[3]/p[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[3]/p[2]`.
...
XML location: `/div[1]/div[2]/div[4]/div[3]/p[3]`.
...
XML location: `/div[1]/div[2]/div[4]/div[3]/p[4]`.
...
XML location: `/div[1]/div[2]/div[4]/div[3]/p[5]`.

```xml
<p>Example: <code>#left(line1)</code> indicates the point immediately before
the <tag>lb n="1"</tag> element.</p>
```
...
XML location: `/div[1]/div[2]/div[4]/div[4]/head[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[4]/p[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[4]/p[2]`.
...
XML location: `/div[1]/div[2]/div[4]/div[4]/p[3]`.
...
XML location: `/div[1]/div[2]/div[4]/div[5]/head[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[5]/p[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[5]/p[2]`.
...
XML location: `/div[1]/div[2]/div[4]/div[5]/p[3]`.
...
XML location: `/div[1]/div[2]/div[4]/div[5]/p[4]`.
...
XML location: `/div[1]/div[2]/div[4]/div[6]/head[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[6]/p[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[6]/p[2]`.
...
XML location: `/div[1]/div[2]/div[4]/div[6]/p[3]`.
...
XML location: `/div[1]/div[2]/div[4]/div[6]/p[4]`.
...
XML location: `/div[1]/div[2]/div[4]/div[6]/p[5]`.
...
XML location: `/div[1]/div[2]/div[4]/div[6]/p[6]`.
...
XML location: `/div[1]/div[2]/div[4]/div[7]/head[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[7]/p[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[7]/p[2]`.
...
XML location: `/div[1]/div[2]/div[4]/div[7]/p[3]`.
...
XML location: `/div[1]/div[2]/div[4]/div[7]/p[4]`.
...
XML location: `/div[1]/div[2]/div[4]/div[7]/p[5]`.
...
XML location: `/div[1]/div[2]/div[4]/div[7]/p[6]`.
...
XML location: `/div[1]/div[2]/div[4]/div[8]/head[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[8]/p[1]`.
...
XML location: `/div[1]/div[2]/div[4]/div[8]/p[2]`.
...
XML location: `/div[1]/div[2]/div[4]/div[8]/p[3]`.
...
XML location: `/div[1]/div[2]/div[4]/div[8]/p[4]`.
...
XML location: `/div[1]/div[2]/div[4]/div[8]/p[5]`.
...
XML location: `/div[1]/div[2]/div[5]/head[1]`.
...
XML location: `/div[1]/div[2]/div[5]/p[1]`.
...
XML location: `/div[1]/div[2]/div[5]/p[2]`.
...
XML location: `/div[1]/div[2]/div[5]/p[3]`.
...
XML location: `/div[1]/div[2]/div[5]/p[4]`.
...
XML location: `/div[1]/div[2]/div[5]/p[5]`.
...
XML location: `/div[1]/div[2]/div[5]/div[1]/head[1]`.
...
XML location: `/div[1]/div[2]/div[5]/div[1]/p[1]`.
...
XML location: `/div[1]/div[2]/div[5]/div[1]/p[2]`.
...
XML location: `/div[1]/div[2]/div[5]/div[1]/p[3]`.
...
XML location: `/div[1]/div[2]/div[5]/div[1]/p[4]`.
...
XML location: `/div[1]/div[2]/div[5]/div[2]/head[1]`.
...
XML location: `/div[1]/div[2]/div[5]/div[2]/p[1]`.
...
XML location: `/div[1]/div[2]/div[5]/div[2]/p[2]`.
...
XML location: `/div[1]/div[2]/div[5]/div[3]/head[1]`.

```xml
<head>Miscellaneous Usages</head>
```
...
XML location: `/div[1]/div[2]/div[5]/div[3]/p[1]`.
...
XML location: `/div[1]/div[2]/div[5]/div[4]/head[1]`.
...
XML location: `/div[1]/div[2]/div[5]/div[4]/p[1]`.
...
XML location: `/div[1]/div[2]/div[5]/div[4]/p[2]`.
...
XML location: `/div[1]/div[2]/div[5]/div[4]/p[3]`.
...
XML location: `/div[1]/div[2]/div[5]/div[4]/p[4]`.
...
XML location: `/div[1]/div[2]/div[5]/div[4]/p[5]`.
...
XML location: `/div[1]/div[3]/specGrp[1]`.
...
XML location: `/div[1]/div[4]/div[1]/p[3]`.
...
XML location: `/div[1]/div[4]/div[1]/p[4]`.
...
XML location: `/div[1]/div[4]/div[1]/p[5]`.
...
XML location: `/div[1]/div[4]/div[1]/p[6]`.
...
XML location: `/div[1]/div[4]/div[1]/p[7]`.
...
XML location: `/div[1]/div[4]/div[2]/p[7]`.
...
XML location: `/div[1]/div[4]/div[2]/p[8]`.
...
XML location: `/div[1]/div[4]/div[2]/specGrp[1]`.
...
XML location: `/div[1]/div[5]/div[1]/head[1]`.
...
XML location: `/div[1]/div[5]/div[1]/p[1]`.
...
XML location: `/div[1]/div[5]/div[1]/p[2]`.
...
XML location: `/div[1]/div[5]/div[1]/p[3]`.
...
XML location: `/div[1]/div[5]/div[1]/p[4]`.
...
XML location: `/div[1]/div[5]/div[1]/p[5]`.
...
XML location: `/div[1]/div[5]/div[2]/head[1]`.
...
XML location: `/div[1]/div[5]/div[2]/p[1]`.
...
XML location: `/div[1]/div[5]/div[2]/p[2]`.
...
XML location: `/div[1]/div[5]/div[2]/p[3]`.
...
XML location: `/div[1]/div[5]/div[2]/p[4]`.
...
XML location: `/div[1]/div[5]/div[2]/p[5]`.
...
XML location: `/div[1]/div[5]/div[2]/p[6]`.
...
XML location: `/div[1]/div[5]/div[3]/head[1]`.
...
XML location: `/div[1]/div[5]/div[3]/p[1]`.
...
XML location: `/div[1]/div[5]/div[3]/p[2]`.
...
XML location: `/div[1]/div[5]/div[3]/p[3]`.
...
XML location: `/div[1]/div[5]/div[3]/p[4]`.
...
XML location: `/div[1]/div[5]/div[3]/p[5]`.
...
XML location: `/div[1]/div[5]/div[3]/p[6]`.
...
XML location: `/div[1]/div[5]/div[3]/p[7]`.
...
XML location: `/div[1]/div[5]/div[3]/p[8]`.
...
XML location: `/div[1]/div[5]/div[3]/p[9]`.
...
XML location: `/div[1]/div[6]/p[8]`.

```xml
<p>For further examples of the use of this attribute, see <ptr target="#SAAT"/> and <ptr target="#GDAT"/>.</p>
```
...
XML location: `/div[1]/div[7]/specGrp[1]`.
...
XML location: `/div[1]/div[8]/specGrp[1]`.
...
XML location: `/div[1]/div[9]/div[1]/head[1]`.
...
XML location: `/div[1]/div[9]/div[1]/p[1]`.
...
XML location: `/div[1]/div[9]/div[1]/p[2]`.
...
XML location: `/div[1]/div[9]/div[1]/p[3]`.
...
XML location: `/div[1]/div[9]/div[1]/p[4]`.
...
XML location: `/div[1]/div[9]/div[1]/p[5]`.
...
XML location: `/div[1]/div[9]/div[2]/head[1]`.
...
XML location: `/div[1]/div[9]/div[2]/p[1]`.
...
XML location: `/div[1]/div[9]/div[2]/p[2]`.
...
XML location: `/div[1]/div[9]/div[2]/p[3]`.
...
XML location: `/div[1]/div[9]/div[3]/head[1]`.
...
XML location: `/div[1]/div[9]/div[3]/p[1]`.
...
XML location: `/div[1]/div[9]/div[3]/p[2]`.
...
XML location: `/div[1]/div[9]/div[3]/p[3]`.
...
XML location: `/div[1]/div[9]/div[3]/p[4]`.
...
XML location: `/div[1]/div[9]/div[3]/p[5]`.
...
XML location: `/div[1]/div[9]/div[3]/p[6]`.
...
XML location: `/div[1]/div[9]/div[4]/head[1]`.
...
XML location: `/div[1]/div[9]/div[4]/p[1]`.
...
XML location: `/div[1]/div[9]/div[4]/p[2]`.
...
XML location: `/div[1]/div[9]/div[5]/head[1]`.
...
XML location: `/div[1]/div[9]/div[5]/p[1]`.
...
XML location: `/div[1]/div[9]/div[5]/p[2]`.
...
XML location: `/div[1]/div[9]/div[5]/p[3]`.
...
XML location: `/div[1]/div[9]/div[5]/p[4]`.
...
XML location: `/div[1]/div[9]/div[5]/p[5]`.
...
XML location: `/div[1]/div[10]/head[1]`.
...
XML location: `/div[1]/div[11]/head[1]`.
...
XML location: `/div[1]/div[11]/include[1]`.
...
XML location: `/div[1]/div[11]/include[2]`.
...
XML location: `/div[1]/div[11]/include[3]`.
...
XML location: `/div[1]/div[12]/head[1]`.
...
XML location: `/div[1]/div[13]/head[1]`.
