...
source: '[[00_sources/tei-p5-stage-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 stage
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Specs/stage.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 15398. Git blob: `7279f33fe781f6dff3719f4b60ef32978fb566ae`.
...
<elementSpec xmlns="http://www.tei-c.org/ns/1.0" module="core" xml:id="gi-stage" ident="stage">
  ...
  <gloss versionDate="2017-06-13" xml:lang="de">Regieanweisung</gloss>
  ...
  <desc versionDate="2017-06-13" xml:lang="de">enthält jegliche Regieanweisung in einem Dramentext oder -fragment.</desc>
  <classes>
    ...
    <attDef ident="type" usage="rec">
      ...
      <valList type="semi">
        <valItem ident="setting">
          ...
          <desc versionDate="2017-06-13" xml:lang="de">beschreibt die Szenerie.</desc>
        </valItem>
        <valItem ident="entrance">
          ...
          <desc versionDate="2017-06-13" xml:lang="de">beschreibt einen Auftritt.</desc>
        </valItem>
        <valItem ident="exit">
          ...
          <desc versionDate="2017-06-13" xml:lang="de">beschreibt einen Abgang.</desc>
        </valItem>
	  ...
	  action sur scène</desc>
          ...
          <desc versionDate="2017-06-13" xml:lang="de">beschreibt eine Bühnenhandlung.</desc>
        </valItem>
        <valItem ident="novelistic">
          ...
          <desc versionDate="2007-01-21" xml:lang="it">testo narrativo che indica le direzioni
                        di scena.</desc>
          <desc versionDate="2017-06-13" xml:lang="de">beschreibt eine narrative Regieanweisung.</desc>
        </valItem>
        <valItem ident="delivery">
          ...
          <desc versionDate="2007-01-21" xml:lang="it">descrive il modo in cui un personaggio
                        parla.</desc>
          <desc versionDate="2017-06-13" xml:lang="de">beschreibt die Art und Weise der Darbietung einer Figurenrede.</desc>
        </valItem>
        <valItem ident="modifier">
          ...
          <desc versionDate="2007-01-21" xml:lang="it">fornisce dettagli sul
                    personaggio</desc>
          <desc versionDate="2017-06-13" xml:lang="de">gibt nähere Details zu einer Figur an.</desc>
        </valItem>
        <valItem ident="location">
          ...
          <desc versionDate="2007-01-21" xml:lang="it">descrive l'ambientazione.</desc>
          <desc versionDate="2017-06-13" xml:lang="de">beschreibt einen Handlungsort.</desc>
        </valItem>
        <valItem ident="mixed">
          ...
          <desc versionDate="2017-06-13" xml:lang="de">mehrere der oben angeführten Funktionen.</desc>
        </valItem>
      </valList>
      <remarks ident="stage-attr.type-remarks" versionDate="2016-11-04" xml:lang="en"><p>If the value <val>mixed</val> is used, it must be the only value. Multiple values may however be supplied
      if a single stage direction performs multiple functions, for example is both an entrance and a modifier. </p></remarks>
      <remarks ident="stage-attr.type-remarks" versionDate="2017-06-13" xml:lang="de"><p>Der Wert <val>mixed</val> kann nur alleine benutzt werden. Mehrere Werte können in Kombination
        eingesetzt werden, wenn eine einzelne Regieanweisung unterschiedliche Funktionen erfüllt, z. B.
        sowohl einen Auftritt als auch eine Figurenbeschreibung.</p></remarks>
    </attDef>
  </attList>
  <exemplum xml:lang="en">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-stage-egXML-hj">
      <stage type="setting">A curtain being drawn.</stage>
      <stage type="setting">Music</stage>
      <stage type="entrance">Enter Husband as being thrown off his horse and falls.</stage><!-- Middleton : Yorkshire Tragedy -->
      ...
      <stage type="novelistic">Having had enough, and embarrassed for the family.</stage> <!-- Lorraine Hansbury : a raisin in in the sun -->
      <stage type="modifier">Disguised as Ansaldo.</stage>
      <stage type="entrance modifier">Enter Latrocinio disguised as an empiric</stage><!-- Middleton: The Widow -->
  ...
  <exemplum xml:lang="en">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-stage-egXML-gt">
  ...
  <exemplum versionDate="2008-04-06" xml:lang="fr">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-stage-egXML-gk" source="#fr-ex-Moliere_Ecole">
  ...
  <exemplum xml:lang="zh-TW">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-stage-egXML-vt">
  ...
  <remarks ident="stage-remarks" versionDate="2013-04-18" xml:lang="en">
...
by the stage direction.</p>
  ...
  <remarks ident="stage-remarks" versionDate="2017-06-13" xml:lang="de">
    <p>Das <att>who</att>-Attribut kann verwendet werden, um die Person oder Personen näher zu
      bezeichnen, die die Regieanweisung ausführen.</p>
  </remarks>
  <listRef>
    <ptr target="#CODR"/>
    <ptr target="#CODV"/>
