...
source: '[[00_sources/tei-p5-guidelines-prefatorynote-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 Prefatory Notes
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Guidelines/en/PrefatoryNote.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 38717. Git blob: `5acbfd8186f5a05e4a972adea2eec09314c6b035`.
...
revision of the TEI Guidelines since its first publication in 1994. 
  ...
  <div xml:id="p5pf01"><head>Prefatory Note (November 2007)</head>
    <p>This publication constitutes the fifth distinct version of the
      ...
      Council over the last five years.</p>
    ...
    <p>The Chair of the TEI Board sits on the Technical Council, and the
      ...
      time.<note>What followed was a list of TEI Board and Council members, which
      was periodically updated over the years, and remains in place with the 2025 Introductory Note.</note>
    </p>
...
```xml
<head>Prefatory Note (November 2007)</head>
```
...
```xml
<head>Prefatory Note (March 2002)</head>
```
...
XML location: `/div[1]/div[2]/signed[1]`.
...
```xml
<head>Introductory Note (November 2001)</head>
```
...
XML location: `/div[1]/div[3]/signed[1]`.
...
```xml
<head>Introductory Note (June 2001)</head>
```
...
XML location: `/div[1]/div[5]/div[1]/list[1]`.
...
XML location: `/div[1]/div[5]/div[3]/list[1]`.
...
XML location: `/div[1]/div[5]/div[3]/signed[1]`.
...
```xml
<head>TEI Working Committees (1990-1993)</head>
```
...
XML location: `/div[1]/div[7]/div[1]/note[1]`.

```xml
<note place="inline">Not all members listed were able to serve throughout the development
of the Guidelines.</note>
```
...
XML location: `/div[1]/div[7]/div[1]/list[1]`.
...
Gregory Shreve (Kent State University);
Richard Strehlow (Oak Ridge National Laboratory);
Sue Ellen Wright (Kent State University).</item></list></p>
```
...
<item>Stephen Anderson (The Johns Hopkins University)</item><label>Modern Language Association:</label>
<item>Randall Jones (Brigham Young University) and
Ian Lancashire (University of Toronto).</item></list></p>
```
...
```xml
<head>Steering Committee Membership</head>
```
...
<item>1987–1999:  Susan M. Hockey (Center for Electronic Texts in the
Humanities);</item>
<item>1987–1999:  Antonio Zampolli (University of Pisa).</item></list></item></list></p>
```
