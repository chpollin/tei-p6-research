...
source: '[[00_sources/tei-p5-guidelines-ce-certaintyresponsibility-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 Certainty, Precision, and Responsibility
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Guidelines/en/CE-CertaintyResponsibility.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 34418. Git blob: `241b4fd68a70d9d3e9bb01ebbcc22aece44d4b25`.
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECENO-egXML-tv"><persName>Elizabeth</persName> went to <placeName>Essex</placeName>. She had always liked <placeName>Essex</placeName>.<note type="certainty" resp="#MSM">It is not
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECENO-egXML-ms"><persName>Elizabeth</persName> went to <placeName xml:id="CE-p1a">Essex</placeName>.
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-uc">Elizabeth went to 
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-no" source="#UND">
<!-- ... -->
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-wi">
<!-- ... -->
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-kf">Elizabeth went to 
<placeName>Essex
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CEconcon-egXML-lf">Elizabeth went to <placeName xml:id="CE-PL1">Essex</placeName>.
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CEconcon-egXML-dx">Ernest went to <anchor xml:id="CE-a1"/> old <persName xml:id="CE-p2">Saybrook</persName>.
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CEconcon-egXML-pv">Ernest went to old <persName>Saybrook</persName>.    (0.6 * 0.9, or 0.54)
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-rq" source="#UND">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-wd">
<div><p>[...]</p></div>
<div>
<certainty locus="name" degree="0.3" match=".//persName"/>
</div>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-qe" source="#UND">
...
For example, 
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-zx" source="#UND">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-bm">I have a <emph xml:id="CE-p3">bun</emph>.
...
also be expressed, as in the following example:<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-dj">You will want to use
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-sv">I have a <emph xml:id="CE-P3">bun</emph>.
...
participant A:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-we"><u xml:id="CE-u1" who="#A">Have you heard the election results?</u>
<certainty target="#CE-u1" match="@who" locus="value" degree="0.5"/></egXML> or, equivalently and without the
need to define a target,
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-ai"><u who="#A">Have you heard the election results?<certainty match="@who" locus="value" degree="0.5"/></u>
</egXML> 
...
examples follow:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-og" source="#UND">
...
identified.</p>
<p>
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-an" source="#UND">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-wv">
...
is correct.</p>
<p>
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-qo" source="#UND">
<certainty match="//*/@resp" locus="value" degree="0.2"/>
</egXML>
...
<p><egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-ic" source="#UND">
...
<p><egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CECECE-egXML-as" source="#UND">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CEPREC-egXML-bb">
...
following examples:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CEPREC-egXML-yf" source="#UND">
...
element:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CEPREC-egXML-px">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CEPREC-egXML-pg">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CEPREC-egXML-ix" source="#UND">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CEPREC-egXML-ms" source="#UND">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CERESP-egXML-vu">Ernest went to old
...
responsible for proposing the value of the <att>rend</att> attribute:  
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CERESP-egXML-aw" source="#UND">
...
```xml
<head>Certainty, Precision, and Responsibility</head>
```
...
```xml
<head>Using Notes to Record Uncertainty</head>
```
...
```xml
<head>Structured Indications of Uncertainty</head>
```
...
XML location: `/div[1]/div[1]/div[2]/div[1]/head[1]`.

```xml
<head>Contingent Conditions</head>
```
...
XML location: `/div[1]/div[1]/div[2]/div[1]/p[1]`.
...
XML location: `/div[1]/div[1]/div[2]/div[1]/p[2]`.
...
XML location: `/div[1]/div[1]/div[2]/div[1]/p[3]`.
...
XML location: `/div[1]/div[1]/div[2]/div[2]/head[1]`.

```xml
<head>Pervasive Conditions</head>
```
...
XML location: `/div[1]/div[1]/div[2]/div[2]/p[1]`.
...
XML location: `/div[1]/div[1]/div[2]/div[2]/p[2]`.
...
XML location: `/div[1]/div[1]/div[2]/div[3]/head[1]`.

```xml
<head>Content Uncertainty</head>
```
...
XML location: `/div[1]/div[1]/div[2]/div[3]/p[1]`.
...
XML location: `/div[1]/div[1]/div[2]/div[3]/p[2]`.
...
XML location: `/div[1]/div[1]/div[2]/div[3]/p[3]`.
...
XML location: `/div[1]/div[1]/div[2]/div[4]/head[1]`.

```xml
<head>Target or Match?</head>
```
...
XML location: `/div[1]/div[1]/div[2]/div[4]/p[1]`.
...
XML location: `/div[1]/div[1]/div[2]/div[4]/p[2]`.
...
XML location: `/div[1]/div[1]/div[2]/div[4]/p[3]`.
...
XML location: `/div[1]/div[1]/div[2]/div[4]/p[4]`.
...
XML location: `/div[1]/div[1]/div[2]/div[4]/p[5]`.
...
XML location: `/div[1]/div[1]/div[2]/div[4]/p[6]`.
...
XML location: `/div[1]/div[1]/div[2]/div[4]/p[7]`.
...
XML location: `/div[1]/div[1]/div[2]/div[4]/p[8]`.
...
XML location: `/div[1]/div[1]/div[2]/div[4]/p[9]`.
...
XML location: `/div[1]/div[1]/div[2]/div[4]/p[10]`.
...
XML location: `/div[1]/div[1]/div[2]/div[4]/specGrp[1]`.
...
XML location: `/div[1]/div[1]/div[2]/div[4]/specGrpRef[1]`.

```xml
<specGrpRef target="#DCERESP"/>
```
...
```xml
<head>Indications of Precision</head>
```
...
```xml
<head>Attribution of Responsibility</head>
```
...
```xml
<head>The Certainty Module</head>
```
