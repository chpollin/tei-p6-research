...
source: '[[00_sources/tei-p5-usg-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 usg
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Specs/usg.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 19756. Git blob: `0111c40314def3ed0dbf1353f9ad48a3ccafadde`.
...
<elementSpec xmlns="http://www.tei-c.org/ns/1.0" module="dictionaries" xml:id="gi-usg" ident="usg">
  ...
  <desc versionDate="2007-05-04" xml:lang="es">contiene la información sobre el uso en la entrada de un diccionario.</desc>
  <desc versionDate="2007-01-21" xml:lang="it">in una voce di dizionario, contiene informazioni sull'uso.</desc>
  <classes>
  ...
  <attList>
    <attDef ident="type" mode="change" usage="opt">
      ...
      <desc versionDate="2007-06-12" xml:lang="fr">classe les informations sur l'usage en utilisant n'importe quelle typologie adaptée.</desc>
      ...
      <valList type="open">
        ...
        <valItem ident="register">
          <gloss versionDate="2007-05-02" xml:lang="en">register</gloss>
  ...
  <exemplum xml:lang="en">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-usg-egXML-xr">
      <form>
        <orth>colour</orth>
        <form>
  ...
  <exemplum versionDate="2008-04-06" xml:lang="fr">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-usg-egXML-po">
      <form>
        <orth>tuer</orth>
        <form>
  ...
  <exemplum xml:lang="zh-TW">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-usg-egXML-sv">
      <form>
        <orth>過</orth>
        <form>
