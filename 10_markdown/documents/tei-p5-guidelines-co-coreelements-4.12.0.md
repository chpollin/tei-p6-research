...
source: '[[00_sources/tei-p5-guidelines-co-coreelements-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 Elements Available in All TEI Documents
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Guidelines/en/CO-CoreElements.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 325714. Git blob: `c2750b2b16eb19a8c2c376558701a2bc82b7a547`.
...
attribute values supplied.
 ...
 <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COHQQ-egXML-ju" source="#DSHD-eg-30"><said rend="pre(‘) post(’)">Who-e debel
...
<tagsDecl partial="true">
  <rendition scheme="css" selector="said" scope="before">content:"‘";</rendition>
  <rendition scheme="css" selector="said" scope="after">content:"’";</rendition>
</tagsDecl>
</egXML>
</p>
...
<include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/soCalled.xml"/> </specGrp>
  ...
  <div type="div2" xml:id="COHTGEDR"><head>Terms and Glosses, Ruby Annotations, and Equivalents and Descriptions</head>
      ...
      <div type="div4" xml:id="COHTGEG"><head>Some Further Examples</head>
        ...
        <p>In this example, the decision as to which textual features
          ...
          <q rend="display">A pretty common case, I believe; in all
            ...
            <hi rend="italic">too witty</hi>; Anglicé,
    ...
    <div type="div3" xml:id="COHTGRB">
      ...
      <p>In Japanese, furigana (<seg xml:lang="ja">振り仮名</seg>) ruby annotations are often used to provide pronunciation 
        ...
        <p>Pinyin ruby annotations are also used in Chinese to provide pronunciation guidance,
          and Zhuyin (<seg xml:lang="zh-TW">注音</seg>) phonetic symbols (commonly known as <mentioned>bopomofo</mentioned>) are 
	  ...
	  <val>left</val>, and <val>right</val>.</p>
        ...
        <p>In its simplest representation, a glossed form consists of an <gi>rb</gi> (ruby base) element containing the
          ...
          In the example above, the word <seg xml:lang="ja">大学</seg>
          ...
          <mentioned>píngzi</mentioned> = bottle)<note place="foot">Taken from <ref target="https://en.wikipedia.org/wiki/Bopomofo#Example">Wikipedia</ref>.</note>:          
        ...
        <p>The same ruby base may be accompanied by more than one gloss. 
          Here, the Japanese word <seg xml:lang="ja">打球場</seg> (dakyūba, or <gloss>billiard hall</gloss>)
          ...
          <figure xml:id="COHTGRB-figure-zy">
            ...
            <head><mentioned>Billiard hall</mentioned> with two ruby glosses. 
              <ref target="http://school.nijl.ac.jp/kindai/NIJL/NIJL-01116.html#37"><seg xml:lang="ja">国文学研究資料館所蔵：：英国／龍動新繁昌記</seg></ref>.</head>
          </figure>
          ...
          as demonstrated for <seg xml:lang="ja">大学</seg> above, but 
          with nesting:
...
follows:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDCOR-egXML-bx" source="#NONE">… marginal comments which indicate that the <corr>dates</corr>
...
in the encoding:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDCOR-egXML-oa" source="#NONE">… marginal comments which indicate that the <sic>date's</sic>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDCOR-egXML-ru" source="#NONE">… marginal comments which indicate that the
  <choice>
    <corr>dates</corr>
    <sic>date's</sic>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDCOR-egXML-yo" source="#NONE">… marginal comments which indicate that the
  <choice>
...
section <ptr target="#HD5"/>). In these situations — where copy text
is not transcribed due to editorial policy or because it is impossible
to do so — the <gi>gap</gi> element may be used to indicate the
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDADD-egXML-bz" source="#COEDADD-eg-83">… Their arrangement with respect to Jupiter and to each other was as follows:
...
west; …</egXML>
  ...
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDADD-egXML-qf" xml:lang="en" source="#COEDADD-eg-90">
    <p>I leave Dublin to-morrow for M<ellipsis><metamark>——</metamark></ellipsis> house. It is situated in the county of <ellipsis><metamark>——</metamark></ellipsis>, on the north-west coast of <placeName>Connaught</placeName>, which I am told is the classic ground of <placeName>Ireland</placeName>.</p>
  </egXML>
  </p>
<p>A manuscript of song lyrics provides a more complex example of <gi>ellipsis</gi> to encode a marked omission that begins in the middle of a verse line.
    <figure xml:id="COEDADD-figure-bs">
      ...
      <q>·:—</q>, indicates that the rest of the chorus should follow
    ...
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDADD-egXML-tg" xml:lang="gl" source="#COEDADD-eg-93">
      ...
      <lg>
        ...
        <lb/><metamark function="signalChorus">꜒</metamark>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDADD-egXML-vw" xml:lang="de" source="#COEDADD-eg-89">
  <l><del rend="overtyped">Mein</del> Frisch <del rend="overstrike">schwebt</del> weht der Wind</l>
</egXML></p>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COBITY-egXML-wy" xml:space="preserve" source="#NONE"><listBibl>
   ...
   <biblStruct xml:id="NELSON80">
      ...
      <monogr>
         ...
         <biblScope unit="page" from="1013" to="1023">1013–23</biblScope>
      </monogr>
...
<include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/stage.xml"/>
 ...
 <div type="div2" xml:id="COOV">
   ...
   <moduleSpec xml:id="DCO" ident="core">
     ...
     <desc xml:lang="fr" versionDate="2018-07-12">Éléments disponibles pour tous les documents TEI</desc>
     <desc xml:lang="zh-TW" versionDate="2018-07-12">所有TEI文件所通用的元素</desc>
     ...
     <desc xml:lang="ja" versionDate="2018-07-12">コアモジュール</desc>
   </moduleSpec>
...
XML location: `/div[1]/div[1]/specGrp[1]`.
...
```xml
<head>Treatment of Punctuation</head>
```
...
```xml
<head>Functions of Punctuation</head>
```
...
```xml
<head>Highlighting and Quotation</head>
```
...
XML location: `/div[1]/div[3]/div[1]/p[3]`.
...
XML location: `/div[1]/div[3]/div[1]/p[4]`.
...
XML location: `/div[1]/div[3]/div[1]/p[5]`.
...
XML location: `/div[1]/div[3]/div[1]/p[6]`.
...
XML location: `/div[1]/div[3]/div[1]/p[7]`.
...
XML location: `/div[1]/div[3]/div[1]/p[8]`.
...
XML location: `/div[1]/div[3]/div[1]/p[9]`.
...
```xml
<head>Emphasis, Foreign Words, and Unusual Language</head>
```
...
XML location: `/div[1]/div[3]/div[2]/div[1]/specGrp[1]`.
...
```xml
<head>Emphatic Words and Phrases</head>
```
...
XML location: `/div[1]/div[3]/div[2]/div[2]/specGrp[1]`.
...
XML location: `/div[1]/div[3]/div[2]/div[3]/head[1]`.

```xml
<head>Other Linguistically Distinct Material</head>
```
...
XML location: `/div[1]/div[3]/div[2]/div[3]/p[1]`.
...
XML location: `/div[1]/div[3]/div[2]/div[3]/p[2]`.
...
XML location: `/div[1]/div[3]/div[2]/div[3]/p[3]`.
...
XML location: `/div[1]/div[3]/div[2]/div[3]/specGrp[1]`.
...
XML location: `/div[1]/div[3]/div[3]/p[5]`.
...
XML location: `/div[1]/div[3]/div[3]/p[6]`.
...
XML location: `/div[1]/div[3]/div[3]/p[7]`.
...
XML location: `/div[1]/div[3]/div[3]/p[8]`.
...
XML location: `/div[1]/div[3]/div[3]/p[9]`.
...
XML location: `/div[1]/div[3]/div[3]/p[10]`.
...
XML location: `/div[1]/div[3]/div[3]/p[11]`.
...
XML location: `/div[1]/div[3]/div[3]/p[12]`.
...
XML location: `/div[1]/div[3]/div[3]/p[13]`.
...
XML location: `/div[1]/div[3]/div[3]/p[14]`.
...
XML location: `/div[1]/div[3]/div[3]/p[15]`.
...
XML location: `/div[1]/div[3]/div[3]/p[16]`.
...
XML location: `/div[1]/div[3]/div[3]/p[17]`.
...
```xml
<head>Terms and Glosses, Ruby Annotations, and Equivalents and Descriptions</head>
```
...
XML location: `/div[1]/div[4]/div[1]/div[1]/head[1]`.

```xml
<head>Some Further Examples</head>
```
...
XML location: `/div[1]/div[4]/div[1]/div[1]/p[1]`.
...
XML location: `/div[1]/div[4]/div[1]/div[1]/p[2]`.
...
XML location: `/div[1]/div[4]/div[1]/div[1]/p[3]`.
...
XML location: `/div[1]/div[4]/div[1]/div[1]/p[4]`.
...
XML location: `/div[1]/div[4]/div[2]/figure[1]`.
...
XML location: `/div[1]/div[4]/div[2]/figure[2]`.
...
```xml
<head>Simple Editorial Changes</head>
```
...
```xml
<p>The following examples show alternative treatment of the same
material. The copy text reads:
<q rend="display">Another property of computer-assisted historical
research is that data modelling must permit any one textual feature or
part of a textual feature to be a part of more than one information
...
follows:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDCOR-egXML-bx" source="#NONE">… marginal comments which indicate that the <corr>dates</corr>
mentioned in the main body of the text are incorrect.</egXML></p>
```
...
```xml
<p>Alternatively, the encoder may simply record the typographic
error without correcting it, either without comment or with a
<gi>sic</gi> element to indicate the error is not a transcription error
in the encoding:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDCOR-egXML-oa" source="#NONE">… marginal comments which indicate that the <sic>date's</sic>
...
```xml
<p>If the encoder elects both to record the original source text
and to provide a correction for the sake of word-search
and other programs, both <gi>sic</gi> and <gi>corr</gi> are used,
wrapped in a <gi>choice</gi>:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDCOR-egXML-ru" source="#NONE">… marginal comments which indicate that the
...
XML location: `/div[1]/div[5]/div[1]/p[6]`.
...
XML location: `/div[1]/div[5]/div[1]/p[7]`.
...
XML location: `/div[1]/div[5]/div[1]/specGrp[1]`.
...
```xml
<p>When the source text makes extensive use of
variant forms or non-standard spellings, it may be desirable for a
number of reasons to <term>regularize</term> it: that is, to provide
<soCalled>standard</soCalled> or <soCalled>regularized</soCalled>
forms equivalent to the non-standard forms.<note place="bottom">In some
...
```xml
<p>As with other such changes to the copy
text, the changes may be made silently (in which case the TEI header
should specify the types of silent changes made) or may be explicitly
marked using the following elements:
<specList>
...
```xml
<p>Typical applications for these elements include the production of
editions intended for student or lay readers, linguistic research in
which spelling or usage variation is not the main question at issue,
production of spelling dictionaries, etc.</p>
```
...
```xml
<p>Consider this 16th-century text:
<q rend="display">how godly a dede it is to overthrowe so wicked a race
the world may judge: for my part I thinke there canot
be a greater sacryfice to God.</q></p>
```
...
```xml
<p>An encoder may choose to preserve the original spelling of this
text, but simply flag it as nonstandard by using the <gi>orig</gi>
element with no attributes specified, as follows:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDREG-egXML-ne" source="#COEDREG-eg-74"><p>...how godly a <orig>dede</orig> it is to
<orig>overthrowe</orig> so wicked a race the
world may judge: for my part I <orig>thinke</orig>
there <orig>canot</orig> be a greater
<orig>sacryfice</orig> to God</p></egXML></p>
```
...
```xml
<p>Alternatively, the encoder may simply indicate that certain words
have been modernized by using the <gi>reg</gi> element with no
attributes specified, as follows:<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDREG-egXML-bj" source="#COEDREG-eg-74"><p>...how godly a
<reg>deed</reg> it is to <reg>overthrow</reg> so wicked a race the
world may judge: for my part I <reg>think</reg>
there <reg>cannot</reg> be a greater
<reg>sacrifice</reg> to God.</p></egXML></p>
```
...
XML location: `/div[1]/div[5]/div[2]/p[7]`.

```xml
<p>Alternatively, the encoder may elect to record both old and new
spellings, so that (for example) the same electronic text may serve as
the basis of an old- or new-spelling edition:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDREG-egXML-ss" source="#COEDREG-eg-74"><p>...how godly a <choice><orig>dede</orig><reg>deed</reg></choice> it is to
<choice><orig>overthrowe</orig><reg>overthrow</reg></choice> so wicked a race the
...
XML location: `/div[1]/div[5]/div[2]/p[8]`.

```xml
<p>As elsewhere, the <att>resp</att> attribute may be used to specify the agency
responsible for the regularization. 
</p>
```
...
XML location: `/div[1]/div[5]/div[2]/specGrp[1]`.
...
```xml
<p>The <gi>add</gi> element should not be used to mark editorial
changes, such as supplying a word omitted by mistake from the source
text or a passage present in another version. In these cases, either
the <gi>corr</gi> or <gi>supplied</gi> tags should be used, as
discussed above in section <ptr target="#COEDCOR"/>, and in section
<ptr target="#PHCC"/>, respectively.</p>
```
...
XML location: `/div[1]/div[5]/div[3]/p[10]`.

```xml
<p>The <gi>unclear</gi> element is used to mark passages in the
original which cannot be read with confidence, or about which the
transcriber is uncertain for other reasons, as for example when
transcribing a partially inaudible or illegible source. Its
<att>reason</att> and <att>resp</att> attributes are used, as with the
<gi>gap</gi> element, to indicate the cause of uncertainty and the
person responsible for the conjectured reading.</p>
```
...
XML location: `/div[1]/div[5]/div[3]/p[11]`.
...
XML location: `/div[1]/div[5]/div[3]/p[12]`.
...
XML location: `/div[1]/div[5]/div[3]/p[13]`.
...
XML location: `/div[1]/div[5]/div[3]/p[14]`.

```xml
<p>The <att>rend</att> attribute may be used to distinguish different
methods of deletion in manuscript or typescript material, as in this
line from the typescript of Eliot's <title>Waste Land</title>:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="COEDADD-egXML-vw" xml:lang="de" source="#COEDADD-eg-89">
  <l><del rend="overtyped">Mein</del> Frisch <del rend="overstrike">schwebt</del> weht der Wind</l>
...
XML location: `/div[1]/div[5]/div[3]/p[15]`.
...
XML location: `/div[1]/div[5]/div[3]/p[16]`.
...
XML location: `/div[1]/div[5]/div[3]/specGrp[1]`.
...
```xml
<head>Names, Numbers, Dates, Abbreviations, and Addresses</head>
```
...
XML location: `/div[1]/div[6]/div[1]/head[1]`.
...
XML location: `/div[1]/div[6]/div[1]/p[1]`.
...
XML location: `/div[1]/div[6]/div[1]/p[2]`.
...
XML location: `/div[1]/div[6]/div[1]/p[3]`.

```xml
<p>As the following example shows, the <gi>rs</gi> element may be used
for any reference to a person, place, etc., not only to references in
the form of a proper noun or noun phrase.
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CONARS-egXML-no" source="#CONARS-eg-101"><p><q>My dear <rs type="person">Mr. Bennet</rs></q>, said
<rs type="person">his lady</rs> to him one day ... </p></egXML>
...
XML location: `/div[1]/div[6]/div[1]/p[4]`.
...
XML location: `/div[1]/div[6]/div[1]/p[5]`.
...
XML location: `/div[1]/div[6]/div[1]/p[6]`.
...
XML location: `/div[1]/div[6]/div[1]/p[7]`.
...
XML location: `/div[1]/div[6]/div[1]/p[8]`.
...
XML location: `/div[1]/div[6]/div[1]/p[9]`.
...
XML location: `/div[1]/div[6]/div[1]/p[10]`.
...
XML location: `/div[1]/div[6]/div[1]/p[11]`.
...
XML location: `/div[1]/div[6]/div[1]/p[12]`.
...
XML location: `/div[1]/div[6]/div[1]/p[13]`.
...
XML location: `/div[1]/div[6]/div[1]/p[14]`.
...
XML location: `/div[1]/div[6]/div[1]/p[15]`.

```xml
<p>The <gi>index</gi> element discussed in <ptr target="#CONOIX"/> may be
more appropriate if the function of the regularization is to provide a
consistent index:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CONARS-egXML-gs" source="#CONARS-eg-111"><p><name type="place">Montaillou</name> is not a large parish.
At the time of the events which led to
...
XML location: `/div[1]/div[6]/div[1]/specGrp[1]`.
...
XML location: `/div[1]/div[6]/div[2]/head[1]`.
...
XML location: `/div[1]/div[6]/div[2]/p[1]`.
...
XML location: `/div[1]/div[6]/div[2]/p[2]`.
...
XML location: `/div[1]/div[6]/div[2]/p[3]`.
...
XML location: `/div[1]/div[6]/div[2]/p[4]`.
...
XML location: `/div[1]/div[6]/div[2]/p[5]`.
...
XML location: `/div[1]/div[6]/div[2]/p[6]`.
...
XML location: `/div[1]/div[6]/div[2]/p[7]`.
...
XML location: `/div[1]/div[6]/div[2]/p[8]`.
...
XML location: `/div[1]/div[6]/div[2]/p[9]`.
...
XML location: `/div[1]/div[6]/div[2]/p[10]`.
...
XML location: `/div[1]/div[6]/div[2]/specGrp[1]`.

```xml
<specGrp xml:id="DCOAD" n="Addresses and their components"><include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/email.xml"/>
<include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/address.xml"/>
<include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/addrLine.xml"/>
<include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/street.xml"/>
<include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/postCode.xml"/>
...
XML location: `/div[1]/div[6]/div[3]/head[1]`.
...
XML location: `/div[1]/div[6]/div[3]/p[1]`.
...
XML location: `/div[1]/div[6]/div[3]/p[2]`.
...
XML location: `/div[1]/div[6]/div[3]/p[3]`.
...
XML location: `/div[1]/div[6]/div[3]/p[4]`.
...
XML location: `/div[1]/div[6]/div[3]/p[5]`.
...
XML location: `/div[1]/div[6]/div[3]/p[6]`.
...
XML location: `/div[1]/div[6]/div[3]/p[7]`.
...
XML location: `/div[1]/div[6]/div[3]/p[8]`.
...
XML location: `/div[1]/div[6]/div[3]/p[9]`.
...
XML location: `/div[1]/div[6]/div[3]/p[10]`.
...
XML location: `/div[1]/div[6]/div[3]/p[11]`.
...
XML location: `/div[1]/div[6]/div[3]/specGrp[1]`.
...
XML location: `/div[1]/div[6]/div[4]/head[1]`.
...
XML location: `/div[1]/div[6]/div[4]/p[1]`.
...
XML location: `/div[1]/div[6]/div[4]/p[2]`.
...
XML location: `/div[1]/div[6]/div[4]/p[3]`.
...
XML location: `/div[1]/div[6]/div[4]/p[4]`.
...
XML location: `/div[1]/div[6]/div[4]/p[5]`.
...
XML location: `/div[1]/div[6]/div[4]/p[6]`.
...
XML location: `/div[1]/div[6]/div[4]/p[7]`.
...
XML location: `/div[1]/div[6]/div[4]/p[8]`.
...
XML location: `/div[1]/div[6]/div[4]/p[9]`.
...
XML location: `/div[1]/div[6]/div[4]/specGrp[1]`.
...
XML location: `/div[1]/div[6]/div[5]/head[1]`.

```xml
<head>Abbreviations and Their Expansions</head>
```
...
XML location: `/div[1]/div[6]/div[5]/p[1]`.
...
XML location: `/div[1]/div[6]/div[5]/p[2]`.
...
XML location: `/div[1]/div[6]/div[5]/p[3]`.

```xml
<p>The <att>type</att> attribute may be used to distinguish types
  of abbreviation by their function:<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CONAAB-egXML-su" source="#NONE"><abbr type="title">Dr.</abbr> <abbr type="initial">M.</abbr> Deegan is
the Director of the <abbr type="acronym">CTI</abbr> Centre for Textual Studies.</egXML>
 </p>
```
...
XML location: `/div[1]/div[6]/div[5]/p[4]`.
...
XML location: `/div[1]/div[6]/div[5]/p[5]`.
...
XML location: `/div[1]/div[6]/div[5]/p[6]`.
...
XML location: `/div[1]/div[6]/div[5]/specGrp[1]`.
...
```xml
<head>Simple Links and Cross-References</head>
```
...
```xml
<p>The <gi>ptr</gi> and <gi>ref</gi> elements have many applications in
addition to the simple cross-referencing facilities illustrated in this
section. In conjunction with the analytic tools discussed
in chapters <ptr target="#SA"/>, <ptr target="#AI"/>, and <ptr target="#FS"/>, they may be
used to link analyses of a text to their object, to combine
...
```xml
<head>Notes, Annotation, and Indexing</head>
```
...
```xml
<head>Notes and Simple Annotation</head>
```
...
XML location: `/div[1]/div[9]/div[1]/p[6]`.
...
XML location: `/div[1]/div[9]/div[1]/p[7]`.
...
XML location: `/div[1]/div[9]/div[1]/p[8]`.
...
XML location: `/div[1]/div[9]/div[1]/p[9]`.
...
XML location: `/div[1]/div[9]/div[1]/p[10]`.
...
XML location: `/div[1]/div[9]/div[1]/p[11]`.
...
XML location: `/div[1]/div[9]/div[1]/p[12]`.
...
XML location: `/div[1]/div[9]/div[1]/p[13]`.
...
XML location: `/div[1]/div[9]/div[1]/div[1]/head[1]`.

```xml
<head>Encoding Grouped Notes</head>
```
...
XML location: `/div[1]/div[9]/div[1]/div[1]/p[1]`.
...
XML location: `/div[1]/div[9]/div[1]/div[1]/p[2]`.
...
XML location: `/div[1]/div[9]/div[1]/div[1]/p[3]`.
...
XML location: `/div[1]/div[9]/div[1]/div[1]/p[4]`.
...
XML location: `/div[1]/div[9]/div[2]/div[1]/head[1]`.

```xml
<head>Pre-existing Indexes</head>
```
...
XML location: `/div[1]/div[9]/div[2]/div[1]/p[1]`.
...
XML location: `/div[1]/div[9]/div[2]/div[1]/p[2]`.
...
XML location: `/div[1]/div[9]/div[2]/div[1]/p[3]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/head[1]`.

```xml
<head>Auto-generated Indexes</head>
```
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[1]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[2]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[3]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[4]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[5]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[6]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[7]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[8]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[9]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[10]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[11]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[12]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[13]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[14]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[15]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[16]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/p[17]`.
...
XML location: `/div[1]/div[9]/div[2]/div[2]/specGrp[1]`.
...
```xml
<head>Graphics and Other Non-textual Components</head>
```
...
XML location: `/div[1]/div[10]/specGrp[1]`.
...
XML location: `/div[1]/div[11]/div[1]/head[1]`.

```xml
<head>Using the <att>xml:id</att> and <att>n</att> Attributes</head>
```
...
XML location: `/div[1]/div[11]/div[1]/p[1]`.
...
XML location: `/div[1]/div[11]/div[1]/p[2]`.
...
XML location: `/div[1]/div[11]/div[1]/p[3]`.
...
XML location: `/div[1]/div[11]/div[1]/p[4]`.
...
XML location: `/div[1]/div[11]/div[1]/p[5]`.
...
XML location: `/div[1]/div[11]/div[1]/p[6]`.
...
XML location: `/div[1]/div[11]/div[2]/head[1]`.

```xml
<head>Creating New Reference Systems</head>
```
...
XML location: `/div[1]/div[11]/div[2]/p[1]`.
...
XML location: `/div[1]/div[11]/div[2]/p[2]`.
...
XML location: `/div[1]/div[11]/div[2]/p[3]`.
...
XML location: `/div[1]/div[11]/div[2]/p[4]`.
...
XML location: `/div[1]/div[11]/div[2]/div[1]/head[1]`.
...
XML location: `/div[1]/div[11]/div[2]/div[1]/p[1]`.
...
XML location: `/div[1]/div[11]/div[2]/div[1]/p[2]`.
...
XML location: `/div[1]/div[11]/div[2]/div[1]/p[3]`.
...
XML location: `/div[1]/div[11]/div[2]/div[1]/p[4]`.
...
XML location: `/div[1]/div[11]/div[2]/div[1]/p[5]`.
...
XML location: `/div[1]/div[11]/div[2]/div[2]/head[1]`.
...
XML location: `/div[1]/div[11]/div[2]/div[2]/p[1]`.
...
XML location: `/div[1]/div[11]/div[2]/div[2]/p[2]`.
...
XML location: `/div[1]/div[11]/div[2]/div[2]/p[3]`.
...
XML location: `/div[1]/div[11]/div[2]/div[2]/p[4]`.
...
XML location: `/div[1]/div[11]/div[3]/head[1]`.
...
XML location: `/div[1]/div[11]/div[3]/p[1]`.

```xml
<p>Where the desired reference system does not
correspond to any particular structural hierarchy, or the document
combines multiple structural hierarchies (as further discussed in <ptr target="#NH"/>), simpler though less expressive methods may be
necessary. In such cases the simplest solution may be just to mark up
changes in the reference system where they occur, by using one or more
...
XML location: `/div[1]/div[11]/div[3]/p[2]`.
...
XML location: `/div[1]/div[11]/div[3]/p[3]`.
...
XML location: `/div[1]/div[11]/div[3]/p[4]`.
...
XML location: `/div[1]/div[11]/div[3]/p[5]`.

```xml
<p>Milestone tags also make it possible to record the reference systems
used in a number of different editions of the same work. The reference
system of any one edition can be recreated from a text in which all are
marked by simply ignoring all elements that do not specify that edition
on their <att>ed</att> attribute.
...
XML location: `/div[1]/div[11]/div[3]/p[6]`.
...
XML location: `/div[1]/div[11]/div[3]/p[7]`.
...
XML location: `/div[1]/div[11]/div[3]/p[8]`.
...
XML location: `/div[1]/div[11]/div[3]/p[9]`.
...
XML location: `/div[1]/div[11]/div[3]/p[10]`.
...
XML location: `/div[1]/div[11]/div[3]/p[11]`.
...
XML location: `/div[1]/div[11]/div[3]/p[12]`.
...
XML location: `/div[1]/div[11]/div[3]/p[13]`.
...
XML location: `/div[1]/div[11]/div[3]/p[14]`.
...
XML location: `/div[1]/div[11]/div[3]/specGrp[1]`.
...
XML location: `/div[1]/div[11]/div[4]/head[1]`.

```xml
<head>Declaring Reference Systems</head>
```
...
XML location: `/div[1]/div[11]/div[4]/p[1]`.
...
XML location: `/div[1]/div[11]/div[4]/p[2]`.
...
XML location: `/div[1]/div[11]/div[4]/p[3]`.
...
XML location: `/div[1]/div[11]/div[4]/p[4]`.
...
XML location: `/div[1]/div[11]/div[4]/p[5]`.
...
XML location: `/div[1]/div[11]/div[4]/p[6]`.
...
XML location: `/div[1]/div[11]/div[4]/p[7]`.
...
XML location: `/div[1]/div[11]/div[4]/p[8]`.
...
XML location: `/div[1]/div[12]/div[1]/head[1]`.

```xml
<head>Methods of Encoding Bibliographic References and Lists of References</head>
```
...
XML location: `/div[1]/div[12]/div[1]/p[1]`.
...
XML location: `/div[1]/div[12]/div[1]/p[2]`.
...
XML location: `/div[1]/div[12]/div[1]/p[3]`.
...
XML location: `/div[1]/div[12]/div[1]/p[4]`.
...
XML location: `/div[1]/div[12]/div[1]/p[5]`.
...
XML location: `/div[1]/div[12]/div[1]/p[6]`.
...
XML location: `/div[1]/div[12]/div[1]/p[7]`.
...
XML location: `/div[1]/div[12]/div[1]/p[8]`.
...
XML location: `/div[1]/div[12]/div[2]/head[1]`.
...
XML location: `/div[1]/div[12]/div[2]/p[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/head[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/p[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/p[2]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/p[3]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/p[4]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/p[5]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/p[6]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/p[7]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/p[8]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/p[9]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/p[10]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/egXML[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/p[11]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/p[12]`.
...
XML location: `/div[1]/div[12]/div[2]/div[1]/specGrp[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/head[1]`.

```xml
<head>Titles, Authors, and Editors</head>
```
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[2]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[3]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[4]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[5]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[6]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[7]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[8]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/egXML[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[9]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[10]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[11]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[12]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[13]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[14]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[15]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/p[16]`.
...
XML location: `/div[1]/div[12]/div[2]/div[2]/specGrp[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[3]/head[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[3]/p[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[3]/p[2]`.
...
XML location: `/div[1]/div[12]/div[2]/div[3]/p[3]`.
...
XML location: `/div[1]/div[12]/div[2]/div[3]/p[4]`.
...
XML location: `/div[1]/div[12]/div[2]/div[4]/head[1]`.

```xml
<head>Imprint, Size of a Document, and Reprint Information</head>
```
...
XML location: `/div[1]/div[12]/div[2]/div[4]/p[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[4]/p[2]`.
...
XML location: `/div[1]/div[12]/div[2]/div[4]/p[3]`.
...
XML location: `/div[1]/div[12]/div[2]/div[4]/p[4]`.
...
XML location: `/div[1]/div[12]/div[2]/div[4]/p[5]`.
...
XML location: `/div[1]/div[12]/div[2]/div[4]/p[6]`.
...
XML location: `/div[1]/div[12]/div[2]/div[4]/p[7]`.
...
XML location: `/div[1]/div[12]/div[2]/div[4]/p[8]`.
...
XML location: `/div[1]/div[12]/div[2]/div[4]/p[9]`.
...
XML location: `/div[1]/div[12]/div[2]/div[5]/head[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[5]/p[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[5]/p[2]`.
...
XML location: `/div[1]/div[12]/div[2]/div[5]/p[3]`.
...
XML location: `/div[1]/div[12]/div[2]/div[5]/p[4]`.
...
XML location: `/div[1]/div[12]/div[2]/div[5]/specGrp[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[6]/head[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[6]/p[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[7]/head[1]`.

```xml
<head>Related Items</head>
```
...
XML location: `/div[1]/div[12]/div[2]/div[7]/p[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[7]/p[2]`.
...
XML location: `/div[1]/div[12]/div[2]/div[7]/p[3]`.
...
XML location: `/div[1]/div[12]/div[2]/div[7]/p[4]`.
...
XML location: `/div[1]/div[12]/div[2]/div[7]/p[5]`.
...
XML location: `/div[1]/div[12]/div[2]/div[7]/specGrp[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[8]/head[1]`.

```xml
<head>Notes and Statement of Language</head>
```
...
XML location: `/div[1]/div[12]/div[2]/div[8]/p[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[8]/p[2]`.
...
XML location: `/div[1]/div[12]/div[2]/div[8]/p[3]`.
...
XML location: `/div[1]/div[12]/div[2]/div[8]/p[4]`.
...
XML location: `/div[1]/div[12]/div[2]/div[8]/p[5]`.
...
XML location: `/div[1]/div[12]/div[2]/div[9]/head[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[9]/p[1]`.
...
XML location: `/div[1]/div[12]/div[2]/div[9]/p[2]`.
...
XML location: `/div[1]/div[12]/div[2]/div[9]/p[3]`.
...
XML location: `/div[1]/div[12]/div[2]/div[9]/p[4]`.
...
XML location: `/div[1]/div[12]/div[3]/head[1]`.
...
XML location: `/div[1]/div[12]/div[3]/p[1]`.
...
XML location: `/div[1]/div[12]/div[3]/p[2]`.
...
XML location: `/div[1]/div[12]/div[3]/p[3]`.
...
XML location: `/div[1]/div[12]/div[3]/p[4]`.
...
XML location: `/div[1]/div[12]/div[4]/head[1]`.
...
XML location: `/div[1]/div[12]/div[4]/p[1]`.
...
XML location: `/div[1]/div[12]/div[4]/p[2]`.
...
```xml
<head>Passages of Verse or Drama</head>
```
...
XML location: `/div[1]/div[13]/div[1]/head[1]`.

```xml
<head>Core Tags for Verse</head>
```
...
XML location: `/div[1]/div[13]/div[1]/p[1]`.
...
XML location: `/div[1]/div[13]/div[1]/p[2]`.
...
XML location: `/div[1]/div[13]/div[1]/p[3]`.
...
XML location: `/div[1]/div[13]/div[1]/p[4]`.
...
XML location: `/div[1]/div[13]/div[1]/p[5]`.
...
XML location: `/div[1]/div[13]/div[1]/p[6]`.
...
XML location: `/div[1]/div[13]/div[1]/p[7]`.
...
XML location: `/div[1]/div[13]/div[1]/p[8]`.
...
XML location: `/div[1]/div[13]/div[1]/p[9]`.
...
XML location: `/div[1]/div[13]/div[1]/specGrp[1]`.
...
XML location: `/div[1]/div[13]/div[2]/head[1]`.

```xml
<head>Core Tags for Drama</head>
```
...
XML location: `/div[1]/div[13]/div[2]/p[1]`.

```xml
<p>Like other written texts, dramatic and other <term>performance
texts</term> such as cinema or TV scripts are often hierarchically
organized, for example into acts and scenes.  These structural
subdivisions should be encoded using the general purpose <gi>div</gi>
or <gi>div1</gi> (etc.) elements described below in chapters <ptr target="#DS"/> and <ptr target="#DR"/>.  Within these divisions, the
...
XML location: `/div[1]/div[13]/div[2]/p[2]`.

```xml
<p>In the following simple example, each speech consists of a single
paragraph:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="CODR-egXML-fl" source="#COVE-eg-285"><div2 n="I.2" type="scene">
   <head>Scene 2.</head>
   <stage type="setting">Peachum, Filch.</stage>
...
XML location: `/div[1]/div[13]/div[2]/p[3]`.
...
XML location: `/div[1]/div[13]/div[2]/p[4]`.
...
XML location: `/div[1]/div[13]/div[2]/p[5]`.
...
XML location: `/div[1]/div[13]/div[2]/p[6]`.
...
XML location: `/div[1]/div[13]/div[2]/specGrp[1]`.
...
XML location: `/div[1]/div[14]/head[1]`.
...
XML location: `/div[1]/div[14]/specGrpRef[1]`.
...
XML location: `/div[1]/div[14]/specGrpRef[2]`.
...
XML location: `/div[1]/div[14]/specGrpRef[3]`.
...
XML location: `/div[1]/div[14]/specGrpRef[4]`.
...
XML location: `/div[1]/div[14]/specGrpRef[5]`.
...
XML location: `/div[1]/div[14]/specGrpRef[6]`.
...
XML location: `/div[1]/div[14]/specGrpRef[7]`.
...
XML location: `/div[1]/div[14]/specGrpRef[8]`.
...
XML location: `/div[1]/div[14]/specGrpRef[9]`.
...
XML location: `/div[1]/div[14]/specGrpRef[10]`.
...
XML location: `/div[1]/div[14]/specGrpRef[11]`.
...
XML location: `/div[1]/div[14]/specGrpRef[12]`.
...
XML location: `/div[1]/div[14]/specGrpRef[13]`.
...
XML location: `/div[1]/div[14]/specGrpRef[14]`.
...
XML location: `/div[1]/div[14]/specGrpRef[15]`.
...
XML location: `/div[1]/div[14]/specGrpRef[16]`.
...
XML location: `/div[1]/div[14]/specGrpRef[17]`.
...
XML location: `/div[1]/div[14]/specGrpRef[18]`.
