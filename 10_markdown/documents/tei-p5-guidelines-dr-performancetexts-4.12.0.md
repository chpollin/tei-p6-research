...
source: '[[00_sources/tei-p5-guidelines-dr-performancetexts-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 Performance Texts
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Guidelines/en/DR-PerformanceTexts.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 71152. Git blob: `494ab346af9c309abdb7c2e9bc8bf2249cc22a2e`.
...
following examples:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRSET-egXML-ef" source="#DR-eg-01"><front>
  <castList>
    <castItem> ... </castItem>
  </castList>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRSET-egXML-rx" source="#DR-eg-02"><front>
...
example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRPRO-egXML-zt" source="#DRPRO-eg-6"><front>
  <prologue>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRPRO-egXML-ch" source="#DRPRO-eg-7"><epilogue>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRPRO-egXML-sl" source="#CODR-eg-295"><text>
  <body>
    <div1 type="scene">
      <sp>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRPRO-egXML-zi" source="#CODR-eg-295"><sp>
...
purpose elements for encoding names and dates as described in <ptr target="#CO"/>.
No particular elements for such features as stagehouses,
directors, etc., are proposed at this time.
 </p>
<p>For example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRPERF-egXML-ml" source="#DRPERF-eg-12"><performance>
...
<!-- N.B. first two 'p' elements might also be BYLINE?        -->
	...
	<!-- -msm                                                     -->
Or:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRPERF-egXML-gs" source="#DRPERF-eg-13" xml:lang="fr"><performance>
...
<!-- La Machine Infernale, Jean Cocteau -->
  ...
  <p>Performance-specific information (e.g. different actors in different performances) can be encoded using the <att>perf</att> attribute, provided by the <ident>att.performed</ident> attribute class:
    <specList>
      <specDesc key="att.performed"/>
    </specList>
The <att>perf</att> attribute allows one or more pointers to documentation (given through e.g. the <gi>performance</gi> or <gi>event</gi> elements) to associate an element (such as <gi>actor</gi>) with one or more performances:
    
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRPERF-egXML-perf" source="#DRPERF-eg-13.1">
    <performance xml:id="L1025P1"><p>First performed at the Strand Theatre, on the 18th of July, 1832.</p></performance>
    <performance xml:id="L1025P2"><p>Royal Victoria Theatre in July 1834</p></performance>
    
    <castList>
      <head>Characters.</head>
      <castItem>
        <role gender="M">CHARLES WYNDHAM</role>
        <roleDesc>(an Englishman amusing himself in Paris)</roleDesc>
        <actor sex="M" perf="#L1025P1">Mr. ABBOTT.</actor>
        <actor sex="M" perf="#L1025P2">Mr. SELBY.</actor>
      </castItem>
      <castItem>
        <role gender="M">SAM</role>
        <roleDesc>(his Servant)</roleDesc>
        <actor sex="M" perf="#L1025P1">Mr. MITCHELL. </actor>
        <actor sex="M" perf="#L1025P2">Mr. ROSS.</actor>
      </castItem>
      <!-- ... -->
    </castList>
  </egXML>
...
<specGrp xml:id="DDRPERF" n="The performance element">
  ...
  <include xmlns="http://www.w3.org/2001/XInclude" href="../../Specs/att.performed.xml"/>
</specGrp>
</div>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRCAST-egXML-mk" source="#DRCAST-eg-16"><performance>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRCAST-egXML-eh"><castItem>     
  <role xml:id="vlad">Vladimir</role>:
  <actor>Paul Daneman</actor>
</castItem></egXML>
 </p>
<p>The <att>ref</att> attribute on <gi>actor</gi> may be used to associate the name
...
we might associate the name of Paul Daneman with his entry in a widely used bibliography as follows :
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRCAST-egXML-we">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRCAST-egXML-lg" source="#DRCAST-eg-18"><castItem> 
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRCAST-egXML-cs"><castItem>  
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRCAST-egXML-ww"><castItem type="list">Constables, Drawer, Turnkey, etc.</castItem>
<castItem type="list">     
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRCAST-egXML-ja" source="#DRCAST-eg-21"><castGroup rend="braced">
...
example as follows:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRCAST-egXML-pd" source="#DRCAST-eg-21"><castGroup rend="braced">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRCAST-egXML-zq" source="#DRCAST-eg-23"><castList>
   <castGroup>
...
something is verse or prose) <gi>ab</gi> elements (see <ptr target="#DRPAL"/>).</p>
...
example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRDIV-egXML-ns" source="#DRDIV-eg-31"><body>
   <div1 type="scene" n="1">
...
as in this example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRDIV-egXML-oy" source="#DRDIV-eg-32"><body>
  <div1 type="act" n="1">
	<head>Act One</head>
	<div2 type="scene" n="1">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRDIV-egXML-ac"><div type="act" n="2">
   <head>Act Two</head>
   <div type="scene" n="1">
      <head>Scene One</head>
   </div>
...
might point to a <gi>person</gi> element in the TEI header <ptr target="#CCAHPA"/>, to a <gi>role</gi> element in the cast list <ptr target="#DRCAST"/>, or even to some external source such as an online
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRSP-egXML-ab" source="#DRSP-eg-34" xml:lang="la"><castList>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRSP-egXML-fc" source="#DRSP-eg-35"><castList>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRSP-egXML-ph" source="#DRSP-eg-34" xml:lang="la"><castList>
...
following example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRSP-egXML-gh" source="#DRSP-eg-37">
  <castList>
...
<gi>castList</gi> may be encoded inside the <gi>standOff</gi>
...
within the core module (see section <ptr target="#CODV"/>).</p></div>

<div type="div3" xml:id="DRSPG"><head>Grouped Speeches</head>
<p>This module makes available the following additional element for
handling groups of speeches: <specList><specDesc key="spGrp"/></specList></p>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRSPG-egXML-yi" source="#GerStra"><spGrp type="number" n="3">
...
JT (2026): Because of the above conversation, I've now wrapped the `dont` in a `<sic>`
    to remove any future confusion.-->
...
possibilities.
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRSTA-egXML-jl"><stage type="setting">The throne descends.</stage>
...
For example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRSTA-egXML-jn"><tagUsage gi="stage">This element is used for all stage directions,
...
above:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRSTA-egXML-hc">
...
example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRSTA-egXML-up" source="#DRSTA-eg-40"><div1 n="1" type="act">
<stage type="setting">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRSTA-egXML-dh" source="#DR-eg-04"><castList>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRSTA-egXML-kz" source="#DR-eg-05"><castList>
...
elements inherit from the <ident type="class">att.fragmentable</ident> class provides one simple way of indicating where the boundaries of a
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRPAL-egXML-zh" source="#DRPAL-eg-44"><sp><speaker>Face</speaker><l part="N">You most
...
may be used to indicate how metrical lines are constituted:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRPAL-egXML-nq" source="#DRPAL-eg-44"><sp><speaker>Face</speaker><l>You most
notorious whelp, you insolent slave</l>
...
example:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRPAL-egXML-fm" source="#DRPAL-eg-46"><spGrp>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DRPAL-egXML-rh" source="#DRPAL-eg-46"><spGrp>
<head>Song — Sir Joseph</head>
<sp><lg part="I">
    <l>I am the monarch of the sea,</l>
    <l>The ruler of the Queen's Navee.</l>
...
of the speech: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DREMB-egXML-fr" source="#DR-eg-07"><sp><speaker>Kelly</speaker>
   <stage>(calmly).</stage>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DREMB-egXML-qu" source="#DR-eg-07"><sp><speaker>Kelly</speaker>
   <stage>(calmly).</stage>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DREMB-egXML-qz" source="#DR-eg-07"><sp><speaker>Kelly</speaker>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DREMB-egXML-rz" source="#CODR-eg-293"><div1 n="4" type="act">
  <div2 n="5" type="scene">
...
might be encoded as follows:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DREMB-egXML-cm" source="#CODR-eg-293"><text>
  <body>
    <div1 n="4" type="act">
      <div2 n="5" type="scene">
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DROTH-egXML-kk" source="#FieldScreen"><camera>Angle on Olivia.</camera>
...
small capitals:
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DROTH-egXML-kx" source="#FieldScreen"><view>George glances at the window—and freezes.
...
<!-- source? -->
  <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DROTH-egXML-wl" source="#FieldScreen"><view>Ext. TV control van—Early morning.
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DROTH-egXML-ec" source="#FieldScreen"><sp>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DROTH-egXML-me" source="#DROTH-eg-57"><sp> <speaker>Benjy</speaker>
   <p>Now to business.</p>
</sp>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="DROTH-egXML-oy" source="#DROTH-eg-58"><camera>Zoom in to overlay showing some stock film
...
<div>
  <head>Module for Performance Texts</head>
  <p>The module described in this chapter makes available the
  following components:
  <moduleSpec xml:id="DDR" ident="drama">
    <idno type="FPI">Performance Texts</idno>
    <desc xml:lang="en" versionDate="2006-09-13">Performance texts</desc>
    <desc xml:lang="fr" versionDate="2018-07-12">Théâtre</desc>
    <desc xml:lang="zh-TW" versionDate="2018-07-12">劇本</desc>
    <desc xml:lang="it" versionDate="2018-07-12">Testi per performance</desc>
    <desc xml:lang="pt" versionDate="2018-07-12">Textos de actuação</desc>
    <desc xml:lang="ja" versionDate="2018-07-12">舞台芸術モジュール</desc>
  </moduleSpec>
...
XML location: `/div[1]/specGrpRef[1]`.
...
XML location: `/div[1]/specGrpRef[2]`.
...
XML location: `/div[1]/specGrpRef[3]`.
...
```xml
<head>Prologues and Epilogues</head>
```
...
```xml
<head>Records of Performances</head>
```
...
```xml
<p>A <gi>castItem</gi> element may contain any mixture of elements
taken from the <ident type="class">model.castItemPart</ident> class,
members of which (when this module is included) are:
<specList>
<specDesc key="role"/><specDesc key="roleDesc"/><specDesc key="actor"/></specList>
...
XML location: `/div[1]/div[1]/div[4]/p[7]`.
...
XML location: `/div[1]/div[1]/div[4]/p[8]`.
...
XML location: `/div[1]/div[1]/div[4]/p[9]`.
...
XML location: `/div[1]/div[1]/div[4]/p[10]`.
...
XML location: `/div[1]/div[1]/div[4]/p[11]`.
...
XML location: `/div[1]/div[1]/div[4]/specGrp[1]`.
...
```xml
<head>The Body of a Performance Text</head>
```
...
```xml
<head>Major Structural Divisions</head>
```
...
```xml
<p>For further discussion of the use of numbered and unnumbered
divisions, see section <ptr target="#DSDIV"/>.</p>
```
...
```xml
<head>Speeches and Speakers</head>
```
...
```xml
<p>The <gi>sp</gi> and <gi>speaker</gi> elements are both declared
within the core module (see section <ptr target="#CODV"/>).</p>
```
...
XML location: `/div[1]/div[2]/div[5]/p[6]`.
...
XML location: `/div[1]/div[2]/div[5]/p[7]`.
...
XML location: `/div[1]/div[2]/div[5]/p[8]`.
...
XML location: `/div[1]/div[2]/div[5]/p[9]`.
...
XML location: `/div[1]/div[2]/div[5]/specGrp[1]`.
...
XML location: `/div[1]/div[2]/div[6]/p[5]`.
...
XML location: `/div[1]/div[2]/div[6]/p[6]`.
...
XML location: `/div[1]/div[2]/div[6]/p[7]`.
...
XML location: `/div[1]/div[2]/div[6]/p[8]`.
...
XML location: `/div[1]/div[2]/div[6]/p[9]`.
...
XML location: `/div[1]/div[2]/div[6]/p[10]`.
...
```xml
<head>Other Types of Performance Text</head>
```
