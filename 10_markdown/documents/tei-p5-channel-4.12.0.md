...
source: '[[00_sources/tei-p5-channel-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 channel
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Specs/channel.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 9142. Git blob: `17fbf85f44051b364b3f2374e99bb39b46af1ffb`.
...
<elementSpec xmlns="http://www.tei-c.org/ns/1.0" module="corpus" xml:id="gi-channel" ident="channel">
  ...
  <gloss versionDate="2023-10-02" xml:lang="ja">元の媒体</gloss>
    ...
    <attDef ident="mode" usage="opt">
      ...
      <valList type="closed">
        <valItem ident="s">
          ...
          <gloss versionDate="2023-10-02" xml:lang="ja">発話</gloss>
        </valItem>
        <valItem ident="w">
          ...
          <gloss versionDate="2023-10-02" xml:lang="ja">書記</gloss>
        </valItem>
        <valItem ident="sw">
          ...
          <gloss versionDate="2023-10-02" xml:lang="ja">書き起こし</gloss>
        ...
        <valItem ident="ws">
          ...
          <gloss versionDate="2023-10-02" xml:lang="ja">台本</gloss>
        ...
        <valItem ident="m">
          ...
          <gloss versionDate="2023-10-02" xml:lang="ja">混合</gloss>
        </valItem>
        <valItem ident="x">
          ...
          <gloss versionDate="2023-10-02" xml:lang="ja">不明または適用外</gloss>
        </valItem>
      </valList>
    </attDef>
  </attList>
  <exemplum xml:lang="en">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-channel-egXML-ay">
      <channel mode="s">face-to-face conversation</channel>
    </egXML>
  </exemplum>
  <exemplum versionDate="2008-04-06" xml:lang="fr">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-channel-egXML-ba">
      <channel mode="s">Conversation face à face</channel>
    </egXML>
  </exemplum>
  <exemplum xml:lang="zh-TW">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-channel-egXML-jo">
