...
source: '[[00_sources/tei-p5-guidelines-ve-verse-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 Verse
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Guidelines/en/VE-Verse.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 64414. Git blob: `295f751a8e29ca8e484471333eb49736ac826e29`.
...
<div xmlns="http://www.tei-c.org/ns/1.0" type="div1" xml:id="VE" n="9">
   ...
   <div type="div2" xml:id="VEST">
      ...
      <p>Many poems consist only of ungrouped lines.<!-- This short poem by Ezra Pound is a simple case:          -->
         ...
         Dickinson is a simple case: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEST-egXML-tk" source="#VEST-eg-1"><text>
               <front>
                  <head>1755</head>
               </front>
               <body>
      ...
      <p>Often, however, lines are grouped, formally or informally, into stanzas, verse paragraphs,
         ...
         as those of the following example from Allen Ginsberg: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEST-egXML-rr" source="#VEST-eg-2"><text>
               <body>
                  <head>My Alba</head>
                  <lg>
      ...
      <p>It may also be used to mark the verse paragraphs into which longer poems are often divided,
         ...
         Midnight</title>: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEST-egXML-cu" source="#VEST-eg-3"><lg>
      ...
      <p>Most typically, however, the <gi>lg</gi> element is used to mark the highly regular line
         ...
         from Chaucer: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEST-egXML-tl" source="#VEST-eg-4"><lg>
      ...
      <p>Like other text-division elements, <gi>lg</gi> elements may be nested hierarchically. For
         ...
         its components, as in the following example from Byron: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEST-egXML-ru" source="#VEST-eg-5"><lg type="stanza">
               <lg type="sestet">
      ...
      <p>Note the use of the <att>type</att> attribute to name the type of unit encoded by the
            <gi>lg</gi> element; this attribute is common to all members of the <ident type="class">att.divLike</ident> class (see section <ptr target="#DSDIV1"/>).<note place="bottom">For discussion of other attributes of this class, see <ptr target="#DSDIV3X"/>.</note>
      ...
      <p>As a further example, consider the Shakespearean sonnet. This may be divided into two
         ...
         <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEST-egXML-hk" source="#VEST-eg-6"><text>
               <body>
                  <lg>
                     <lg type="quatrain">
      ...
      <p>Large structures of this kind are most conveniently represented by <gi>div</gi> or
         ...
         of the <title>Faerie Queene</title> might be encoded as follows: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEST-egXML-qb" source="#VE-eg-01"><body>
               <div n="I" type="book">
                  <div n="1" type="canto">
         ...
         would (for example) also be possible to encode the above example as follows:<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEST-egXML-sn" source="#VE-eg-01"><body>
               <div n="I" type="book">
   ...
   <div type="div2" xml:id="VESE">
      ...
      <p>In Old and Middle English alliterative verse, individual verse lines are typically split
         ...
         following example from Langland's <title>Piers Plowman</title>: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VESE-egXML-js" source="#VESE-eg-9"><l><seg>In a somer
                  seson,</seg>
      ...
      <p>The <gi>seg</gi> element can be nested hierarchically, in the same way as the <gi>lg</gi>
         ...
         <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VESE-egXML-yj" xml:lang="la" source="#VE-eg-02"><l>
      ...
      <p>The <gi>seg</gi> element may be used to identify any subcomponent of a line which has
         ...
         provide a more systematic framework than the <att>type</att> attribute; see section <ptr target="#VEME"/> below.</p>
      <p>In classical verse, a hexameter like that above may also be formally divided into two
         ...
         follows. <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VESE-egXML-zd" xml:lang="la" source="#VE-eg-02"><l>
               <seg type="hemistich">
                  <seg type="foot">
      ...
      <p>As an example of the <gi>caesura</gi> element, we refer again to the example from Langland.
         ...
         rather than encoding each half-line as a segment in its own right, as follows: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VESE-egXML-re" source="#VESE-eg-9"><l>In a somer seson,
      ...
      <p>Logically, the opposite of caesura might be considered to be <term>enjambement</term>. When
         ...
         schools of verse): <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VESE-egXML-bi" xml:lang="fr" source="#VESE-eg-13"><l enjamb="y">Un astrologue, un jour, se laissa choir</l>
   ...
   <div type="div2" xml:id="VESA">
      ...
      <p>The following example from Margaret Cavendish's <title>Nature's Pictures</title> shows speech
         ...
         <att>next</att> attributes: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VESA-egXML-lx" xml:lang="en" source="#VESA-eg-1"><lg type="couplet">
               <l>
      ...
      <p>Alternatively, the elements may be reconstructed with stand-off markup using the element <gi>join</gi>: 
         <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VESA-egXML-pb" xml:lang="en" source="#VESA-eg-1"><lg type="couplet">
               <l>
            ...
            <p>
               <join result="said" scope="root" target="#eg2-said1 #eg2-said2 #eg2-said3"/>
            </p>
         </egXML>
      </p>
      <p>
   ...
   <div type="div2" xml:id="VEME">
      ...
      <div type="div3" xml:id="VEMEsamp">
         ...
         <p>As a simple example of the use of these attributes, consider the following lines from
            Pope's <title level="a">Essay on Criticism</title>: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEMEsamp-egXML-xx" source="#VEMEsamp-eg-14"><div type="book" n="1" met="-+|-+|-+|-+|-+/" rhyme="aa">
         ...
         <p>A formal definition of the significance of each component of the pattern given as the
            ...
            within the <gi>encodingDesc</gi> element in the TEI header (see section <ptr target="#HDMN"/>). The encoder is free to invent any notation appropriate to his or
	 ...
	 <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEMEsamp-egXML-mx" source="#NONE">
	   <l real="+-|-+|-+|-+|-+">But, of the two, ...</l>
	    ...
	    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEMEsamp-egXML-mi" source="#NONE">
	      <l met="+-|-+|-+|-+|-+">But, of the two, ...</l>
	      </egXML> Alternatively, a different metrical notation might be defined, in
         ...
         <p>In choosing whether to over-ride a metrical specification in this way or by using the
            ...
            <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEMEsamp-egXML-fe" xml:lang="de" source="#VE-eg-03">
               ...
               on Criticism</q>, might be encoded as follows: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEMEsamp-egXML-kp" source="#VEMEsamp-eg-14"><l n="356"> A
      ...
      <div type="div3" xml:id="VEMElevels">
         ...
         <p>The examples given so far have encoded information about the realization of metrical
            ...
            immediately above might be encoded as follows: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEMElevels-egXML-qg" source="#VEMEsamp-eg-14"><l n="356"> A need<seg type="foot" n="2" real="--">less a</seg>lexandrine ends the song,</l>
               <l n="357" met="-+|-+|-+|-+|-+|-+">
         ...
         <p>There are circumstances where it may also be useful to use the <att>met</att> attribute
            ...
            follows (for simplicity's sake the caesura has been omitted): <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEMElevels-egXML-wf" xml:lang="la" source="#VE-eg-02"><l><seg type="foot" met="+--">Arma vi</seg>
      ...
      <div type="div3" xml:id="VEMEana">
         ...
         <p>The method described above may be used to encode quite complex verse forms, for instance
            ...
            lines, and the same rhyme scheme: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEMEana-egXML-qf" xml:lang="it" source="#VEMEana-eg-23"><div type="canzone" met="E/E/S/E/S/E/E/S/E/S/E/S/S/E/S/E/E/S/S/E/E" rhyme="abbcdaccbdceeffghhhgg">
                  <lg n="1" type="stanza">
...
--></p>
         ...
         <p>In the metrical notation used here, the letter <val>E</val> represents a line containing
            ...
            following:
	    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEMEana-egXML-xf" source="#NONE">
		...
		<metSym value="/">line division</metSym>
         ...
         <p>As noted above, the metrical pattern specified on the <gi>div</gi> applies to each
            ...
            on the eighth stanza itself, which will override the default value inherited from parent
               <gi>div</gi>, as follows: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VEMEana-egXML-qn" xml:lang="it" source="#VEMEana-eg-23"><div met="[...]">
                  <lg>
                     <l> ... </l>
                  </lg>
   ...
   <div type="div2" xml:id="VERH">
      ...
      <p>Non-rhyming lines within such a group may be represented using a hyphen or an x, as in the
         following example: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VERH-egXML-pa" source="#fitrub">
            <lg rhyme="aa-a">
      ...
      <p>The <gi>rhyme</gi> element may be used to mark the words (or parts of words) which rhyme
         according to a predefined pattern: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VERH-egXML-zs" source="#VERH-eg-25"><lg type="couplet" rhyme="aa">
      ...
      <p>The <att>label</att> attribute is used to specify which parts of a rhyme scheme a given set
         of rhyming words represent: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VERH-egXML-lc" source="#VE-eg-04"><lg type="quatrain" rhyme="abab">
      ...
      <p>The <gi>rhyme</gi> element can appear anywhere within a verse line, and not necessarily
         ...
         as in the following example: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VERH-egXML-vv" source="#VERH-eg-27"><lg rhyme="ABCCBBA">
      ...
      <p>To use the correspondence mechanisms to represent the complex rhyming pattern of the above
         example, each <gi>rhyme</gi> element must be given a unique identifier, as follows: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VERH-egXML-tf" source="#VERH-eg-27"><lg rhyme="AB-BBA">
         ...
         which of the <gi>rhyme</gi> elements share the same rhyme, as follows: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="VERH-egXML-rh" xml:lang="und" source="#UND"><linkGrp type="rhyme">
      ...
      <p>For further discussion of the <gi>link</gi> and <gi>linkGrp</gi> element, see section <ptr target="#SACS"/>. </p>
   ...
   <div xml:id="HDMN">
      ...
      <p>As a simple example, consider the case of the notation in
      ...
      <mentioned>1</mentioned> is used for metrical prominence,
      <mentioned>0</mentioned> for non-prominence,
      <mentioned>|</mentioned> for foot boundary and
      <mentioned>/</mentioned> for line boundary, then the following
      declaration achieves this objective:
	 <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HDMN-egXML-fo" source="#NONE">
	   <metDecl pattern="((1|0)+\|?/?)*">
      ...
      <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HDMN-egXML-xu" source="#NONE">
	<metDecl>
	  ...
	  Note that in this case, because the <att>pattern</att> attribute has
      ...
      <p>For more complex cases, it will often be more convenient to
      define a notation incrementally. The <att>terminal</att>
      ...
      <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HDMN-egXML-hs" source="#NONE">
	<metDecl pattern="[DTIS3A]+">
      ...
      Note here the use of the global <att>n</att> attribute to supply
      an additional name for the symbols being documented.</p>

      <p>Where an encoder wishes to use more than one different
      pattern for metrical notation, multiple <gi>metDecl</gi>
      elements may be included in the <gi>encodingDesc</gi>, each
      supplied with an <att>xml:id</att>. The <att>decls</att>
      attribute may be used in the text of the document to specify
      which <gi>metDecl</gi> is in force at a particular point in the
      text. In this example, two <gi>metDecl</gi>s are defined in the
      header, one with an English verse pattern and one with a French
      pattern. In the body of the document, there are two <gi>div</gi>
      elements, one declaring the English pattern and one the
      French:
      <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="HDMN-egXML-kr" source="#NONE">
	<encodingDesc>
	  <!-- ... -->
   ...
   <div type="div2" xml:id="VEETC">
      ...
      <p>A number of procedures that may be of particular concern to encoders of verse texts are
         ...
         especially important in the case of free verse, are dealt with in chapter <ptr target="#PH"/>. Some initial recommendations for the encoding of phonetic or prosodic transcripts,
      ...
      <p>As already indicated, chapter <ptr target="#SA"/> contains much which will be found useful
         ...
         texts up into blocks in this way. The <gi>span</gi> element discussed in <ptr target="#AISP"/> provides the means for doing this. Finally, the procedures for the
   ...
   <div type="div2" xml:id="VESTR">
     ...
     <moduleSpec xml:id="DVE" ident="verse">
       ...
       <desc xml:lang="zh-TW" versionDate="2018-07-12">韻文結構</desc>
       <desc xml:lang="it" versionDate="2018-07-12">Strutture poetiche</desc>
       <desc xml:lang="pt" versionDate="2018-07-12">Estrutura dos versos</desc>
       <desc xml:lang="ja" versionDate="2018-07-12">韻文モジュール</desc>
       </moduleSpec>
       <!--publicID:  -//TEI P5//ELEMENTS Base Element Set for Verse//EN-->
       The selection and combination of modules to form a TEI schema
       is described in <ptr target="#STIN"/>.</p>
     <specGrp>
...
XML location: `/div[1]/div[4]/div[1]/p[9]`.
...
XML location: `/div[1]/div[4]/div[1]/p[10]`.
...
XML location: `/div[1]/div[4]/div[1]/p[11]`.
