...
source: '[[00_sources/tei-p5-guidelines-nh-non-hierarchical-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 Non-hierarchical Structures
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Guidelines/en/NH-Non-hierarchical.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 44224. Git blob: `f4f74e3a5cdea77ecd89571b6343b69db71af766`.
...
<div xmlns="http://www.tei-c.org/ns/1.0" n="31" type="div1" xml:id="NH">
    ...
    non-hierarchical information: <list rend="bulleted">
            ...
            <item>
                ...
                of a non-nesting structure (discussed in <ptr target="#NHBM"/>)</p>
            </item>
            <item>
    ...
    <div type="div2" xml:id="NHME">
        ...
        <p>Thus, for example, the <term>Metrical View</term> of <title level="a">Scorn not the
            ...
            each metrical line: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHME-egXML-kx" source="#NH-eg-01">
                <l>Scorn not the sonnet; critic, you have frowned,</l>
                <l>Mindless of its just honours; with this key</l>
                <l>Shakespeare unlocked his heart; the melody</l>
                <l>Of this small lute gave ease to Petrarch's wound.</l>
        ...
        information about its sentence structure: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHME-egXML-ip" source="#NH-eg-01">
                <p>
        ...
        metrical, grammatical, and dialogic views of its text: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHME-egXML-qd" source="#NH-eg-02">
                <lg>
                    <l>Catholic woman of twenty-seven with five children</l>
                    <l>And a first-rate body—pointed her finger</l>
                    <l>at the back of one certain man and asked me,</l>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHME-egXML-we" source="#NH-eg-02">
<p>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHME-egXML-vs" source="#NH-eg-02">
...
thought.</ab>
        ...
        annotations, as described in <ptr target="#NH-BIBL-01"/>. </note></p>
    </div>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHBM-egXML-oa" source="#NH-eg-01">
  <p>
...
wound.</seg></p></egXML>
	...
	lineation, the correspondence would break down entirely.</p>
        ...
        given instance opens or closes the feature. <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHBM-egXML-em" source="#NH-eg-01">
                <l>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xmlns:n="http://www.example.org/ns/nonTEI" xml:id="NHBM-egXML-qi" source="#NH-eg-01">
<l>
...
<l>Of this small lute gave ease to Petrarch's wound. <n:sentenceBoundaryEnd/></l>
        ...
        attributes without loss of information, this method is TEI-conformant<!--ble -->
        ...
        cross-hierarchical boundaries.  Additional attributes (<att scheme="HORSE">sID</att> and <att scheme="HORSE">eID</att> in
        ...
        <ptr target="#NH-BIBL-1" type="cit"/>): <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHBM-egXML-fr" source="#NH-eg-01">
          ...
          TEI, or may produce a non-conformant document. <list rend="bulleted">
                <item>The method is TEI-conformant<!--ble--> <!--if the modified
                ...
                milestone or anchor elements automatically (see <ptr target="#CF"/>).</item>
                ...
                TEI elements without loss of information--> (see <ptr target="#CF"/>).</item>
                <item>The method is non-conformant—and indeed strongly
                deprecated—if the modified elements and attributes are
                not placed in a distinct, non-TEI namespace (see <ptr target="#CFAM"/>).</item>
            </list></p>
        ...
        <p>In each of the above examples (except the last), the relationship between the start and
            ...
            can be understood as either modifying <mentioned>trains and planes</mentioned> or just
                <mentioned>trains</mentioned>: <figure xml:id="NHBM-figure-bu">
        ...
        boundary delimiters is required: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHBM-egXML-wf" source="#NH-eg-03">
                <phr function="NP">
        ...
        for the range limited by empty elements.<note place="bottom">Grammar based schema languages (e.g., DTD, W3C
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHVE-egXML-jc" source="#NH-eg-02">
  <lg>
    <l>Catholic woman of twenty-seven with five children</l>
    <l>And a first-rate body—pointed her finger</l>
    <l>at the back of one certain man and asked me,</l>
...
psychiatrist.</said></l>
	...
	could be encoded:
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHVE-egXML-vf" source="#NH-eg-01">
  <l>
  ...
  <l>
    <seg n="sentence4">Of this small lute gave ease to Petrarch's wound.</seg>
        ...
        combine objects in the text to a new hierarchy. Here is <title level="a">Scorn not the sonnet</title> again; this time the
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHVE-egXML-oe" source="#NH-eg-01">
  <l>
    <seg>Scorn not the sonnet;</seg>
  ...
  <l>
    <seg prev="#s4a" xml:id="s4b">Of this small lute gave ease to Petrarch's wound.</seg>
        ...
        reflect this method: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHVE-egXML-qi" source="#NH-eg-01">
                <l>
                    <seg>Scorn not the sonnet;</seg>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHVE-egXML-wi" source="#NH-eg-02">
  <lg>
    <l>
...
<egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHVE-egXML-qs" source="#NH-eg-01">
  <l>
  ...
  <p>
    ...
    <div type="div2" xml:id="NHSO">
        ...
        literally during processing.</note>: <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="NHSO-egXML-ss" source="#NH-eg-01">
                <l>
...
&lt;/p&gt;
  ...
  might well be in another document, in which case the value of <att scheme="HTML">href</att> of <gi>xi:xinclude</gi> would need to be
  ...
  the <gi>w</gi> elements.
        ...
        offsets (see <ptr target="#SATS"/>, in particular <ptr target="#SATSSR"/>). Another distinction concerns the number
    ...
    <div type="div2" xml:id="NHNX">
        ...
        <list rend="bulleted">
            ...
            of a tree (see <ptr target="#NH-BIBL-3" type="cit"/>).</item>
            <item>The <soCalled>colored XML</soCalled> proposal (<ptr target="#NH-BIBL-4" type="cit"/>), which stores a body of
            ...
            <item>The MultiX proposal (<ptr target="#NH-BIBL-5" type="cit"/>) , which represents documents as directed
            ...
            <item>The Just-In-Time-Trees proposal (<ptr target="#NH-BIBL-6" type="cit"/>), which stores documents
            ...
            <item>The <choice>
                    ...
                    a data structure based on Core Range Algebra (<ptr target="#NH-BIBL-7" type="cit"/>).</item>
            <item><choice>
...
XML location: `/div[1]/div[5]/list[1]`.
