...
source: '[[00_sources/tei-p5-guidelines-ai-analyticmechanisms-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 Simple Analytic Mechanisms
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Guidelines/en/AI-AnalyticMechanisms.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 69574. Git blob: `65ea77daed9961c66b8d221efa570e25cedd45be`.
...
```xml
<head>Simple Analytic Mechanisms</head>
```
...
```xml
<head>Linguistic Segment Categories</head>
```
...
XML location: `/div[1]/div[1]/div[1]/p[16]`.
...
XML location: `/div[1]/div[1]/div[1]/p[17]`.
...
XML location: `/div[1]/div[1]/div[1]/p[18]`.
...
```xml
<head>Below the Word Level</head>
```
...
XML location: `/div[1]/div[1]/div[2]/specGrp[2]`.
...
```xml
<head>Global Attributes for Simple Analyses</head>
```
...
```xml
<head>Spans and Interpretations</head>
```
...
```xml
<head>Linguistic Annotation by Means of Generic TEI Devices</head>
```
...
Project (<ptr target="#AI-BIBL-5"/>).
 <q rend="display">The victim's friends told police that Kruger drove
into the quarry and never surfaced.</q> </p>
```
...
```xml
<head>Lightweight Linguistic Annotation</head>
```
