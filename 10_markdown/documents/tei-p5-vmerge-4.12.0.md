...
source: '[[00_sources/tei-p5-vmerge-4.12.0.xml]]'
converter: tools.ingest_guidelines v1; complete XML plus verbatim blocks of prose,
  specifications and support files
channel: collection
metadata:
  title: TEI P5 4.12.0 vMerge
  creator: TEI Consortium
  date: '2026-07-28'
  format: application/xml
  identifier: https://github.com/TEIC/TEI/blob/113e933e21f016e2655518321e9d10214b8d9fcb/P5/Source/Specs/vMerge.xml
  license: CC-BY-3.0
  confidential: false
created: '2026-09-07'
updated: '2026-09-07'
...
Source byte length: 8656. Git blob: `95a2f998bef956861d3cedf26a39c6074e10e902`.
...
<elementSpec xmlns="http://www.tei-c.org/ns/1.0" module="iso-fs" xml:id="gi-vMerge" ident="vMerge">
...
sont organisées en ensemble.</desc>
        ...
        ることを示す。</desc>
          <desc versionDate="2008-03-30" xml:lang="fr">indique que les valeurs résultantes
sont organisées en paquet (de plusieurs ensembles).</desc>
...
sont organisées en liste.</desc>
  ...
  <exemplum xml:lang="en">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-vMerge-egXML-pf" source="#UND">
      <vMerge org="list">
        <vColl org="set">
...
with the set of values masculine, neuter and feminine.</p>
  ...
  <exemplum versionDate="2008-04-06" xml:lang="fr">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-vMerge-egXML-gx" source="#UND">
      <vMerge org="list">
        <vColl org="set">
          <symbol value="masculine"/>
          <symbol value="neuter"/>
  ...
  <exemplum xml:lang="zh-TW">
    <egXML xmlns="http://www.tei-c.org/ns/Examples" xml:id="gi-vMerge-egXML-jp" source="#UND">
      <vMerge org="list">
        <vColl org="set">
          <symbol value="masculine"/>
          <symbol value="neuter"/>
